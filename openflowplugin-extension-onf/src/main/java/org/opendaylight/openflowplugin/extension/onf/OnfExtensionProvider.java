...
public class OnfExtensionProvider {
    ...
    public OnfExtensionProvider(final List<SwitchConnectionProvider> switchConnectionProviders,
                                final OpenFlowPluginExtensionRegistratorProvider converterRegistrator) {
        this.switchConnectionProviders = Preconditions.checkNotNull(switchConnectionProviders,
                "SwitchConnectionProviders can not be null!");
    ...
    private void registerSerializers() {
        switchConnectionProviders.forEach(s -> {
            s.registerExperimenterMessageSerializer(
    ...
    private void registerDeserializers() {
        switchConnectionProviders.forEach(s -> {
            s.registerExperimenterMessageDeserializer(
