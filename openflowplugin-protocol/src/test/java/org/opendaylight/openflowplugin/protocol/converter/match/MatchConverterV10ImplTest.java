 ...
 */
public class MatchConverterV10ImplTest {
    ...
    public void testConvert() {
        MatchV10 matchV10 = matchConvertorV10.convert(createL4UdpMatch().build(), null, null);
        ...
        matchV10 = matchConvertorV10.convert(createL4TcpMatch().build(), null, null);
        assertEquals(DEFAULT_PORT.getValue().intValue(), matchV10.getTpSrc().intValue());
        assertEquals(DEFAULT_PORT.getValue().intValue(), matchV10.getTpDst().intValue());

        matchV10 = matchConvertorV10.convert(createVlanTcpMatch().build(), null, null);
    ...
    public void testConvertIcmpv4() {
        ...
        MatchV10 matchV10 = matchConvertorV10.convert(match, converterManager, null);
        Integer zero = 0;
        ...
        match = matchBuilder.setIcmpv4Match(icmpv4MatchBuilder.build()).
            build();
        matchV10 = matchConvertorV10.convert(match, converterManager, null);
        assertEquals(ZERO_MAC, matchV10.getDlDst());
        assertEquals(FF_MAC, matchV10.getDlSrc());
        assertEquals(0, matchV10.getDlType().intValue());
        assertEquals(0xffff, matchV10.getDlVlan().intValue());
