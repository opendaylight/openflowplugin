 ...
 */
public class MatchConverterImpl2Test {
    ...
    public void testEmptyAndNullInput() {
        ...
        List<MatchEntry> entries = convertor.convert(null, converterManager, null);
        Assert.assertEquals("Wrong entries size", 0, entries.size());

        entries = convertor.convert(match, converterManager, null);
        Assert.assertEquals("Wrong entries size", 0, entries.size());
    }
    ...
    public void testConversion() {
        ...
        List<MatchEntry> entries = convertor.convert(match, converterManager, null);
