...
package org.opendaylight.openflowplugin.protocol.serialization.multipart;
...
public class MultipartRequestPortDescSerializerTest extends AbstractSerializerTest {
    private static final MultipartRequestPortDesc BODY = new MultipartRequestPortDescBuilder()
            .build();

    private MultipartRequestPortDescSerializer serializer;
