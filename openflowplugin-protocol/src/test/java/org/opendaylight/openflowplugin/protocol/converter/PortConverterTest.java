...
public class PortConverterTest {
    ...
    public void testtoPortModInputwithAllParameters()
    {
        ...
        VersionConverterData data = new VersionConverterData(OFConstants.OFP_VERSION_1_3);
        final ConverterManagerImpl converterManager = new ConverterManagerFactory().newInstance(new ExtensionConverterManagerImpl());
        Optional<PortModInput> portOutOptional = converterManager.convert(portBld.build(), data);
        PortModInput portOut = portOutOptional.orElse(PortConverter.defaultResult(OFConstants.OFP_VERSION_1_3));
    ...
    /**
     * test of {@link PortConverter#toPortDesc(org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.port.rev130925.FlowCapablePort , short)}
     */
    @Test
    public void testtoPortDescwithAllParameters(){
        ...
        Ports portsOut = PortConverter.toPortDesc(flowCapableNodeConnectorBuilder.build(), EncodeConstants.OF13_VERSION_ID);
