...
package org.opendaylight.openflowplugin.protocol.serialization.messages;
...
import org.opendaylight.openflowplugin.protocol.serialization.AbstractSerializerTest;
...
public class FlowMessageSerializerTest extends AbstractSerializerTest {
    ...
    private void testVlanFalse(final ByteBuf out) {
        ...
        Assert.assertEquals(out.readUnsignedShort(), InstructionConstants.APPLY_ACTIONS_TYPE);
        ...
        Assert.assertEquals(out.readUnsignedShort(), ActionConstants.PUSH_VLAN_CODE);
        Assert.assertEquals(out.readUnsignedShort(), ActionConstants.GENERAL_ACTION_LENGTH);
        ...
        Assert.assertEquals(out.readUnsignedShort(), ActionConstants.SET_FIELD_CODE);
