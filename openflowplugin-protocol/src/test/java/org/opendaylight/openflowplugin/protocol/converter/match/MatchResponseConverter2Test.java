 ...
 */
public class MatchResponseConverter2Test {
    ...
    public void testEmptyMatch() {
        final VersionDatapathIdConverterData datapathIdConverterData = new VersionDatapathIdConverterData(OFConstants.OFP_VERSION_1_3);
        datapathIdConverterData.setDatapathId(new BigInteger("42"));
        convert(new MatchBuilder().build(), datapathIdConverterData);
    }
    ...
    public void testEmptyMatchEntry() {
        ...
        final org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.flow
                .MatchBuilder salMatch = convert(match, datapathIdConverterData);
    ...
    /**
     * Test {@link org.opendaylight.openflowplugin.protocol.converter.match.MatchResponseConvertor#convert(org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.oxm.rev150225.MatchEntriesGrouping, org.opendaylight.openflowplugin.protocol.converter.data.VersionDatapathIdConverterData)}
     */
    @Test
    ...
    public void testLayer4MatchUdp() {
        ...
        final org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.flow
                .MatchBuilder builtMatch = convert(builder.build(), datapathIdConverterData);
    ...
    public void testLayer4MatchSctp() {
        ...
        final org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.flow
                .MatchBuilder salMatchBuilder = convert(builder.build(), datapathIdConverterData);
    ...
    public void testWithMatchEntryWithIpv6ArbitraryMasks() {
        ...
        final org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.flow
                .MatchBuilder salMatchBuilder = convert(match, datapathIdConverterData);
        final org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.flow.Match builtMatch = salMatchBuilder.build();
    ...
    private org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.flow
            .MatchBuilder convert(Match match, VersionDatapathIdConverterData data) {
        final Optional<org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.flow
                .MatchBuilder> salMatchOptional = converterManager.convert(match, data);
