 ...
 *
 */
public class MatchConverterUtilTest {

    private static Logger LOG = LoggerFactory
            .getLogger(MatchConverterUtilTest.class);

    /**
     * Test method for {@link org.opendaylight.openflowplugin.protocol.converter.match.MatchConvertorUtil#ipv6ExthdrFlagsToInt(org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.types.rev130731.Ipv6ExthdrFlags)}.
     *
     * @throws Exception
     */
