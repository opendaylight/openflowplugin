...
public class MeterConverterTest {
    ...
    @Test
    public void testMeterModCommandConverterwithAllParameters() {
        long BURST_SIZE = 10L;
        long DROP_RATE = 20L;
        // / DROP Band
        ...
        MeterModInputBuilder outMeterModInput = convert(meterInputCommand, new VersionConverterData((short) 0X4));
    ...
    @Test
    public void testMeterModCommandConverterwithNoFlags() {
        long BURST_SIZE = 10L;
        long DROP_RATE = 20L;
        // / DROP Band
        MeterBandHeaderBuilder meterBandHeaderBuilder = new MeterBandHeaderBuilder();
    ...
    @Test
    public void testMeterModCommandConverterBandDataisNULL() {
        AddMeterInputBuilder addMeterFromSAL = new AddMeterInputBuilder();
    ...
    @Test
    public void testMeterModCommandConverterNoValidBandData() {
    ...
    private MeterModInputBuilder convert(Meter source, VersionConverterData data) {
        Optional<MeterModInputBuilder> outMeterModInputOptional = converterManager.convert(source, data);
        return outMeterModInputOptional.orElse(MeterConverter.defaultResult(data.getVersion()));
    }
}