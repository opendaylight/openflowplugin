...
public class MatchV10ResponseConverterTest {
    ...
    public void test() {
        ...
        final VersionDatapathIdConverterData datapathIdConverterData = new VersionDatapathIdConverterData(OFConstants.OFP_VERSION_1_0);
        datapathIdConverterData.setDatapathId(new BigInteger("42"));

        final Match salMatch = convert(match, datapathIdConverterData).build();
    ...
    public void testIcmpv4Match() {
        ...
        final VersionDatapathIdConverterData datapathIdConverterData = new VersionDatapathIdConverterData(OFConstants.OFP_VERSION_1_0);
        datapathIdConverterData.setDatapathId(dpid);

        Match salMatch = convert(match, datapathIdConverterData).build();
        ...
        salMatch = convert(match, datapathIdConverterData).build();
    ...
    /**
     * UDP match test for {@link org.opendaylight.openflowplugin.protocol.converter.match.MatchV10ResponseConvertor#convert(org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.oxm.rev150225.match.v10.grouping.MatchV10, org.opendaylight.openflowplugin.protocol.converter.data.VersionDatapathIdConverterData)}
     */
    @Test
    ...
    private MatchBuilder convert(MatchV10 match, VersionDatapathIdConverterData data) {
        final Optional<MatchBuilder> salMatchOptional = converterManager.convert(match, data);
