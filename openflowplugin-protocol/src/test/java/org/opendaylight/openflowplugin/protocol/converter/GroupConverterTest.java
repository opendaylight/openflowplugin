...
public class GroupConverterTest {
    ...
    @Test
    public void testGroupModConverterwithallParameters() {
        ...
        VersionDatapathIdConverterData data = new VersionDatapathIdConverterData((short) 0X4);
    ...
    @Test
    public void testGroupModConverterNoBucket() {
        final AddGroupInputBuilder addGroupBuilder = new AddGroupInputBuilder();
    ...
    @Test
    public void testGroupModConverterBucketwithNOWieghtValuesForGroupTypeFastFailure() {
    ...
    @Test
    public void testGroupModConverterBucketwithNOWieghtValuesForGroupTypeAll() {
    ...
    private GroupModInputBuilder convert(Group group, VersionDatapathIdConverterData data) {
        final Optional<GroupModInputBuilder> outAddGroupInputOptional = converterManager.convert(group, data);
        Assert.assertTrue("Group converter not found", outAddGroupInputOptional.isPresent());
