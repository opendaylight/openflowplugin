...
public class GroupStatsResponseConverterTest {
    ...
    public void testEmptyGroupStats() {
        ...
        Optional<List<org.opendaylight.yang.gen.v1.urn.opendaylight.group.types.rev131018.group.statistics.reply
                .GroupStats>> salGroupStats = converterManager.convert(groupStats, new VersionConverterData(OFConstants.OFP_VERSION_1_3));
    ...
    public void testSingleGroupStat() {
        ...
        Optional<List<org.opendaylight.yang.gen.v1.urn.opendaylight.group.types.rev131018.group.statistics.reply
                .GroupStats>> salGroupStatsOptional = converterManager.convert(groupStats, new VersionConverterData(OFConstants.OFP_VERSION_1_3));
