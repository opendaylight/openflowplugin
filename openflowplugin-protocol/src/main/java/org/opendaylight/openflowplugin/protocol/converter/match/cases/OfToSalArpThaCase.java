...
public class OfToSalArpThaCase extends ConvertorCase<ArpThaCase, MatchBuilder, MatchResponseConverterData> {
    ...
    @Override
    public Optional<MatchBuilder> process(@Nonnull ArpThaCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
