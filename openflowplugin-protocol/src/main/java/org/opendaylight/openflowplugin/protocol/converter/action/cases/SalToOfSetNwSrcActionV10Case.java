...
public class SalToOfSetNwSrcActionV10Case extends ConvertorCase<SetNwSrcActionCase, Action, ActionConverterData> {
    ...
    @Nonnull
    @Override
    public Optional<Action> process(@Nonnull final SetNwSrcActionCase source, final ActionConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
