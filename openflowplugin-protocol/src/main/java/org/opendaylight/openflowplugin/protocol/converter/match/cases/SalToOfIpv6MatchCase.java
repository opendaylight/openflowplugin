...
public class SalToOfIpv6MatchCase extends ConvertorCase<Ipv6Match, List<MatchEntry>, VersionConverterData> {
    ...
    @Override
    public Optional<List<MatchEntry>> process(@Nonnull Ipv6Match source, VersionConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
