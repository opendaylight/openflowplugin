...
public class OfToSalEthDstCase extends ConvertorCase<EthDstCase, MatchBuilder, MatchResponseConverterData> {
    ...
    @Override
    public Optional<MatchBuilder> process(@Nonnull EthDstCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
        ...
        if (ethDstCase != null) {
            ...
            if (destinationMask != null) {
                ethDestinationBuilder.setMask(new MacAddress(ByteBufUtils.macAddressToString(destinationMask)));
            }
