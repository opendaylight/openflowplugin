 ...
 * Optional<MatchBuilder> salMatch = converterManager.convert(ofMatchV10, data);
 * }
 * </pre>
 */
public class MatchV10ResponseConverter extends Converter<MatchV10, MatchBuilder, VersionDatapathIdConverterData> {
    ...
    @Override
    public MatchBuilder convert(MatchV10 source, VersionDatapathIdConverterData datapathIdConverterData) {
        MatchBuilder matchBuilder = new MatchBuilder();
        EthernetMatchBuilder ethMatchBuilder = new EthernetMatchBuilder();
        VlanMatchBuilder vlanMatchBuilder = new VlanMatchBuilder();
        Ipv4MatchBuilder ipv4MatchBuilder = new Ipv4MatchBuilder();
        IpMatchBuilder ipMatchBuilder = new IpMatchBuilder();
        OpenflowVersion ofVersion = OpenflowVersion.get(datapathIdConverterData.getVersion());
        BigInteger datapathid = datapathIdConverterData.getDatapathId();
