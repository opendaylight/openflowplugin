 ...
 * Optional<MeterModInputBuilder> ofMeter = converterManager.convert(salMeter, data);
 * }
 * </pre>
 */
public class MeterConverter extends Converter<Meter, MeterModInputBuilder, VersionConverterData> {
    private static final Logger LOG = LoggerFactory.getLogger(MeterConverter.class);
    ...
    @Override
    public MeterModInputBuilder convert(Meter source, VersionConverterData data) {
