...
public final class MatchExtensionHelper {
    ...
    AugmentTuple<EXT_POINT> processAllExtensions(Collection<MatchEntry> matchEntries,
        ...
        for (MatchEntry matchEntry : matchEntries) {
            ExtensionListBuilder extensionListBld = processExtension(matchEntry, ofVersion.getVersion(),
                    matchPath, extensionConverterProvider);
     ...
     * @return
     */
    private static ExtensionListBuilder processExtension(MatchEntry matchEntry, short ofVersion,
                                                         MatchPath matchPath,
                                                         ExtensionConverterProvider extensionConverterProvider) {
        ...
        ConvertorFromOFJava<MatchEntry, MatchPath> convertor = extensionConverterProvider.getConverter(key);
        if (convertor != null) {
