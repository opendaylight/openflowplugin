...
import org.opendaylight.openflowplugin.protocol.serialization.match.ArpOpEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.ArpSourceHardwareAddressEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.ArpSourceTransportAddressEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.ArpTargetHardwareAddressEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.ArpTargetTransportAddressEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.EthernetDestinationEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.EthernetSourceEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.EthernetTypeEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Icmpv4CodeEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Icmpv4TypeEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Icmpv6CodeEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Icmpv6TypeEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.InPhyPortEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.InPortEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.IpDscpEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.IpEcnEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.IpProtoEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Ipv4DestinationEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Ipv4SourceEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Ipv6DestinationEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Ipv6ExtHeaderEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Ipv6LabelEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Ipv6NdSllEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Ipv6NdTargetEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Ipv6NdTllEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.Ipv6SourceEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.MatchEntrySerializerKeyImpl;
import org.opendaylight.openflowplugin.protocol.serialization.match.MatchSerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.MetadataEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.MplsBosEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.MplsLabelEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.MplsTcEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.PbbEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.SctpDestinationPortEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.SctpSourcePortEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.TcpDestinationPortEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.TcpFlagsEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.TcpSourcePortEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.TunnelIdEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.TunnelIpv4DestinationEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.TunnelIpv4SourceEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.UdpDestinationPortEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.UdpSourcePortEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.VlanPcpEntrySerializer;
import org.opendaylight.openflowplugin.protocol.serialization.match.VlanVidEntrySerializer;
