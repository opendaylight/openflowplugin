 ...
 * Optional<PortModInput> ofPort = converterManager.convert(salPort, data);
 * }
 * </pre>
 */
public class PortConverter extends Converter<Port, PortModInput, VersionConverterData> {
    ...
    @Override
    public PortModInput convert(Port source, VersionConverterData data) {
        PortConfig config = maskPortConfigFields(source.getConfiguration());
