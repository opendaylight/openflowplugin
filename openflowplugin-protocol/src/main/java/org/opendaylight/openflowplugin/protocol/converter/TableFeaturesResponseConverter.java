 ...
 * Optional<List<TableFeatures>> salFeatures = converterManager.convert(ofTableFeatures, data);
 * }
 * </pre>
 */
public class TableFeaturesResponseConverter extends Converter<MultipartReplyTableFeatures, List<TableFeatures>, VersionConverterData> {
    private static final Logger LOG = LoggerFactory.getLogger(TableFeaturesResponseConverter.class);
    ...
    @Override
    public List<TableFeatures> convert(MultipartReplyTableFeatures source, VersionConverterData data) {
