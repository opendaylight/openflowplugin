 ...
 * Optional<GroupModInputBuilder> ofGroup = converterManager.convert(salGroup, data);
 * }
 * </pre>
 */
public class GroupConverter extends Converter<Group, GroupModInputBuilder, VersionDatapathIdConverterData> {
    ...
    private List<BucketsList> salToOFBucketList(Buckets buckets, short version, int groupType, BigInteger datapathid) {
        ...
        for (org.opendaylight.yang.gen.v1.urn.opendaylight.group.types.rev131018.group.buckets.Bucket groupBucket : buckets
            ...
            Optional<List<Action>> bucketActionList = getConverterExecutor().convert(
    ...
    @Override
    public GroupModInputBuilder convert(Group source, VersionDatapathIdConverterData data) {
