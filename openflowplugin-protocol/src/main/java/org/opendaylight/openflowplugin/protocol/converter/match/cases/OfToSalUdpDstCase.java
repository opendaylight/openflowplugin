...
public class OfToSalUdpDstCase extends ConvertorCase<UdpDstCase, MatchBuilder, MatchResponseConverterData> {
    ...
    @Override
    public Optional<MatchBuilder> process(@Nonnull UdpDstCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
