 ...
 * Optional<List<GroupStats>> salGroupStats = converterManager.convert(ofGroupStats, data);
 * }
 * </pre>
 */
public class GroupStatsResponseConverter extends Converter<
    ...
    @Override
    public List<GroupStats> convert(List<org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.protocol.rev130731.multipart.reply.multipart.reply.body.multipart.reply.group._case.multipart.reply.group.GroupStats> source, VersionConverterData data) {
