...
public class SalToOfSetTpSrcActionV10Case extends ConvertorCase<SetTpSrcActionCase, Action, ActionConverterData> {
    ...
    @Nonnull
    @Override
    public Optional<Action> process(@Nonnull final SetTpSrcActionCase source, final ActionConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
