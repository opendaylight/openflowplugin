...
public class OfToSalEthSrcCase extends ConvertorCase<EthSrcCase, MatchBuilder, MatchResponseConverterData> {
    ...
    @Override
    public Optional<MatchBuilder> process(@Nonnull EthSrcCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
        ...
        if (ethSrcCase != null) {
            ...
            if (mask != null) {
                ethSourceBuilder.setMask(new MacAddress(ByteBufUtils.macAddressToString(mask)));
            }
