 ...
 */
public class MatchV10Converter extends Converter<Match, MatchV10, VersionConverterData> {
    ...
    @Override
    public MatchV10 convert(final Match source, final VersionConverterData data) {
