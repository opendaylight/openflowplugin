...
public class SalToOfTcpMatchCase extends ConvertorCase<TcpMatch, List<MatchEntry>, VersionConverterData> {
    ...
    @Override
    public Optional<List<MatchEntry>> process(@Nonnull TcpMatch source, VersionConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
