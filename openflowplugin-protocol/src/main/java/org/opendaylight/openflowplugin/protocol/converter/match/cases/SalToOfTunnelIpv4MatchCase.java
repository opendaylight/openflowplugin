...
public class SalToOfTunnelIpv4MatchCase extends ConvertorCase<TunnelIpv4Match, List<MatchEntry>, VersionConverterData> {
    ...
    @Override
    public Optional<List<MatchEntry>> process(@Nonnull TunnelIpv4Match source, VersionConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
