...
public class OfToSalPopPbbCase extends ConvertorCase<PopPbbCase, Action, ActionResponseConverterData> {
    ...
    @Override
    public Optional<Action> process(@Nonnull final PopPbbCase source, final ActionResponseConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
