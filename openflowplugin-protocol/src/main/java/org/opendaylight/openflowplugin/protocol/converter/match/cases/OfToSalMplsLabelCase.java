...
public class OfToSalMplsLabelCase extends ConvertorCase<MplsLabelCase, MatchBuilder, MatchResponseConverterData> {
    ...
    @Override
    public Optional<MatchBuilder> process(@Nonnull MplsLabelCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
