...
public class OfToSalPopMplsCase extends ConvertorCase<PopMplsCase, Action, ActionResponseConverterData> {
    ...
    @Override
    public Optional<Action> process(@Nonnull final PopMplsCase source, final ActionResponseConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
