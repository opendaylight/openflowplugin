...
package org.opendaylight.openflowplugin.protocol.converter.match.data;
...
/**
 * Converter data used in {@link org.opendaylight.openflowplugin.protocol.converter.match.MatchResponseConverter}
 * containing Openflow version, datapath ID and various builders, because match response converter cases depends
 * on each other and requires shared builders
 */
public class MatchResponseConverterData extends VersionDatapathIdConverterData {
    ...
    /**
     * Instantiates a new Match converter data.
     *
     * @param version the version
     */
    public MatchResponseConverterData(short version) {
        super(version);
    }
