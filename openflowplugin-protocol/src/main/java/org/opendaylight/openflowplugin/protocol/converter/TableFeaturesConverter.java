 ...
 * Optional<List<TableFeatures>> ofFeatures = converterManager..convert(salTableFeatures, data);
 * }
 * </pre>
 */
public class TableFeaturesConverter extends Converter<
        org.opendaylight.yang.gen.v1.urn.opendaylight.table.types.rev131026.TableFeatures,
        List<TableFeatures>,
        VersionConverterData> {

    private static final Logger LOG = LoggerFactory.getLogger(TableFeaturesConverter.class);
    ...
    @Override
    public List<TableFeatures> convert(org.opendaylight.yang.gen.v1.urn.opendaylight.table.types.rev131026.TableFeatures source, VersionConverterData data) {
