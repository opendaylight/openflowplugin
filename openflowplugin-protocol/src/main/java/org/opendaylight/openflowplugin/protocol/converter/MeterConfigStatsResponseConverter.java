 ...
 * Optional<List<MeterConfigStats>> salMeterConfigStats = converterManager.convert(ofMeterConfigStats, data);
 * }
 * </pre>
 */
public class MeterConfigStatsResponseConverter extends Converter<List<MeterConfig>, List<MeterConfigStats>, VersionConverterData> {
    ...
    @Override
    public List<MeterConfigStats> convert(List<MeterConfig> source, VersionConverterData data) {
