...
public class OfToSalSetDlSrcCase extends ConvertorCase<SetDlSrcCase, Action, ActionResponseConverterData> {
    public OfToSalSetDlSrcCase() {
        super(SetDlSrcCase.class, true, OFConstants.OFP_VERSION_1_0);
    }

    @Override
    public Optional<Action> process(@Nonnull final SetDlSrcCase source, final ActionResponseConverterData data, ConverterExecutor converterExecutor, final ExtensionConverterProvider extensionConverterProvider) {
