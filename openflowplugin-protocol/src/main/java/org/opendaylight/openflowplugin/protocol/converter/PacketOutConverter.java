 ...
 * data.setXid(xid);
 * Optional<PacketOutInput> ofPacketInput = converterManager.convert(salPacket, data);
 * }
 * </pre>
 */
public class PacketOutConverter extends Converter<TransmitPacketInput, PacketOutInput, PacketOutConverterData> {
    private static final Logger LOG = LoggerFactory.getLogger(PacketOutConverter.class);
    ...
    @Override
    public PacketOutInput convert(TransmitPacketInput source, PacketOutConverterData data) {
        ...
        if (inputActions != null) {
            final ActionConverterData actionConverterData = new ActionConverterData(data.getVersion());
            actionConverterData.setDatapathId(data.getDatapathId());

            final Optional<List<Action>> convertedActions = getConverterExecutor().convert(
                    inputActions, actionConverterData);
