...
public class ConvertorProcessor<FROM extends DataContainer, TO, DATA extends ConverterData> {
    ...
    public Optional<TO> process(final FROM source, final ConverterExecutor converterExecutor,
        ...
        return process(source, null, converterExecutor, extensionConverterProvider);
    }
    ...
    public Optional<TO> process(final FROM source, final DATA data, final ConverterExecutor converterExecutor,
        ...
        if (Objects.nonNull(processorCase)) {
            result = processorCase.processRaw(source, data, converterExecutor, extensionConverterProvider);
