...
if __name__ == "__main__":
    ...
    parser.add_argument( '--gxmls', default = None, help = 'generate the Group tests for the selected xml from xmls DIR '
                        'only (i.e. 1,3,34), 0 means no test and None means all tests  (default = None)' )
    parser.add_argument( '--confresp', type = int, default = 2, help = 'delay to '
                        'the Configuration Data Store  (default = 2 second) '\
                        'Increase this value is important for a weaker controller machine' )
    parser.add_argument( '--operresp', type = int, default = 5, help = 'delay to '
                        'the Operational Data Store  (default = 5 second) '\
                        'Increase this value is important for a weaker controller machine' )
