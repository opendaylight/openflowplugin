...
public class MatchComparatorHelper {
    ...
    static boolean layer3MatchEquals(final Layer3Match statsLayer3Match, final Layer3Match storedLayer3Match) {
        ...
        if (statsLayer3Match instanceof Ipv4Match && storedLayer3Match instanceof Ipv4Match) {
            ...
            // At this moment storedIpv4MatchArbitraryBitMask & statsIpv4MatchArbitraryBitMask will always have arbitrary masks - because in other cases
            // they both together won't be instances of Ipv4MatchArbitraryBitMask. (statsLayer3Match will be instance of Ipv4Match)
    ...
    static boolean isMaskArbitraryBitMask(byte[] byteMask) {
        if (byteMask == null) {
            return false;
        }
        else {
