...
public class MatchComparatorHelperTest {
    ...
    public void isMaskArbitraryBitMaskTest() {
        ...
        arbitraryBitMask = MatchComparatorHelper.isMaskArbitraryBitMask(new byte[] {1,1,1,1});
        assertEquals(arbitraryBitMask,true);
        arbitraryBitMask = MatchComparatorHelper.isMaskArbitraryBitMask(new byte[] {-1,-1,-1,-1});
        assertEquals(arbitraryBitMask,false);
        arbitraryBitMask = MatchComparatorHelper.isMaskArbitraryBitMask(new byte[] {-1,-1,0,-1});
        assertEquals(arbitraryBitMask,true);
        arbitraryBitMask = MatchComparatorHelper.isMaskArbitraryBitMask(null);
        assertEquals(arbitraryBitMask,false);
    }
