...
public abstract class AbstractFRMTest extends AbstractDataBrokerTest {
    ...
    protected void addFlowCapableNode(final NodeKey nodeKey) {
        ...
        writeTx.put(LogicalDatastoreType.OPERATIONAL, DataObjectIdentifier.builder(Nodes.class).build(), nodes);
        assertCommit(writeTx.commit());

        writeTx = getDataBroker().newWriteOnlyTransaction();
        writeTx.put(LogicalDatastoreType.CONFIGURATION, DataObjectIdentifier.builder(Nodes.class).build(), nodes);
        assertCommit(writeTx.commit());
    }
