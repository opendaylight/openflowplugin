...
public class ArbitratorReconcileServiceMock implements ArbitratorReconcileService {
    @Override public ListenableFuture<RpcResult<CommitActiveBundleOutput>> commitActiveBundle(
    ...
    @Override public ListenableFuture<RpcResult<GetActiveBundleOutput>> getActiveBundle(
