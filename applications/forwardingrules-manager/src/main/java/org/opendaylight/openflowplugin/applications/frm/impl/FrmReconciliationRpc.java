...
@Singleton
public class FrmReconciliationRpc {

    private static final Logger LOG = LoggerFactory.getLogger(FrmReconciliationRpc.class);

    private final ForwardingRulesManagerImpl forwardingRulesManagerImpl;

    @Inject
    public FrmReconciliationRpc(ForwardingRulesManagerImpl forwardingRulesManagerImpl) {
