...
public class BundleFlowForwarder {
        ...
        public void remove(InstanceIdentifier<Flow> identifier, Flow del, InstanceIdentifier<FlowCapableNode> nodeIdent,
                ...
                AddBundleMessagesInput addBundleMessagesInput = new AddBundleMessagesInputBuilder()
                        .setNode(new NodeRef(nodeIdent.firstIdentifierOf(Node.class))).setBundleId(getBundleId()).setFlags(BUNDLE_FLAGS)
        ...
        public Future<? extends RpcResult<?>> add(InstanceIdentifier<Flow> identifier, Flow add, InstanceIdentifier<FlowCapableNode> nodeIdent) {
                return null;
        }
