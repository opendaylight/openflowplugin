...
public class NodeConfiguratorImpl implements NodeConfigurator {
        ...
        @Override
        public void enqueueJob(String key, Callable<Future<? extends RpcResult<?>>> mainWorker, Future<? extends RpcResult<?>> resultFuture) {
        ...
        private class MainTask implements Callable <Future<? extends RpcResult<?>>>{
                ...
                @SuppressWarnings("checkstyle:illegalcatch")
                public Future<? extends RpcResult<?>> call() {
