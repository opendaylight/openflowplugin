...
import org.opendaylight.openflowplugin.applications.reconciliation.DefaultAction;
...
public class ForwardingReconciliationTaskFactory implements IReconciliationTaskFactory  {
    ...
    final private DefaultAction action;
    ...
    public ForwardingReconciliationTaskFactory(String serviceName, final int priority, final DefaultAction action,
...
//        }
    ...
    @Override public DefaultAction getAction() {
        return action;
    }
