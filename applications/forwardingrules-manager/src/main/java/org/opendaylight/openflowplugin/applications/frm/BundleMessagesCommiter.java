...
public interface BundleMessagesCommiter<D extends DataObject> extends AutoCloseable {
     ...
     */
    Future<RpcResult<AddBundleMessagesOutput>> add(InstanceIdentifier<D> identifier, D add,
                                                   InstanceIdentifier<FlowCapableNode> nodeIdent, BundleId bundleId);
