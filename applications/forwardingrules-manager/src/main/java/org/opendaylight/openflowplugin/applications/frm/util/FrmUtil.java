...
public final class FrmUtil {
    ...
    public static NodeId getNodeIdFromNodeIdentifier(InstanceIdentifier<FlowCapableNode> nodeIdent) {
    ...
    public static BigInteger getDpnIdFromNodeName(InstanceIdentifier<FlowCapableNode> nodeIdent) {
    ...
    public static boolean isGroupExistsOnDevice(final InstanceIdentifier<FlowCapableNode> nodeIdent,
            final Long groupId, ForwardingRulesManager provider) {
        NodeId nodeId = getNodeIdFromNodeIdentifier(nodeIdent);
