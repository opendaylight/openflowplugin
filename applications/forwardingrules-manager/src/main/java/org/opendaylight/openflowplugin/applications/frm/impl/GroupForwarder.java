...
public class GroupForwarder extends AbstractListeningCommiter<Group> {
    ...
    public Future<RpcResult<AddGroupOutput>> add(final InstanceIdentifier<Group> identifier, final Group addDataObj,
        ...
        ListenableFuture<List<ListenableFuture<RpcResult<AddGroupOutput>>>> futures = jobCoordinator
...
//                MoreExecutors.directExecutor());
        ...
        Futures.addCallback(futures, new FutureCallback<List<ListenableFuture<RpcResult<AddGroupOutput>>>>() {
            @Override
            public void onSuccess(List<ListenableFuture<RpcResult<AddGroupOutput>>> listenableFutures) {
