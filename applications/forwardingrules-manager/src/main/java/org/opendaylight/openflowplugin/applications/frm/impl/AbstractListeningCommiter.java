...
public abstract class AbstractListeningCommiter<T extends DataObject> implements ForwardingRulesCommiter<T> {
    ...
    public AbstractListeningCommiter(final ForwardingRulesManager provider, final NodeConfigurator nodeConfigurator) {
        this.provider = Preconditions.checkNotNull(provider, "ForwardingRulesManager can not be null!");
        this.nodeConfigurator = Preconditions.checkNotNull(nodeConfigurator, "NodeConfigurator can not be null!");
    }
