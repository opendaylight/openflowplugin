...
class JobEntry {
        ...
        private volatile Future<RpcResult<? extends RpcResult<?>>> resultFuture;
        ...
        JobEntry(String key, Callable<Future<? extends RpcResult<?>>> mainWorker, Future<RpcResult<? extends RpcResult<?>>> resultFuture) {
                this.key = key;
        ...
        public Future<RpcResult<? extends RpcResult<?>>> getResultFuture() {
                return resultFuture;
        }

        public void setResultFuture(Future<RpcResult<? extends RpcResult<?>>> resultFuture) {
                this.resultFuture = resultFuture;
        }
}
