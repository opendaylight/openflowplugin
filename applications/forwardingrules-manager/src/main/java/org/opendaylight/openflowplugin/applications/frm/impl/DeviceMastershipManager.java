...
public class DeviceMastershipManager implements OpendaylightInventoryListener, AutoCloseable{
    ...
    public void onNodeUpdated(NodeUpdated notification) {
        LOG.info("NodeUpdate notification received : {}", notification);
        LOG.info("FRM service registered for: {}", notification.getId());
    ...
    public void onNodeRemoved(NodeRemoved notification) {
        LOG.info("NodeRemoved notification received : {}", notification);
        ...
        if (mastership != null) {
            mastership.close();
            LOG.info("FRM service unregistered for: {}", nodeId.getValue());
        }
    }
