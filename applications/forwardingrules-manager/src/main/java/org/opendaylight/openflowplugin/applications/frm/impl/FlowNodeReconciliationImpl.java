...
public class FlowNodeReconciliationImpl implements FlowNodeReconciliation {
    ...
    public FlowNodeReconciliationImpl(final ForwardingRulesManager manager, final DataBroker db,
        ...
        this.controlBundleRpc = requireNonNull(provider.getRpc(ControlBundle.class),
            "controlBundleRpc can not be null!");
        this.addBundleMessagesRpc = requireNonNull(provider.getRpc(AddBundleMessages.class),
            "addBundleMessagesRpc can not be null!");
