        ...
        public void run() {
                ...
                while ((!(toBeInstalledGroups.isEmpty()) || !(suspectedGroups.isEmpty())) &&
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (okToInstall) {
                            ...
                            provider.getGroupCommiter().add(groupIdent, group, m_nodeIdent);
            ...
            /* Meters */
                ...
                for (Meter meter : meters) {
                    ...
                    provider.getMeterCommiter().add(meterIdent, meter, m_nodeIdent);
                }
            /* Flows */
                ...
                for (Table table : tables) {
                    ...
                    for (Flow flow : flows) {
                        ...
                        provider.getFlowCommiter().add(flowIdent, flow, m_nodeIdent);
                    }
                }
            }
        /* clean transaction */
