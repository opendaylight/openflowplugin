...
public class ForwardingRulesManagerImpl implements ForwardingRulesManager {
    ...
    private boolean bundlebasedresyncenabled;
    ...
    public ForwardingRulesManagerImpl(final DataBroker dataBroker,
        ...
        bundlebasedresyncenabled = config.isEnableBundleBasedRecon();
    ...
    @Override
    public SalBundleService getSalBundleService() { return salBundleService; }
    ...
    public int getReconciliationRetryCount() {
        ...
        LOG.error("return reconciliationRetryCount ..>>"+reconciliationRetryCount);
    ...
    public boolean isBundleBasedReconEnabled() {
        LOG.error("return bundlebasedresyncenabled ..>>"+bundlebasedresyncenabled);
        return bundlebasedresyncenabled; }
        ...
        Optional.ofNullable(ForwardingRulesProperty.forValue(propertyName)).ifPresent(forwardingRulesProperty -> {
            switch (forwardingRulesProperty) {
                ...
                case RECONCILIATION_RETRY_COUNT:
                    ...
                    break;
                case ENABLE_BUNDLE_BASED_RECON:
                    LOG.error("bundlebasedresyncenabled -> "+propertyValue);
                    bundlebasedresyncenabled = Boolean.valueOf(propertyValue);
                    break;
            }
        });
    }
