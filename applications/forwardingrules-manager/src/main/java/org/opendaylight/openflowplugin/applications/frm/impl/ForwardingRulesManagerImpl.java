...
public class ForwardingRulesManagerImpl implements ForwardingRulesManager {
    ...
    public ForwardingRulesManagerImpl(final DataBroker dataBroker, final RpcConsumerRegistry rpcRegistry,
                                      ...
                                      OpenflowpluginServiceRecoveryHandler openflowpluginServiceRecoveryHandler,
    ...
    public void start() {
        ...
        this.flowListener = new FlowForwarder(this, dataService, openflowpluginServiceRecoveryHandler,
                serviceRecoveryRegistry);
        this.groupListener = new GroupForwarder(this, dataService, openflowpluginServiceRecoveryHandler,
                serviceRecoveryRegistry);
        this.meterListener = new MeterForwarder(this, dataService, openflowpluginServiceRecoveryHandler,
                serviceRecoveryRegistry);
        this.tableListener = new TableForwarder(this, dataService, openflowpluginServiceRecoveryHandler,
                serviceRecoveryRegistry);
