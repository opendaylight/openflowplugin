...
public class FlowWriterSequential implements FlowCounterMBean {
    ...
    private class FlowHandlerTask implements Runnable {
        ...
        FlowHandlerTask(final String dpId, final int flowsPerDpn, final boolean add, final int batchSize,
                int sleepMillis, final short startTableId, final short endTableId, final boolean isCreateParents) {
