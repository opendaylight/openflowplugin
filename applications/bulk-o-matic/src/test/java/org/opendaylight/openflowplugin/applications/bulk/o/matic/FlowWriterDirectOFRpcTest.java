...
public class FlowWriterDirectOFRpcTest {
    ...
    public void testRpcFlowAdd() throws Exception {
        flowWriterDirectOFRpc.rpcFlowAdd("1", 100, 10);
        Mockito.verify(mockSalFlowService, Mockito.times(100)).addFlow(Mockito.<AddFlowInput>any());
    }

    @Test
    public void testRpcFlowAddAll() throws Exception {
        flowWriterDirectOFRpc.rpcFlowAddAll(100, 10);
        Mockito.verify(mockSalFlowService, Mockito.times(100)).addFlow(Mockito.<AddFlowInput>any());
    }
