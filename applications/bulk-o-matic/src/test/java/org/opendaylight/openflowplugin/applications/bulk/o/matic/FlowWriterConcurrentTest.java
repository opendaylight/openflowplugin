...
public class FlowWriterConcurrentTest {
    ...
    public void testAddFlows() throws Exception {
        flowWriterConcurrent.addFlows(1, 100, 10, 10, 10, (short)0, (short)1);
        Mockito.verify(wTx, Mockito.times(100)).put(Matchers.<LogicalDatastoreType>any(), Matchers.<InstanceIdentifier<DataObject>>any(), Matchers.<DataObject>any(), Matchers.anyBoolean());
    }

    @Test
    public void testDeleteFlows() throws Exception {
        flowWriterConcurrent.deleteFlows(1, 100, 10, (short)0, (short)1);
        Mockito.verify(wTx, Mockito.times(100)).delete(Matchers.<LogicalDatastoreType>any(), Matchers.<InstanceIdentifier<DataObject>>any());
    }
