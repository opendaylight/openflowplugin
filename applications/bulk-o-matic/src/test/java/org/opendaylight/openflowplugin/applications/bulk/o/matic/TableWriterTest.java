...
public class TableWriterTest {
    ...
    public void testAddTables() throws Exception {
        ...
        Mockito.verify(writeTransaction, Mockito.times(TABLES_PER_DPN)).put(ArgumentMatchers.<LogicalDatastoreType>any(),
    ...
    public void testDeleteTables() throws Exception {
        ...
        Mockito.verify(writeTransaction, Mockito.times(TABLES_PER_DPN)).delete(ArgumentMatchers.<LogicalDatastoreType>any(),
