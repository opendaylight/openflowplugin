...
public class SalBulkFlowServiceImplTest {
    ...
    public void testAddRemoveFlowsDs() throws Exception {
        ...
        verify(writeTransaction).put(ArgumentMatchers.<LogicalDatastoreType>any(), ArgumentMatchers.<InstanceIdentifier<Flow>>any(),
        ...
        verify(writeTransaction).delete(ArgumentMatchers.<LogicalDatastoreType>any(), ArgumentMatchers.<InstanceIdentifier<Flow>>any());
