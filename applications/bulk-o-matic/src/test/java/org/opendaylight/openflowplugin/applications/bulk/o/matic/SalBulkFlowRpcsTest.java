...
public class SalBulkFlowRpcsTest {
    ...
    @Mock
    private SalFlowRpcs mockSalFlowRpcs;
    @Mock
    ...
    private SalBulkFlowRpcs salBulkFlowRpcs;
    ...
    public void setUp() {
        ...
        salBulkFlowRpcs = new SalBulkFlowRpcs(mockSalFlowRpcs, mockDataBroker);
        rpcMap = salBulkFlowRpcs.getRpcClassToInstanceMap();
    }
    ...
    public void testAddRemoveFlowsDs() {
        ...
        rpcMap.getInstance(AddFlowsDs.class).invoke(addFlowsDsInput);
        ...
        rpcMap.getInstance(RemoveFlowsDs.class).invoke(removeFlowsDsInput);
    ...
    public void testAddRemoveFlowsRpc() {
        when(mockSalFlowRpcs.getRpcClassToInstanceMap().getInstance(AddFlow.class).invoke((any())))
                .thenReturn(RpcResultBuilder.success(new AddFlowOutputBuilder().build()).buildFuture());

        when(mockSalFlowRpcs.getRpcClassToInstanceMap().getInstance(RemoveFlow.class).invoke((any())))
        ...
        rpcMap.getInstance(AddFlowsRpc.class).invoke(addFlowsRpcInput);

        verify(mockSalFlowRpcs).getRpcClassToInstanceMap().getInstance(AddFlow.class).invoke(ArgumentMatchers.any());
        ...
        rpcMap.getInstance(RemoveFlowsRpc.class).invoke(removeFlowsRpcInput);

        verify(mockSalFlowRpcs).getRpcClassToInstanceMap().getInstance(RemoveFlow.class).invoke(ArgumentMatchers.any());
    }
    ...
    public void testReadFlowTest() throws Exception {
        ...
        final ListenableFuture<RpcResult<ReadFlowTestOutput>> resultFuture
                = rpcMap.getInstance(ReadFlowTest.class).invoke(readFlowTestInput);
    ...
    public void testFlowRpcAddTest() throws Exception {
        ...
        final ListenableFuture<RpcResult<FlowRpcAddTestOutput>> resultFuture
                = rpcMap.getInstance(FlowRpcAddTest.class).invoke(flowRpcAddTestInput);
    ...
    public void testFlowTest() throws Exception {
        ...
        Assert.assertTrue(rpcMap.getInstance(FlowTest.class).invoke(flowTestInput).get().isSuccessful());
    ...
    public void testFlowRpcAddMultiple() throws Exception {
        ...
        Assert.assertTrue(rpcMap.getInstance(FlowRpcAddMultiple.class).invoke(flowRpcAddMultipleInput).get()
            .isSuccessful());
    }
    ...
    public void testTableTest() throws Exception {
        ...
        Assert.assertTrue(rpcMap.getInstance(TableTest.class).invoke(tableTestInput).get().isSuccessful());
