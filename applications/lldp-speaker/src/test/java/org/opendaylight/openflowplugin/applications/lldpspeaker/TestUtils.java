...
final class TestUtils {
    ...
    static @NonNull WithKey<NodeConnector, NodeConnectorKey> createNodeConnectorId(final String nodeKey,
            final String nodeConnectorKey) {
    ...
    static FlowCapableNodeConnectorBuilder createFlowCapableNodeConnector(final boolean linkDown,
            final boolean adminDown) {
        return createFlowCapableNodeConnector(linkDown, adminDown, new MacAddress("13:37:BA:AD:F0:0D"), 1L);
    }

    static FlowCapableNodeConnectorBuilder createFlowCapableNodeConnector(final MacAddress mac, final long port) {
        return createFlowCapableNodeConnector(false, false, mac, port);
    }

    private static FlowCapableNodeConnectorBuilder createFlowCapableNodeConnector(final boolean linkDown,
            final boolean adminDown, final MacAddress mac, final long port) {
