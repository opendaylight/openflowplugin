...
/*
 * Provider to start the tasks of a node
 * Provider to end the tasks of a node
 */
public interface ReconciliationNotificationListener extends AutoCloseable {
     ...
     * tasks. If the tasks fails for the services with a priority, the tasks of the node for
     ...
     * tasks for all the services is carried out irrespective of the intent.
     *
     ...
     * add the service tasks property as a configurable property.
     *
    ...
    /*
     * Application's intent when the application's tasks fails
     *
     * @return the intent of the service if the tasks fails
     */
