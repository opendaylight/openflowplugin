...
public class ReconciliationManagerImpl implements ReconciliationManager {
    ...
    private class ReconciliationTask implements Callable<SettableFuture<NodeId>> {
        ...
        final NodeId nodeId;
        final SettableFuture<NodeId> future;

        public ReconciliationTask(final NodeId nodeId, final SettableFuture<NodeId> future) {
            this.nodeId = nodeId;
            this.future = future;
        }
    ...
    public void registerService(ReconciliationTaskFactory reconciliationTask) {
        ...
        if (registeredServices.containsKey(reconciliationTask.getPriority())) {
            ...
            List<ReconciliationTaskFactory> temp = new ArrayList<>();
    ...
    private class CancelReconciliationTask implements Runnable {
        ...
        public CancelReconciliationTask(final NodeId nodeId, final SettableFuture<NodeId> future) {
            this.nodeId = nodeId;
            this.future = future;
        }
