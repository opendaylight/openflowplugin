...
public interface ReconciliationManager {
     ...
     */
    void registerService(ReconciliationNotificationListener service);

    /*
     * API to unregister the service from Reconciliation Framework
     */
    void unregisterService(ReconciliationNotificationListener service);
    /*
     * Plugin will use this api to stop reconciliation when dpn disconnects
     *
     * @param nodeId - Node InstanceIdentifier
     */
    void haltReconciliation(DeviceInfo node);
