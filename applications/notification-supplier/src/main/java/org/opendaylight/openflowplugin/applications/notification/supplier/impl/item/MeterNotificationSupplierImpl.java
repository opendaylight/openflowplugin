...
public class MeterNotificationSupplierImpl extends
    ...
    private static final InstanceIdentifier<Meter> wildCardedInstanceIdent = AbstractNotifSupplierBase.getNodeWildII().augmentation(FlowCapableNode.class).child(Meter.class);
    ...
    public MeterAdded createNotification(final Meter o, final InstanceIdentifier<Meter> path) {
        ...
        builder.setNode(AbstractNotifSupplierBase.createNodeRef(path));
