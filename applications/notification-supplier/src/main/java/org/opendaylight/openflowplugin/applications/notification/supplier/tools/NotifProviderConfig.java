 ...
 */
public class NotifProviderConfig {
    ...
    private NotifProviderConfig(final NotifProviderConfigBuilder builder) {
    ...
    public static NotifProviderConfigBuilder builder() {
        return new NotifProviderConfigBuilder();
    }

    public static class NotifProviderConfigBuilder {
        ...
        public NotifProviderConfig build() {
            return new NotifProviderConfig(this);
        }
    }
}
