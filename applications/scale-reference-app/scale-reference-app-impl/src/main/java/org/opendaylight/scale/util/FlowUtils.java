...
public class FlowUtils {
    ...
    public static Flow convertSubsToFlow(String subscriberId, int sourceIp) {
    ...
    public static Flow convertSubsToFlowIPPrefix(String subscriberId, Ipv4Prefix subscriberPrefix) {
        // build match using subscriber ip
        MatchBuilder matchBuilder = new MatchBuilder();
        Ipv4Match ipv4Match = new Ipv4MatchBuilder().setIpv4Source(subscriberPrefix).build();
        matchBuilder.setLayer3Match(ipv4Match);
