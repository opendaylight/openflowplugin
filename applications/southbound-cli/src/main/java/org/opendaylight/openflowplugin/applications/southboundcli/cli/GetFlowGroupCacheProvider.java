...
public class GetFlowGroupCacheProvider extends OsgiCommandSupport {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(GetFlowGroupCacheProvider.class);
    ...
    public GetFlowGroupCacheProvider(final FlowGroupCacheManager flowGroupCacheManager) {
        ...
        LOG.info("inside GetFlowGroupCacheProvider");
    }
    ...
    protected Object doExecute() throws Exception {
        ...
        if (dpnId == null) {
            Map<String, Queue<FlowGroupCache>> flowGroupCacheListForAllNodes = flowGroupCacheManager
                    .getFlowGroupCacheListForAllNodes();
            ...
            if (!flowGroupCacheManager.getFlowGroupCacheListForAllNodes().containsKey(nodeId)) {
                session.getConsole().println("No node available for this NodeID");
                return null;
            }
            Queue<FlowGroupCache> flowGroupCacheList = flowGroupCacheManager.getFlowGroupCacheListForAllNodes()
                    .get(nodeId);
