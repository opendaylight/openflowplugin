...
/**
 * Purpose: prescribe common synchronization plan execution strategy, implementations should be stateless.
 */
public interface SyncPlanPushStrategy {
     ...
     * @param counters      reference to internal oneshot statistics - summary off successfully pushed items shall be recorded here
