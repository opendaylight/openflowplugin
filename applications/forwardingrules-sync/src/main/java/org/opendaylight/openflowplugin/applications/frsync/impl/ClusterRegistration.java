 ...
 */
public class ClusterRegistration implements ClusterSingletonService {
    ...
    public ClusterRegistration(final NodeId nodeId, final ReconciliationRegistry reconciliationRegistry) {
        this.nodeId = nodeId;
