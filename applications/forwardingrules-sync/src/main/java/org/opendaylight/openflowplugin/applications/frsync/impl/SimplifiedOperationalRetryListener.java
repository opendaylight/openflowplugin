...
public class SimplifiedOperationalRetryListener extends SimplifiedOperationalListener {
    ...
    protected Optional<ListenableFuture<Boolean>> processNodeModification(
        ...
        if (isAdd(modification) || isAddLogical(modification) || isRegisteredAndConsistentForRetry(modification)) {
     ...
     * If device is registered for retry and if modification is consistent.
     */
    @VisibleForTesting
