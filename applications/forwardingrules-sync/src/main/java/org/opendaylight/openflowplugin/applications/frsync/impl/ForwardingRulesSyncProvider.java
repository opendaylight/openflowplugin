...
public class ForwardingRulesSyncProvider implements AutoCloseable, BindingAwareProvider {
    ...
    public void onSessionInitiated(final BindingAwareBroker.ProviderContext providerContext) {
        ...
        final SyncReactor cfgReactor = new SyncReactorFutureZipDecorator(syncReactorGuard, syncThreadPool);
        final SyncReactor operReactor = new SyncReactorFutureZipDecorator(syncReactorGuard, syncThreadPool);
