...
public class ForwardingRulesSyncProvider implements AutoCloseable, BindingAwareProvider {
    ...
    public void onSessionInitiated(final BindingAwareBroker.ProviderContext providerContext) {
        ...
        final SyncReactor cfgReactor = new SyncReactorFutureZipRetryConfigDecorator(syncReactorGuard, syncThreadPool, retryRegistry);
        final SyncReactor operReactor = new SyncReactorFutureZipRetryOperationalDecorator(syncReactorGuard, syncThreadPool, retryRegistry);
        ...
        final NodeListener<Node> nodeListenerOperational =
                new SimplifiedOperationalRetryListener(operReactor, operationalSnapshot, configDao, retryRegistry);
