...
//                    .setTransactionService(transactionService);
            ...
            final SyncReactorRetryDecorator syncReactorRetry = new SyncReactorRetryDecorator(syncReactorGuard,
                    snapshotElicitRegistry, directStatisticsService);
            final SyncReactor cfgReactor = new SyncReactorFutureWithCompressionDecorator(syncReactorRetry, syncThreadPool);
            final SyncReactor operReactor = new SyncReactorFutureWithCompressionDecorator(syncReactorRetry, syncThreadPool);
