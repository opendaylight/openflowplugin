...
public class ForwardingRulesSyncProvider implements AutoCloseable, BindingAwareProvider {
    ...
    public void onSessionInitiated(final BindingAwareBroker.ProviderContext providerContext) {
        ...
        final SyncReactor cfgReactor = new SyncReactorFutureZipRetryDecorator(syncReactorGuard, syncThreadPool, retryRegistry);
        final SyncReactor operReactor = new SyncReactorFutureZipRetryDecorator(syncReactorGuard, syncThreadPool, retryRegistry);
