...
public class SimplifiedConfigListenerTest {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SimplifiedConfigListenerTest.class);
    ...
    public void testOnDataTreeChangedSyncupAdd() throws InterruptedException {
        ...
        Mockito.verify(reactor).syncup(fcNodePath, dataAfter, dataBefore);
    ...
    public void testOnDataTreeChangedSyncupDelete() throws InterruptedException {
        ...
        Mockito.verify(reactor).syncup(fcNodePath, null, dataBefore);
        Mockito.verify(roTx).close();
    }
