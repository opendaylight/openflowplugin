...
public class ClusteringServiceManagerTest {
    ...
    public void setUp() throws Exception {
        clusteringServiceManager = new ClusteringServiceManager(clusterSingletonService, new ReconciliationRegistry());
    }
    ...
    public void testOnDeviceConnectedAndDisconnected() {
        ...
        ClusterRegistration registration = clusteringServiceManager.getClusterRegistrations().get(NODE_ID);
