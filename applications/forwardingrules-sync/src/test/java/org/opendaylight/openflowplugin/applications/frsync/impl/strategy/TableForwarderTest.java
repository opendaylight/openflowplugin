...
public class TableForwarderTest {
    ...
    public void testUpdate() throws Exception {
        ...
        Assert.assertEquals("test-table", updateTableInput.getOriginalTable().getTableFeatures().values()
                .iterator().next().getName());
        Assert.assertEquals(1, updateTableInput.getUpdatedTable().getTableFeatures().size());
        Assert.assertEquals("another-table", updateTableInput.getUpdatedTable().getTableFeatures()
