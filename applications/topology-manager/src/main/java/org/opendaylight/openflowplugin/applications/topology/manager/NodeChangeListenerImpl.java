...
public class NodeChangeListenerImpl extends DataChangeListenerImpl<FlowCapableNode> {
        ...
        for (DataTreeModification modification : modifications) {
            switch (modification.getRootNode().getModificationType()) {
                ...
                case SUBTREE_MODIFIED:
                    // processUpdatedNode(modification);
                    break;
                case DELETE:
    ...
    private void processRemovedNode(final DataTreeModification modification) {
...
//     private void processUpdatedNode(final DataTreeModification modification) {
...
//     }
    ...
    private void processAddedNode(final DataTreeModification modification) {
        final InstanceIdentifier<?> iiToNodeInInventory = modification.getRootPath().getRootIdentifier();
