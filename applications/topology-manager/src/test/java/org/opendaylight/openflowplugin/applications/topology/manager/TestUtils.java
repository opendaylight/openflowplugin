...
public final class TestUtils {
    ...
    static void verifyMockTx(final ReadWriteTransaction mockTx) {
        ...
        inOrder.verify(mockTx, never()).delete(eq(LogicalDatastoreType.OPERATIONAL), any(DataObjectIdentifier.class));
    }

    @SuppressWarnings("rawtypes")
    static void assertDeletedIDs(final DataObjectIdentifier[] expDeletedIIDs,
    ...
    @SuppressWarnings("rawtypes")
    static void setupStubbedDeletes(final ReadWriteTransaction mockTx,
                                    final ArgumentCaptor<DataObjectIdentifier> deletedLinkIDs,
    ...
    static org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.NodeKey newInvNodeKey(
            final String id) {
        return new org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.NodeKey(
    ...
    static DataObjectIdentifier.WithKey<NodeConnector, NodeConnectorKey> newNodeConnID(
        ...
        return DataObjectIdentifier.builder(Nodes.class)
            ...
            .child(org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.node.NodeConnector.class, ncKey)
            .build();
    }
