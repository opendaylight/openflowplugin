...
import org.opendaylight.openflowplugin.applications.old.notification.supplier.impl.item.stat.ConnectorStatNotifSupplierImpl;
...
public class OldNotifProviderImpl implements OldNotifProvider {
    ...
    public void start() {
        ...
        connectorSupp = new ConnectorNotificationSupplierImpl(nps, db);
        ...
        connectorStatSupp = config.isNodeConnectorStatSupport() ? new ConnectorStatNotifSupplierImpl(nps, db) : null;
