 ...
 *
 */
public class MeterNotificationSupplierImpl extends AbstractNofitSupplierDefinition<Meter, MeterUpdated, MeterUpdated, MeterRemoved> {

    private final InstanceIdentifier<Meter> wildCardedInstanceIdent;
    ...
    @Override
    public MeterUpdated createNotification(final Meter o, final InstanceIdentifier<Meter> path) {
