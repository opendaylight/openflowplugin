...
public class ConnectorStatNotifSupplierImpl extends
        AbstractNofitSupplierDefinition<FlowCapableNodeConnectorStatistics, NodeConnectorStatisticsUpdate, NodeConnectorStatisticsUpdate, NodeConnectorStatisticsUpdate> {

    private final InstanceIdentifier<FlowCapableNodeConnectorStatistics> wildCardedInstanceIdent;
    ...
    @Override
    public NodeConnectorStatisticsUpdate updateNotification(final FlowCapableNodeConnectorStatistics o,
            final InstanceIdentifier<FlowCapableNodeConnectorStatistics> path) {
        // NOOP
        return null;
    }
    ...
    @Override
    public NodeConnectorStatisticsUpdate deleteNotification(
            final InstanceIdentifier<FlowCapableNodeConnectorStatistics> path) {
        // NOOP
        return null;
    }
