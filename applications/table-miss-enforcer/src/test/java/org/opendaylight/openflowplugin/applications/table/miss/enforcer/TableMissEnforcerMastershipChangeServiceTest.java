...
/**
 * Test for
 * {@link org.opendaylight.openflowplugin.applications.table.miss.enforcer.TableMissEnforcerMastershipChangeService}.
 */
...
public class TableMissEnforcerMastershipChangeServiceTest {
    ...
    private static final KeyedInstanceIdentifier<Node, NodeKey> NODE_INSTANCE_IDENTIFIER
            = InstanceIdentifier.create(Nodes.class).child(Node.class, new NodeKey(new NodeId("testnode:1")));
