...
public class TableMissUtils {
    ...
    static NodeId retreiveNodeId(DataTreeModification<Node> modification) {
    ...
    static boolean isDelete(final DataObjectModification<Node> nodeModification) {

        return Objects.nonNull(nodeModification.getDataBefore()) && Objects.isNull(nodeModification.getDataAfter())
                || !safeConnectorsEmpty(nodeModification.getDataBefore()) && safeConnectorsEmpty(nodeModification.getDataAfter());
    }

    static boolean isAdd(final DataObjectModification<Node> nodeModification) {
        return Objects.isNull(nodeModification.getDataBefore()) && Objects.nonNull(nodeModification.getDataAfter())
                || safeConnectorsEmpty(nodeModification.getDataBefore()) && !safeConnectorsEmpty(nodeModification.getDataAfter());
    }

    static boolean safeConnectorsEmpty(final Node node) {
        if (node == null) {
            return true;
        }
