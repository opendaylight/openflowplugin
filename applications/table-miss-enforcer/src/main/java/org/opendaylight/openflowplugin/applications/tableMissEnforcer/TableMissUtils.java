...
public class TableMissUtils {
    ...
    static NodeId retreiveNodeId(DataTreeModification<FlowCapableNode> modification) {
        final InstanceIdentifier<FlowCapableNode> nodeIdent = modification.getRootPath().getRootIdentifier();
        return nodeIdent.firstKeyOf(Node.class).getId();
    }

    static boolean isDelete(final DataTreeModification nodeModification) {
        return Objects.isNull(nodeModification.getRootNode().getDataAfter())
                && ModificationType.DELETE.equals(nodeModification.getRootNode().getModificationType())
                && !nodeModification.getRootPath().getRootIdentifier().isWildcarded();
    }

    static boolean isAdd(final DataTreeModification nodeModification) {
        return Objects.isNull(nodeModification.getRootNode().getDataBefore())
                && ModificationType.WRITE.equals(nodeModification.getRootNode().getModificationType())
                && !nodeModification.getRootPath().getRootIdentifier().isWildcarded();
    }
