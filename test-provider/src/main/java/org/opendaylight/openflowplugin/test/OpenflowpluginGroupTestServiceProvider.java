...
public class OpenflowpluginGroupTestServiceProvider implements AutoCloseable,
    ...
    public void close() throws Exception {
        ...
        RoutedRpcRegistration<SalGroupService> groupRegistration = getGroupRegistration();
    ...
    public CompositeObjectRegistration<OpenflowpluginGroupTestServiceProvider> register(
        ...
        RoutedRpcRegistration<SalGroupService> groupRegistration = this
                .getGroupRegistration();
        InstanceIdentifier<Node> instance = nodeIndentifier.toInstance();
