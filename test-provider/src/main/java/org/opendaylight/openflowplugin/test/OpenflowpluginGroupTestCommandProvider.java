...
public class OpenflowpluginGroupTestCommandProvider implements CommandProvider {
    ...
    public void onSessionInitiated(ProviderContext session) {
        ...
        // For switch events
        listener1Reg = notificationService.registerNotificationListener(groupEventListener);
    ...
    final class GroupEventListener implements SalGroupListener {
        ...
        public void onGroupAdded(GroupAdded notification) {
            System.out.println("Group to be added.........................."+notification.toString());
            System.out.println("Group  Xid........................."+notification.getTransactionId().getValue());
            System.out.println("-----------------------------------------------------------------------------------");
        ...
        public void onGroupRemoved(GroupRemoved notification) {
            System.out.println("Group to be removed.........................."+notification.toString());
            System.out.println("Group  Xid........................."+notification.getTransactionId().getValue());
            System.out.println("-----------------------------------------------------------------------------------");
        ...
        public void onGroupUpdated(GroupUpdated notification) {
            System.out.println("Group to be updated.........................."+notification.toString());
            System.out.println("Group  Xid........................."+notification.getTransactionId().getValue());
            System.out.println("-----------------------------------------------------------------------------------");
