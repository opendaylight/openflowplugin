...
class OpenflowpluginTestActivator extends AbstractBindingAwareProvider {
    ...
    var OpenflowDisconnectTestCommandProvider disconnectCmdProvider;
    ...
    override onSessionInitiated(ProviderContext session) {
        ...
        disconnectCmdProvider.onSessionInitiated(session);
    }
    ...
    override startImpl(BundleContext ctx) {
    	...
    	disconnectCmdProvider = new OpenflowDisconnectTestCommandProvider(ctx);
    }
