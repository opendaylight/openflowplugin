...
public class OpenflowpluginTestCommandProvider implements CommandProvider {
	...
	private Registration<org.opendaylight.yangtools.yang.binding.NotificationListener> listener;
	...
	public void onSessionInitiated(ProviderContext session) {
		...
		listener = notificationService.registerNotificationListener(portEventListener);
	...
	final class PortEventListener implements OpendaylightInventoryNotificationListener {

		@Override
		public void onNodeConnectorRemovedNotification(
				NodeConnectorRemovedNotification notification) {
		...
		@Override
		public void onNodeConnectorUpdatedNotification(
				NodeConnectorUpdatedNotification notification) {
			// TODO Auto-generated method stub
			InstanceIdentifier<NodeConnector> path = InstanceIdentifier.builder(Nodes.class)
					.child(Node.class, new NodeKey(new NodeId("openflow:1")))
					.child(NodeConnector.class, new NodeConnectorKey(notification.getId())).toInstance();

			DataObject object = dataBrokerService.readOperationalData(path);
			LOG.info("--------Node Connector Updated----------------",object);

		}

		@Override
		public void onNodeRemovedNotification(
				NodeRemovedNotification notification) {
			// TODO Auto-generated method stub
		...
		@Override
		public void onNodeUpdatedNotification(
				NodeUpdatedNotification notification) {
			// TODO Auto-generated method stub
			InstanceIdentifier<Node> path = InstanceIdentifier.builder(Nodes.class)
					.child(Node.class, new NodeKey(notification.getId())).toInstance();

			DataObject object = dataBrokerService.readOperationalData(path);
			LOG.info("----------Node Updated--------------",object);
