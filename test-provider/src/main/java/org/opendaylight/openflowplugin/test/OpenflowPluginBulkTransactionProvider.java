...
public class OpenflowPluginBulkTransactionProvider implements CommandProvider {
    ...
    final class FlowEventListener implements SalFlowListener {
        ...
        public void onFlowAdded(FlowAdded notification) {
            ...
            System.out.println(notification.getFlowRef().getValue().firstKeyOf(Node.class, NodeKey.class).getId()
                    .getValue().toString());
    ...
    // private
    // org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.meters.MeterBuilder
    // createTestMeter() {
    ...
    // Future<RpcResult<TransactionStatus>> commitFuture =
    // modification.commit();
    // try {
