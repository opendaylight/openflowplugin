...
public class OpenflowpluginTestRpcProvider implements AutoCloseable {
    ...
    private static final Logger LOG = LoggerFactory
            .getLogger(OpenflowpluginTestRpcProvider.class);

    private final DataBroker dataService;
    private Registration flowRegistration;
    ...
    public Registration register(final RpcProviderService rpcRegistry) {
        setFlowRegistration(rpcRegistry.registerRpcImplementations(this.getRpcClassToInstanceMap(), ImmutableSet.of(
