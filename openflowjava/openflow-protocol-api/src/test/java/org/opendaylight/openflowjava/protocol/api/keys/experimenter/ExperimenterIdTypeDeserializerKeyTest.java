...
public class ExperimenterIdTypeDeserializerKeyTest {
    ...
    public void testHashCodeAndEquals() {
        ExperimenterIdTypeDeserializerKey<?> key1 = new ExperimenterIdTypeDeserializerKey<>(
            EncodeConstants.OF10_VERSION_ID, 42L, 1L, ExperimenterMessage.class);
        ExperimenterIdTypeDeserializerKey<?> key2 = new ExperimenterIdTypeDeserializerKey<>(
            EncodeConstants.OF10_VERSION_ID, 42L, 1L, ExperimenterMessage.class);
    ...
    public void testEquals() {
        ExperimenterIdTypeDeserializerKey<?> key1 = new ExperimenterIdTypeDeserializerKey<>(
            EncodeConstants.OF10_VERSION_ID, 41L, 1L, ExperimenterMessage.class);
        ...
        ExperimenterIdTypeDeserializerKey<?> key3 = new ExperimenterIdTypeDeserializerKey<>(
            EncodeConstants.OF10_VERSION_ID, 41L, 2L, ExperimenterMessage.class);
        assertFalse("Wrong equal by type.", key1.equals(key3));
    }
