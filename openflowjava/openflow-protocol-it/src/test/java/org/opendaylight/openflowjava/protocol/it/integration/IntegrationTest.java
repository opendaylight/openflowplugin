...
public class IntegrationTest {
    ...
    public void setUp(final TransportProtocol protocol) throws Exception {
        ...
        switchConnectionProvider = new SwitchConnectionProviderImpl(connConfig, Mockito.mock(DiagStatusService.class), Mockito.mock(OpenflowPluginDiagStatusProvider.class));
