...
public class MatchDeserializerTest {
    ...
    public void testMatch() {
        ...
        Assert.assertEquals("Wrong entry value", 1,
                ((PacketTypeCase) entry40.getMatchEntryValue()).getPacketType().getNamespace().intValue());
        Assert.assertEquals("Wrong entry value", 0x894f,
                ((PacketTypeCase) entry40.getMatchEntryValue()).getPacketType().getType().intValue());
    }
