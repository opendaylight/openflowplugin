...
public class ChannelOutboundQueue02Test {
    ...
    public void test01() throws Exception {
        ...
        counter = 0;
        adapter.getRpcClassToInstanceMap().getInstance(Barrier.class).invoke(barrierInput);
        adapter.getRpcClassToInstanceMap().getInstance(Echo.class).invoke(echoInput);
        ...
        counter = 0;
        adapter.getRpcClassToInstanceMap().getInstance(Barrier.class).invoke(barrierInput);
        adapter.getRpcClassToInstanceMap().getInstance(Experimenter.class).invoke(experimenterInput);
        ec.runPendingTasks();
    ...
    public void test02() {
        ...
        ec.setWritable();
        adapter.getRpcClassToInstanceMap().getInstance(EchoReply.class).invoke(echoReplyInput);
        adapter.getRpcClassToInstanceMap().getInstance(Echo.class).invoke(echoInput);
        ec.runPendingTasks();
