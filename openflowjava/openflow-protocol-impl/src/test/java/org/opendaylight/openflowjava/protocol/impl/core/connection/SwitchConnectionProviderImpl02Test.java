...
public class SwitchConnectionProviderImpl02Test {
    ...
    public void testShutdownUnconfigured() throws Exception {
        ...
        assertEquals(Boolean.TRUE, Futures.getDone(provider.shutdown()));
    }
    ...
    public void testUnregisterExistingKeys() throws Exception {
        ...
        final var key3 = new ExperimenterInstructionSerializerKey(EncodeConstants.OF_VERSION_1_0, 42L);
        ...
        final var key8 = new ExperimenterIdDeserializerKey(EncodeConstants.OF_VERSION_1_0, Uint32.valueOf(42),
