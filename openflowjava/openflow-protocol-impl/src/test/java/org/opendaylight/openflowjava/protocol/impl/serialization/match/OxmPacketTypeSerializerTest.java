...
public class OxmPacketTypeSerializerTest {
    ...
    public void serializeTest() {
        ...
        MatchEntry matchEntry = createMatchEntry(namespace, ns_type);
        ...
        assertEquals(namespace, buffer.readUnsignedShort());
        assertEquals(ns_type, buffer.readUnsignedShort());
    }

    private MatchEntry createMatchEntry(int namespace, int type) {
        PacketTypeCase packetTypeCase = new PacketTypeCaseBuilder()
                .setPacketType(new PacketTypeBuilder().setNamespace(namespace).setType(type).build())
                .build();
