...
/**
 * Abstract OXM Basic match field superclass for {@code IN_PORT} and
 * {@code IN_PHY_PORT}.
 *
 * @author Simon Hunt
 */
public abstract class MFieldBasicBigPort extends MFieldBasic {
    BigPortNumber port;
     ...
     */
    MFieldBasicBigPort(ProtocolVersion pv, Header header) {
        super(pv, header);
    }
    ...
    public boolean equals(Object o) {
        ...
        MFieldBasicBigPort that = (MFieldBasicBigPort) o;
