...
/**
 * Mutable subclass of {@link OfmEchoRequest}.
 *
 * @author Scott Simes
 */
public class OfmMutableEchoRequest extends OfmEchoRequest
        implements MutableMessage {

    private final Mutable mutt = new Mutable();

    /**
     * Constructs a mutable OpenFlow ECHO_REQUEST message.
     *
     * @param header the message header
     */
    OfmMutableEchoRequest(Header header) {
        super(header);
    }
    ...
    public OpenflowMessage toImmutable() {
        ...
        OfmEchoRequest msg = new OfmEchoRequest(header);
        msg.data = this.data;
        return msg;
    }
     ...
     */
    public OfmMutableEchoRequest data(byte[] data) {
        mutt.checkWritable(this);
