...
/**
 * Unit tests for DecodeException.
 *
 * @author Simon Hunt
 */
public class DecodeExceptionTest extends AbstractExceptionTest {
    ...
    protected Exception createWithCause(Throwable cause) {
        return new DecodeException(cause);
    }

    @Override
    protected Exception createWithMsgAndCause(String msg, Throwable cause) {
        return new DecodeException(msg, cause);
    }
}
