...
public class DefaultFlowMod extends AbstractDefaultFacet
    ...
    // message strings
    protected static final String E_NULL_PARAMS = "Parameters cannot be null";
    protected static final String E_FLOW_UNSUPPORTED = "This flow {} is not supported by device type {}.";
    protected static final String E_VERSION_NOT_SUPPORTED = "Instructions are only supported on Openflow versions 1.3 and above";
     ...
     * @throws org.opendaylight.net.facet.FlowUnsupportedException if things go wrong
     */
