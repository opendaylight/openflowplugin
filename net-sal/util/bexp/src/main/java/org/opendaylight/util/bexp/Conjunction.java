...
/**
 * Binary conjunction (AND) of two other boolean expressions.
 *
...
public class Conjunction implements BooleanExpression {
    ...
    /**
     * Create a conjunction of the two specified boolean expressions. Note
     ...
     */
    public Conjunction(BooleanExpression bexp1, BooleanExpression bexp2) {
        this.bexp1 = bexp1;
        this.bexp2 = bexp2;
    }
