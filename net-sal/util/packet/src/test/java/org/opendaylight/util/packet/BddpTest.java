...
/**
 * BDDP packet unit tests.
 *
 * @author Frank Wood
 */
public class BddpTest extends PacketTest {

    private static final String BDDP_DATA = "eth2-bddp.hex";
    private static final int BDDP_DATA_LEN = 67;

    private static final MacAddress DST_MAC = mac("ff:ff:ff:ff:ff:ff");
    private static final MacAddress SRC_MAC = mac("00:00:00:00:00:01");
    private static final MacAddress CID_MAC = mac("00:00:00:00:00:01");
    private static final String PORT = "5";
    private static final int TTL = 120;
    private static final String SYS_DESC ="233366330652660427";

    private static final byte[] PRIV_0 = new byte[] {
        0x00, 0x26, (byte)0xe1, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x01
    };
