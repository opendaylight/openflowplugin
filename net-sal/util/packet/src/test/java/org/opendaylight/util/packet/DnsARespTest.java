 ...
 * @author Frank Wood
 */
public class DnsARespTest extends PacketTest {

    private static final String TEST_DATA_FILE
        = "eth2-ip-udp-dns-a-resp.hex";
    
    private static final String REQ_DATA_FILE
        = "eth2-ip-udp-dns-a-query.hex";
    
    private static final int PKT_LEN = 90;
    ...
    private static final int IP_IDENT = 0xcff9;
    private static final int IP_CHECK_SUM = 0x9539;
    ...
    private static final int UDP_LEN = 56;
    private static final int UDP_CHECK_SUM = 0xa317;

    private static final int TXID = 0x75c0;
    private static final int ANS_TTL = 82159;
    
    private static final String QUERY_NAME = "www.netbsd.org";
    private static final IpAddress ANS_IP = IpAddress.valueOf("204.152.190.12");
    ...
    private Packet create() {
        ...
        Dns dns = new Dns.Builder()
            ...
            .svrRecurAvail(true)
            .query(QUERY_NAME, A)
            .answer(QUERY_NAME, A, ANS_TTL, ANS_IP)
            .build();
    ...
    @Test
    public void encodeResponseFor() {
        print(EOL + "encodeResponseFor()");
        ...
        Packet reqPkt = Codec.decodeEthernet(getPacketReader(REQ_DATA_FILE));
        Dns reqDns = reqPkt.get(DNS);
        
        Dns respDns = new Dns.Builder()
            .responseFor(reqDns)
            .svrRecurAvail(true)
            .answer(QUERY_NAME, A, ANS_TTL, ANS_IP)
            .build();
        
        Packet pkt = new Packet(eth, ip, udp, respDns);
        print(pkt.toDebugString());
