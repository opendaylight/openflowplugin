...
/**
 * DNS A (IPv4 host) query unit tests.
 *
 * @author Frank Wood
 */
public class DnsAQueryTest extends PacketTest {
    ...
    private static final int IP_CHECK_SUM = 0x6543;
    ...
    private static final int UDP_CHECK_SUM = 0xaf61;
