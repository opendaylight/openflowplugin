...
/**
 * ICMPv6 Router Advertisement packet unit tests.
 *
 * @author Frank Wood
 */
public class IcmpRaV6Test extends PacketTest {

    private static final String IPV6_ICMPV6 = "eth2-ipv6-icmpv6-ra.hex";
    private static final int IPV6_ICMPV6_LEN = 110;

    private static final MacAddress DST_MAC = mac("33:33:00:00:00:01");
    private static final MacAddress SRC_MAC = mac("00:11:25:82:95:b5");

    private static final IpAddress SRC_IP = ip("fe80::211:25ff:fe82:95b5");
    private static final IpAddress DST_IP = ip("ff02::1");

    private static final MacAddress SRC_LL_MAC = mac("00:11:25:82:95:b5");

    private static final int FLOW_LABEL = 0x00;
    private static final int UPPER_LAYER_LEN = 56;
    ...
    private static final int CHECK_SUM = 0x79d2;

    private static final byte[] PREFIX_BYTES = new byte[] {
        0x40, (byte)0xc0, 0x00, 0x27, (byte)0x8d, 0x00, 0x00, 0x09,
        0x3a, (byte)0x80, 0x00, 0x00, 0x00, 0x00, 0x20, 0x01,
        0x06, (byte)0xf8, 0x10, 0x2d, 0x00, 0x00, 0x00, 0x00,
    ...
    private void verifyIp(Packet pkt) {
        ...
        assertEquals(0, ra.reachableTime());
        assertEquals(0, ra.retransTimer());
        ...
        assertEquals(IcmpOptionV6.Type.PREFIX_INFO, options[1].type());
        assertArrayEquals(PREFIX_BYTES, options[1].bytes());
    }
