...
/**
 * DNS MX query unit tests.
 *
 * @author Frank Wood
 */
public class DnsMxQueryTest extends PacketTest {

    private static final String TEST_DATA_FILE
        = "eth2-ip-udp-dns-mx-query.hex";
    ...
    private static final int UDP_CHECK_SUM = 0x9eb0;
    ...
    private void verify(Packet pkt) {
        ...
        assertEquals(RecordType.MX, q.recType());
        
        // verify equals method
        Record aRec = new Record(QUERY_NAME, RecordType.MX);
        assertEquals(aRec, q);
    }
    ...
    private Packet create() {
        ...
        Dns dns = new Dns.Builder()
            ...
            .opCode(OpCode.QUERY)
            .recurDesired(true)
            .query(QUERY_NAME, RecordType.MX)
            .build();
