...
/**
 * DHCP Discovery #2 packet unit tests.
 *
 * @author Frank Wood
 */
public class DhcpDisco2Test extends PacketTest {

    private static final String ETH2_DHCP_REQ = "eth2-ip-udp-dhcp-disco2.hex";
    ...
    private static final long UDP_CHECK_SUM = 0x07333;
    ...
    public void flags() {
        ...
        assertEquals(0x08000, dhcp.flag().code());
    }
