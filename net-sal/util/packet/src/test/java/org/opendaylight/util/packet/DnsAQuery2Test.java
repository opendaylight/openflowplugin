...
/**
 * DNS A (IPv4 host) query #2 unit tests.
 *
 * @author Frank Wood
 */
public class DnsAQuery2Test extends PacketTest {

    private static final String TEST_DATA_FILE
        = "eth2-ip-udp-dns-a2-query.hex";
    ...
    private static final int IP_CHECK_SUM = 0xb8ff;
    
    private static final TcpUdpPort SRC_PORT = TcpUdpPort.udpPort(43015);
    private static final TcpUdpPort DST_PORT = TcpUdpPort.udpPort(53);
    private static final int UDP_LEN = 36;
    private static final int UDP_CHECK_SUM = 0x38e1;
    ...
    private void verify(Packet pkt) {
        ...
        Record aRec = new Record(QUERY_NAME, A);
        assertEquals(aRec, q);
    }
