...
/**
 * DNS TXT query unit tests.
 *
 * @author Frank Wood
 */
public class DnsTxtQueryTest extends PacketTest {

    private static final String TEST_DATA_FILE
        = "eth2-ip-udp-dns-txt-query.hex";
    
    private static final int PKT_LEN = 70;
    ...
    private static final int IP_CHECK_SUM = 0x6547;
    ...
    private static final int UDP_LEN = 36;
    private static final int UDP_CHECK_SUM = 0x85ed;
    ...
    private void verify(Packet pkt) {
        ...
        assertEquals(TXT, q.recType());
        
        // verify equals method
        Record aRec = new Record(QUERY_NAME, TXT);
        assertEquals(aRec, q);
