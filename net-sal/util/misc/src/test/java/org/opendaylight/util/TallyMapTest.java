...
/**
 * This JUnit test class tests the TallyMap class.
 *
 * @author Simon Hunt
 */
public class TallyMapTest {
    ...
    private TallyMap<Fruit> tally;

    @Before
    public void before() {
        tally = new TallyMap<Fruit>();
        checkCounts(0, 0, 0, 0);
    }
    ...
    private void checkCounts(int apples, int oranges, int bananas, int pears) {
    ...
    private void checkTotalHigh(int total, Fruit high) {
