...
public class EthernetData {
    ...
    public static EthernetData toEthernetData(Match match) {
    ...
    public boolean isSame(Match match) {
        ...
        if ((etherData.etherType != this.etherType)
           && (etherData.etherType != -1) && (this.etherType != -1)) {
            return false;
        }
        if ((etherData.srcMac != this.srcMac)
           && (etherData.srcMac != -1) && (this.srcMac != -1)) {
            return false;
        }
        if ((etherData.dstMac != this.dstMac)
           && (etherData.dstMac != -1) && (this.dstMac != -1)) {
            return false;
        }
        return true;
    }
