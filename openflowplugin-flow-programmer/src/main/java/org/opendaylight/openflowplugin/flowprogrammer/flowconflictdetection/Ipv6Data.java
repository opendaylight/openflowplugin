...
public class Ipv6Data {
    ...
    public boolean isSame(Ipv6Match match) {
        ...
        if ((ipv6Data.ipv6Src != this.ipv6Src)
           && (ipv6Data.ipv6Src != Long.valueOf(-1)) && (this.ipv6Src != Long.valueOf(-1))) {
            return false;
        }
        if ((ipv6Data.ipv6Dst != this.ipv6Dst)
           && (ipv6Data.ipv6Dst != Long.valueOf(-1)) && (this.ipv6Dst != Long.valueOf(-1))) {
            return false;
        }
        return true;
    }
