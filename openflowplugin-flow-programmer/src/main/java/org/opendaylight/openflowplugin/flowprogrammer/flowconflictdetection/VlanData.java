...
public class VlanData {
    ...
    public boolean isSame(VlanMatch match) {
        ...
        if ((vlanData.vlanId != this.vlanId)
           && (vlanData.vlanId != Integer.valueOf((short)(-1)))
           && (this.vlanId != Integer.valueOf((short)(-1)))) {
            return false;
        }
        if (vlanData.vlanIdPresent != this.vlanIdPresent) {
            return false;
        }
        if ((vlanData.vlanPcp != this.vlanPcp)
           && (vlanData.vlanPcp != Short.valueOf((short)(-1)))
           && (this.vlanPcp != Short.valueOf((short)(-1)))) {
            return false;
        }
        return true;
    }
