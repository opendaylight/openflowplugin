...
public class L4Data {
    ...
    public boolean isSame(Layer4Match l4Match) {
        ...
        if (!l4Data.srcPort.equals(this.srcPort)
            && !l4Data.srcPort.equals(Integer.valueOf(-1))
            && !this.srcPort.equals(Integer.valueOf(-1))) {
            return false;
        }
        if (!l4Data.dstPort.equals(this.dstPort)
            && !l4Data.dstPort.equals(Integer.valueOf(-1))
            && !this.dstPort.equals(Integer.valueOf(-1))) {
            return false;
        }
        return true;
    }
