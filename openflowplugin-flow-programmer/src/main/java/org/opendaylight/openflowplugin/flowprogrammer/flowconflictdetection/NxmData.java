...
public class NxmData {
    ...
    public boolean isSame(GeneralAugMatchNodesNodeTableFlow m) {
        ...
        if (!nxmData.nxmNxArpSha.equals(this.nxmNxArpSha)
            && !nxmData.nxmNxArpSha.equals(Long.valueOf(-1))
            && !this.nxmNxArpSha.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxArpTha.equals(this.nxmNxArpTha)
           && !nxmData.nxmNxArpTha.equals(Long.valueOf(-1))
           && !this.nxmNxArpTha.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxNshc1.equals(this.nxmNxNshc1)
            && !nxmData.nxmNxNshc1.equals(Long.valueOf(-1))
            && !this.nxmNxNshc1.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxNshc2.equals(this.nxmNxNshc2)
            && !nxmData.nxmNxNshc2.equals(Long.valueOf(-1))
            && !this.nxmNxNshc2.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxNshc3.equals(this.nxmNxNshc3)
            && !nxmData.nxmNxNshc3.equals(Long.valueOf(-1))
            && !this.nxmNxNshc3.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxNshc4.equals(this.nxmNxNshc4)
            && !nxmData.nxmNxNshc4.equals(Long.valueOf(-1))
            && !this.nxmNxNshc4.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxNsi.equals(this.nxmNxNsi)
            && !nxmData.nxmNxNsi.equals(Short.valueOf((short)(-1)))
            && !this.nxmNxNsi.equals(Short.valueOf((short)(-1)))) {
            return false;
        }
        if (!nxmData.nxmNxNsp.equals(this.nxmNxNsp)
            && !nxmData.nxmNxNsp.equals(Long.valueOf(-1))
            && !this.nxmNxNsp.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxReg0.equals(this.nxmNxReg0)
            && !nxmData.nxmNxReg0.equals(Long.valueOf(-1))
            && !this.nxmNxReg0.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxReg1.equals(this.nxmNxReg1)
            && !nxmData.nxmNxReg1.equals(Long.valueOf(-1))
            && !this.nxmNxReg1.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxReg2.equals(this.nxmNxReg2)
            && !nxmData.nxmNxReg2.equals(Long.valueOf(-1))
            && !this.nxmNxReg2.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxReg3.equals(this.nxmNxReg3)
            && !nxmData.nxmNxReg3.equals(Long.valueOf(-1))
            && !this.nxmNxReg3.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxReg4.equals(this.nxmNxReg4)
            && !nxmData.nxmNxReg4.equals(Long.valueOf(-1))
            && !this.nxmNxReg4.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxReg5.equals(this.nxmNxReg5)
            && !nxmData.nxmNxReg5.equals(Long.valueOf(-1))
            && !this.nxmNxReg5.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxReg6.equals(this.nxmNxReg6)
            && !nxmData.nxmNxReg6.equals(Long.valueOf(-1))
            && !this.nxmNxReg6.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxReg7.equals(this.nxmNxReg7)
            && !nxmData.nxmNxReg6.equals(Long.valueOf(-1))
            && !this.nxmNxReg6.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxTunId.equals(this.nxmNxTunId)
            && !nxmData.nxmNxTunId.equals(BigInteger.valueOf(-1))
            && !this.nxmNxTunId.equals(BigInteger.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxTunIpv4Dst.equals(this.nxmNxTunIpv4Dst)
            && !nxmData.nxmNxTunIpv4Dst.equals(Long.valueOf(-1))
            && !this.nxmNxTunIpv4Dst.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmNxTunIpv4Src.equals(this.nxmNxTunIpv4Src)
            && !nxmData.nxmNxTunIpv4Src.equals(Long.valueOf(-1))
            && !this.nxmNxTunIpv4Src.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmOfArpOp.equals(this.nxmOfArpOp)
            && !nxmData.nxmOfArpOp.equals(Integer.valueOf(-1))
            && !this.nxmOfArpOp.equals(Integer.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmOfArpSpa.equals(this.nxmOfArpSpa)
            && !nxmData.nxmOfArpSpa.equals(Long.valueOf(-1))
            && !this.nxmOfArpSpa.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmOfArpTpa.equals(this.nxmOfArpTpa)
            && !nxmData.nxmOfArpTpa.equals(Long.valueOf(-1))
            && !this.nxmOfArpTpa.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmOfEthDst.equals(this.nxmOfEthDst)
            && !nxmData.nxmOfEthDst.equals(Long.valueOf(-1))
            && !this.nxmOfEthDst.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmOfEthSrc.equals(this.nxmOfEthSrc)
            && !nxmData.nxmOfEthSrc.equals(Long.valueOf(-1))
            && !this.nxmOfEthSrc.equals(Long.valueOf(-1))) {
            return false;
        }
        if (!nxmData.nxmOfEthType.equals(this.nxmOfEthType)
            && !nxmData.nxmOfEthType.equals(Integer.valueOf(-1))
            && !this.nxmOfEthType.equals(Integer.valueOf(-1))) {
            return false;
        }
        return true;
    }
