...
public class ArpData {
    ...
    public boolean isSame(ArpMatch match) {
        ...
        if ((arpData.arpOp != this.arpOp)
           && (arpData.arpOp != Integer.valueOf(-1)) && (this.arpOp != Integer.valueOf(-1))) {
            return false;
        }
        if ((arpData.srcMac != this.srcMac)
           && (arpData.srcMac != Long.valueOf(-1)) && (this.srcMac != Long.valueOf(-1))) {
            return false;
        }
        if ((arpData.dstMac != this.dstMac)
           && (arpData.dstMac != Long.valueOf(-1)) && (this.dstMac != Long.valueOf(-1))) {
            return false;
        }
        if ((arpData.ipv4Src != this.ipv4Src)
           && (arpData.ipv4Src != Long.valueOf(-1)) && (this.ipv4Src != Long.valueOf(-1))) {
            return false;
        }
        if ((arpData.ipv4Dst != this.ipv4Dst)
           && (arpData.ipv4Dst != Long.valueOf(-1)) && (this.ipv4Dst != Long.valueOf(-1))) {
            return false;
        }
        return true;
    }
