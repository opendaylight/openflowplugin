...
public class Ipv4Data {
    ...
    public boolean isSame(Ipv4Match match) {
        ...
        if ((ipv4Data.ipv4Src != this.ipv4Src)
           && (ipv4Data.ipv4Src != Long.valueOf(-1)) && (this.ipv4Src != Long.valueOf(-1))) {
            return false;
        }
        if ((ipv4Data.ipv4Dst != this.ipv4Dst)
           && (ipv4Data.ipv4Dst != Long.valueOf(-1)) && (this.ipv4Dst != Long.valueOf(-1))) {
            return false;
        }
        return true;
    }
