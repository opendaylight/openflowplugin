 ...
 *
 */
public interface CiscoExtensionCodecRegistrator {

    void registerActionDeserializer(CiscoActionDeserializerKey key, OFDeserializer<Action> deserializer);

    void unregisterActionDeserializer(CiscoActionDeserializerKey key);

    void registerActionSerializer(CiscoActionSerializerKey key, OFSerializer<Action> serializer);

    void unregisterActionSerializer(CiscoActionSerializerKey key);
