...
public class NextHopCodecTest {
    ...
    public void testSerialize2() {
        ...
        String expected = "ff ff 00 24 00 00 00 0c 00 01 03 01 ef ff ff fe 00 00 00 00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f 10";
        Assert.assertEquals(expected , ByteBufUtils.byteBufToHexString(buffer));
    }
    ...
    public void testSerialize3() {
        ...
        String expected = "ff ff 00 1a 00 00 00 0c 00 01 04 01 ef ff ff fe 00 00 00 00 01 02 03 04 05 06";
        Assert.assertEquals(expected , ByteBufUtils.byteBufToHexString(buffer));
    }
    ...
    public void testSerialize4() {
        ...
        String expected = "ff ff 00 14 00 00 00 0c 00 01 01 01 ef ff ff fe 00 00 00 00";
        Assert.assertEquals(expected , ByteBufUtils.byteBufToHexString(buffer));
    }
    ...
    public void testDeserialize4() {
        String input = "ff ff 00 14 00 00 00 0c 00 01 01 01 ef ff ff fe 00 00 00 00";
        ByteBuf buffer = ByteBufUtils.hexStringToByteBuf(input);
        Action action = NextHopCodec.getInstance().deserialize(buffer);
