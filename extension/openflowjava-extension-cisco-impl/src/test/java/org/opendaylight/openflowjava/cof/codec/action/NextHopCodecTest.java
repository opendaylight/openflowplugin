...
public class NextHopCodecTest {
    ...
    /**
     * Test method for {@link org.opendaylight.openflowjava.cof.codec.action.NextHopCodec#serialize(org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.action.rev150203.actions.grouping.Action, io.netty.buffer.ByteBuf)}.
     * <p/>
     * use port+ivp4
     */
    @Test
    public void testSerialize1() {
        ...
        OfjCofActionOutputNhBuilder cofActionBld = new OfjCofActionOutputNhBuilder().setActionOutputNh(nhBld.build());
    ...
    public void testDeserialize1() {
        ...
        ActionOutputNh nextHopAction = ((OfjCofActionOutputNh) action.getActionChoice()).getActionOutputNh();
