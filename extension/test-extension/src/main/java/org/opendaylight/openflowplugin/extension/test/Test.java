...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.general.rev140714.nodes.node.table.flow.instructions.instruction.instruction.apply.actions._case.apply.actions.action.action.ExtensionCaseBuilder;
...
//        match.addAugmentation(extAugmentWrapper.getAugmentationClass(), extAugmentWrapper.getAugmentationObject());
    ...
    private static ActionBuilder createNxActionBld() {
        // vendor part
        NxRegCaseBuilder nxRegCaseBld = new NxRegCaseBuilder().setNxReg(NxmNxReg0.class);
        ...
        NxAugActionNodesNodeTableFlowApplyActionsCaseBuilder topNxActionAugmentation = new NxAugActionNodesNodeTableFlowApplyActionsCaseBuilder();
        ...
        extensionBuilder.addAugmentation(NxAugActionNodesNodeTableFlowApplyActionsCase.class, topNxActionAugmentation.build());
        ExtensionCaseBuilder extCaseBld = new ExtensionCaseBuilder()
            .setType(NxActionRegLoadKey.class)
