...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.extension.nicira.match.rev140421.ofj.nxm.of.match.eth.src.grouping.EthSrcValuesBuilder;
    ...
    public MatchEntries convert(Extension extension) {
        ...
        return MatchUtil
                .createNiciraMatchEntries(
                        Nxm1Class.class,
                        org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.extension.nicira.match.rev140421.NxmOfEthSrc.class,
