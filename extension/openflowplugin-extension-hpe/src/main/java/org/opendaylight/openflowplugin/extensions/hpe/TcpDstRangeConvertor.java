...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extensions.hpe.rev151112.HpeTcpDstRangeKey;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extensions.hpe.rev151112.OfjHpeOfMatchTcpDstRangeGrouping;
...
public class TcpDstRangeConvertor extends HpeAbstractConvertor<OfjHpeOfMatchTcpDstRangeGrouping> {
    public TcpDstRangeConvertor() {
        super(HpeTcpDstRangeKey.class, HpeOfTcpDstRange.class, false, OfjHpeOfMatchTcpDstRangeGrouping.class);
    }
        ...
        switch (path) {
            case FLOWSSTATISTICSUPDATE_FLOWANDSTATISTICSMAPLIST_MATCH:
                return new ExtensionAugment<>(HpeAugMatchNotifUpdateFlowStats.class,
                        new HpeAugMatchNotifUpdateFlowStatsBuilder().setTcpDstRangeValues(tcpDstRangeValues).build(), this.key);
            case PACKETRECEIVED_MATCH:
                return new ExtensionAugment<>(HpeAugMatchNotifPacketIn.class,
                        new HpeAugMatchNotifPacketInBuilder().setTcpDstRangeValues(tcpDstRangeValues).build(), this.key);
            case SWITCHFLOWREMOVED_MATCH:
                return new ExtensionAugment<>(HpeAugMatchNotifSwitchFlowRemoved.class,
                        new HpeAugMatchNotifSwitchFlowRemovedBuilder().setTcpDstRangeValues(tcpDstRangeValues).build(), this.key);
            default:
    ...
    protected void convertToOFJava(Extension extension, OfjAugHpeMatchBuilder ofjAugHpeMatchBuilder) {
        OfjHpeOfMatchTcpDstRangeGrouping tcpDstRangeGrouping = getExtension(extension);
        TcpDstRangeValues tcpDstRangeValues = tcpDstRangeGrouping.getTcpDstRangeValues();
        TcpDstRangeValuesBuilder tcpDstRangeValuesBuilder = new TcpDstRangeValuesBuilder();
        tcpDstRangeValuesBuilder.setBegin(tcpDstRangeValues.getBegin());
        tcpDstRangeValuesBuilder.setEnd(tcpDstRangeValues.getEnd());
