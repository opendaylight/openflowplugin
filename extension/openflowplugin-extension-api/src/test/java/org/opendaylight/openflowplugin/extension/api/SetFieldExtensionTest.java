...
public class SetFieldExtensionTest {
    ...
    public void testGetExtension() {
        ...
        Assert.assertEquals(ZVendorExt1.class,
                eqGroup.getExtension(setField1).get().getExtensionList().values().iterator().next().getExtensionKey());
        Assert.assertEquals(ZVendorExt2.class,
                eqGroup.getExtension(setField2).get().getExtensionList().values().iterator().next().getExtensionKey());
    }
