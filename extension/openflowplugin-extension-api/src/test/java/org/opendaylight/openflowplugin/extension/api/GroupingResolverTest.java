...
public class GroupingResolverTest {
    ...
    public void testGetExtension() {
        ...
        ExtensionList extension1 = new ExtensionListBuilder().setType(JoachimTheBig.class).build();
        ...
        ExtensionList extension2 = new ExtensionListBuilder().setType(JoachimTheTiny.class).build();
        ...
        Assert.assertEquals(JoachimTheBig.class, eqGroup.getExtension(match1).get().getExtensionList().get(0).getType());
        Assert.assertEquals(JoachimTheTiny.class, eqGroup.getExtension(match2).get().getExtensionList().get(0).getType());
    }
