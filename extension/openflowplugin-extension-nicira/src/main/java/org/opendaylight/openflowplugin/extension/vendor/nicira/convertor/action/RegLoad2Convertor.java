...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421.ofj.nx.action.reg.load._2.grouping.NxActionRegLoad2;
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421.ofj.nx.action.reg.load._2.grouping.NxActionRegLoad2Builder;
...
public class RegLoad2Convertor implements
    ...
    private static NxRegLoad resolveRegLoad(MatchEntry matchEntry) {
        ...
        OfjAugNxExpMatch ofjAugNxExpMatch = experimenterIdCase.getAugmentation(OfjAugNxExpMatch.class);
