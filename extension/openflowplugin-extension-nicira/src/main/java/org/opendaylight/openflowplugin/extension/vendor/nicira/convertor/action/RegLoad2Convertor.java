...
public class RegLoad2Convertor implements
    ...
    @Override
    public org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.Action convert(final Action input,
    ...
    private static NxRegLoad resolveRegLoad(final Uint8 value, @Nullable final Uint8 mask, final int valueLength, final DstBuilder dstBuilder) {
    ...
    private static NxRegLoad resolveRegLoad(final Uint32 value, @Nullable final Uint32 mask, final int valueLength,
            final DstBuilder dstBuilder) {
        return resolveRegLoad(
            Uint64.valueOf(value),
                mask == null ? null : Uint64.valueOf(mask),
