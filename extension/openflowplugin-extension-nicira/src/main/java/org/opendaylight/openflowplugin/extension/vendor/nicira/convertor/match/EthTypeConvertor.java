...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.extension.nicira.match.rev140421.ofj.nxm.of.match.eth.type.grouping.EthTypeValues;
    ...
    public MatchEntries convert(Extension extension) {
        ...
        return MatchUtil
                .createNiciraMatchEntries(
                        Nxm0Class.class,
                        org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.extension.nicira.match.rev140421.NxmOfEthType.class,
