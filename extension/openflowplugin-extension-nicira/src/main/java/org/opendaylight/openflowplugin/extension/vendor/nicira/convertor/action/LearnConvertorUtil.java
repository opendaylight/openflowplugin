...
public class LearnConvertorUtil {
    ...
    private static org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421.flow.mod.spec.FlowModSpec buildFlowModSpec(FlowModSpec flowModSpec) {
        if(flowModSpec instanceof FlowModAddMatchFromFieldCase){
            ...
            caseBuilder.setFlowModAddMatchFromField(flowModAdd.build());
            return caseBuilder.build();
        } else if(flowModSpec instanceof FlowModAddMatchFromValueCaseBuilder){
            FlowModAddMatchFromValue flowModAdd2 = ((FlowModAddMatchFromValueCaseBuilder) flowModSpec).getFlowModAddMatchFromValue(); 
            ...
            caseBuilder.setFlowModAddMatchFromValue(flowModAdd.build());
            return caseBuilder.build();
        } else if(flowModSpec instanceof FlowModCopyFieldIntoFieldCaseBuilder){
            FlowModCopyFieldIntoField flowModCopy2 = ((FlowModCopyFieldIntoFieldCaseBuilder) flowModSpec).getFlowModCopyFieldIntoField(); 
