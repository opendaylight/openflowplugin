...
public class ConntrackConvertor implements
    ...
    private List<org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421.ofj.nx.action.conntrack
        ...
        for ( CtActions ctAction : action.getCtActions()) {
            OfpactActions natAction = ctAction.getOfpactActions();
            if (natAction instanceof org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.nicira
                    .action.rev140714.ofpact.actions.ofpact.actions.NxActionNatCase) {
                org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.nicira.action.rev140714.ofpact
                    .actions.ofpact.actions.nx.action.nat._case.NxActionNat nxActionNat = ((org.opendaylight.yang.gen.v1
                    .urn.opendaylight.openflowplugin.extension.nicira.action.rev140714.ofpact.actions.ofpact
                    .actions.NxActionNatCase) natAction).getNxActionNat();
