...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.nicira.action.rev140714.ofpact.actions.ofpact.actions.NxActionCtLabelCase;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.nicira.action.rev140714.ofpact.actions.ofpact.actions.NxActionCtLabelCaseBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.nicira.action.rev140714.ofpact.actions.ofpact.actions.nx.action.ct.label._case.NxActionCtLabel;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.nicira.action.rev140714.ofpact.actions.ofpact.actions.nx.action.ct.label._case.NxActionCtLabelBuilder;
        ...
        for (org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421.ofj.nx.action.conntrack
            ...
            if (ofpactAction instanceof org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421
                ...
                ctActions.add(ctActionsBuilder.build());
                    ...
                    .ofpact.actions.ofpact.actions.NxActionCtLabelCase) {
                org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421.ofpact.actions.ofpact
                    .actions.nx.action.ct.label._case.NxActionCtLabel nxActionCtLabel = ((org.opendaylight.yang.gen.v1.urn
                            .opendaylight.openflowjava.nx.action.rev140421.ofpact.actions.ofpact.actions
                            .NxActionCtLabelCase) ofpactAction).getNxActionCtLabel();
                NxActionCtLabelBuilder nxActionCtLabelBuilder = new NxActionCtLabelBuilder();
                nxActionCtLabelBuilder.setCtLabel(nxActionCtLabel.getCtLabel());
                nxActionCtLabelBuilder.setMask(nxActionCtLabel.getMask());
                NxActionCtLabelCaseBuilder caseBuilder = new NxActionCtLabelCaseBuilder();
                caseBuilder.setNxActionCtLabel(nxActionCtLabelBuilder.build());
                CtActionsBuilder ctActionsBuilder = new CtActionsBuilder();
                ctActionsBuilder.setOfpactActions(caseBuilder.build());
                ctActions.add(ctActionsBuilder.build());
            } else if (ofpactAction instanceof org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421
                ...
                nxActionCtMarkBuilder.setMask(nxActionCtMark.getMask());
    ...
    private List<org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421.ofj.nx.action.conntrack
        ...
        for (CtActions ctAction : action.getCtActions()) {
            ...
            if (ofpactAction instanceof NxActionNatCase) {
                ...
                ctActionsBuilder.setOfpactActions(caseBuilder.build());
                ctActions.add(ctActionsBuilder.build());
            } else if (ofpactAction instanceof NxActionCtLabelCase) {
                NxActionCtLabel nxActionCtLabel = ((NxActionCtLabelCase) ofpactAction).getNxActionCtLabel();
                org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421.ofpact.actions.ofpact
                    .actions.nx.action.ct.label._case.NxActionCtLabelBuilder nxActionCtLabelBuilder = new org.opendaylight.yang.gen
                    .v1.urn.opendaylight.openflowjava.nx.action.rev140421.ofpact.actions.ofpact.actions.nx.action.ct.label
                    ._case.NxActionCtLabelBuilder();
                nxActionCtLabelBuilder.setCtLabel(nxActionCtLabel.getCtLabel());
                nxActionCtLabelBuilder.setMask(nxActionCtLabel.getMask());
                org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421.ofpact.actions.ofpact
                    .actions.NxActionCtLabelCaseBuilder caseBuilder = new org.opendaylight.yang.gen.v1.urn.opendaylight
                    .openflowjava.nx.action.rev140421.ofpact.actions.ofpact.actions.NxActionCtLabelCaseBuilder();
                caseBuilder.setNxActionCtLabel(nxActionCtLabelBuilder.build());
                org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.action.rev140421.ofj.nx.action.conntrack
                    .grouping.nx.action.conntrack.CtActionsBuilder ctActionsBuilder = new org.opendaylight.yang.gen.v1
                    .urn.opendaylight.openflowjava.nx.action.rev140421.ofj.nx.action.conntrack.grouping.nx.action
