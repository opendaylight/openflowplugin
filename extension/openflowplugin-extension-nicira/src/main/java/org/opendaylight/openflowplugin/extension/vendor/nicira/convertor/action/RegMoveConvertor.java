...
public class RegMoveConvertor implements
    ...
    public static DstChoice resolveDst(long dstValue) {
        ...
        if (dstValue == NiciraMatchCodecs.NXM_OF_MPLS_LABEL_CODEC.getHeaderWithoutHasMask().toLong()) {
    ...
    public static long resolveDst(DstChoice dstChoice) {
        ...
        if (dstChoice instanceof DstOfMplsLabelCase) {
            return NiciraMatchCodecs.NXM_OF_MPLS_LABEL_CODEC.getHeaderWithoutHasMask().toLong();
        }
