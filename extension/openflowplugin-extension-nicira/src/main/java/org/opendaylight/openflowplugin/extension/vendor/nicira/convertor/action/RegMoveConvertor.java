...
public class RegMoveConvertor implements
    ...
    public Action convert(
        ...
        nxActionRegMove.setDst(FieldChoiceResolver.resolveDstHeaderAsBigInt(dst.getDstChoice()));
        nxActionRegMove.setDstOfs(dst.getStart());
        nxActionRegMove.setSrc(FieldChoiceResolver.resolveSrcHeaderAsBigInt(src.getSrcChoice()));
