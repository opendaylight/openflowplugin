...
public class SetNsiConvertorTest {
    ...
    public void testConvert() throws Exception {
        ...
        Assert.assertEquals(Short.valueOf((short) 1), actionSetNsi.getNxActionSetNsi().getNsi());
    }
    ...
    public void testConvert1() throws Exception {
        ...
        Assert.assertEquals(Short.valueOf((short) 3), ((NxActionSetNsiNodesNodeTableFlowWriteActionsCase) actionResult).getNxSetNsi().getNsi());
        Assert.assertEquals(Short.valueOf((short) 3), ((NxActionSetNsiNotifFlowsStatisticsUpdateWriteActionsCase) actionResult1).getNxSetNsi().getNsi());
        Assert.assertEquals(Short.valueOf((short) 3), ((NxActionSetNsiNotifFlowsStatisticsUpdateApplyActionsCase) actionResult2).getNxSetNsi().getNsi());
        Assert.assertEquals(Short.valueOf((short) 3), ((NxActionSetNsiNotifGroupDescStatsUpdatedCase) actionResult3).getNxSetNsi().getNsi());
    }
