...
public class Nshc1ConvertorTest {
    ...
    public void testConvertToOFSal() {
        ...
        Assert.assertEquals(NSHC1_VALUE,
                ((NxAugMatchNotifNodesNodeTableFlow) extensionAugment2.getAugmentationObject()).getNxmNxNshc1().getValue());
        Assert.assertEquals(MASK_VALUE,
                ((NxAugMatchNotifNodesNodeTableFlow) extensionAugment2.getAugmentationObject()).getNxmNxNshc1().getMask());
        Assert.assertEquals(extensionAugment.getKey(), NxmNxNshc1Key.class);
