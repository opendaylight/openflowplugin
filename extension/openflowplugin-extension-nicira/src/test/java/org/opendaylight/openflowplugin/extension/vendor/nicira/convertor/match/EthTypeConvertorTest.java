...
public class EthTypeConvertorTest {
    ...
    public void testConvert1() {
        ...
        final var extensionAugment = ethTypeConvertor
        ...
        final var extensionAugment1 = ethTypeConvertor.convert(matchEntry, MatchPath.SWITCH_FLOW_REMOVED_MATCH);
        ...
        final var extensionAugment2 = ethTypeConvertor.convert(matchEntry, MatchPath.FLOWS_STATISTICS_UPDATE_MATCH);
        Assert.assertEquals(1, ((NxAugMatchNodesNodeTableFlow) extensionAugment2.getAugmentationObject())
                .getNxmOfEthType().getValue().intValue());
        Assert.assertEquals(NxmOfEthTypeKey.VALUE, extensionAugment.getKey());

        final var extensionAugment3 = ethTypeConvertor.convert(matchEntry, MatchPath.FLOWS_STATISTICS_RPC_MATCH);
