...
public class Nshc2ConvertorTest {
    ...
    public void testConvertToOFSal() {
        ...
        Assert.assertEquals(NSHC2_VALUE, ((NxAugMatchNotifNodesNodeTableFlow)
                extensionAugment2.getAugmentationObject()).getNxmNxNshc2().getValue());
        Assert.assertEquals(MASK_VALUE, ((NxAugMatchNotifNodesNodeTableFlow)
                        extensionAugment2.getAugmentationObject()).getNxmNxNshc2().getMask());
        Assert.assertEquals(extensionAugment.getKey(), NxmNxNshc2Key.class);
