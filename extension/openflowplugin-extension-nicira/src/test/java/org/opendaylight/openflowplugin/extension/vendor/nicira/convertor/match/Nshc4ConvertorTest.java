...
public class Nshc4ConvertorTest {
    ...
    public void testConvertToOFSal() {
        ...
        Assert.assertEquals(NSHC4_VALUE,
                ((NxAugMatchNotifNodesNodeTableFlow) extensionAugment2.getAugmentationObject()).getNxmNxNshc4().getValue());
        Assert.assertEquals(MASK_VALUE,
                ((NxAugMatchNotifNodesNodeTableFlow) extensionAugment2.getAugmentationObject()).getNxmNxNshc4().getMask());
        Assert.assertEquals(extensionAugment.getKey(), NxmNxNshc4Key.class);
