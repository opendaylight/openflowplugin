...
public class ResubmitConvertorTest {
    ...
    public void testConvert() throws Exception {
        ...
        Assert.assertEquals(Integer.valueOf(1), actionResubmit.getNxActionResubmit().getInPort());
        Assert.assertEquals(Short.valueOf((short) 2), actionResubmit.getNxActionResubmit().getTable());
    }
    ...
    public void testConvert1() throws Exception {
        ...
        Assert.assertEquals(Integer.valueOf(3), ((NxActionResubmitNotifFlowsStatisticsUpdateApplyActionsCase) actionResult).getNxResubmit().getInPort());
        Assert.assertEquals(Short.valueOf((short) 4), ((NxActionResubmitNotifFlowsStatisticsUpdateApplyActionsCase) actionResult).getNxResubmit().getTable());

        Assert.assertEquals(Integer.valueOf(3), ((NxActionResubmitNotifFlowsStatisticsUpdateWriteActionsCase) actionResult1).getNxResubmit().getInPort());
        Assert.assertEquals(Short.valueOf((short) 4), ((NxActionResubmitNotifFlowsStatisticsUpdateWriteActionsCase) actionResult1).getNxResubmit().getTable());

        Assert.assertEquals(Integer.valueOf(3), ((NxActionResubmitNotifGroupDescStatsUpdatedCase) actionResult2).getNxResubmit().getInPort());
        Assert.assertEquals(Short.valueOf((short) 4), ((NxActionResubmitNotifGroupDescStatsUpdatedCase) actionResult2).getNxResubmit().getTable());

        Assert.assertEquals(Integer.valueOf(3), ((NxActionResubmitNodesNodeTableFlowWriteActionsCase) actionResult3).getNxResubmit().getInPort());
        Assert.assertEquals(Short.valueOf((short) 4), ((NxActionResubmitNodesNodeTableFlowWriteActionsCase) actionResult3).getNxResubmit().getTable());
    }
