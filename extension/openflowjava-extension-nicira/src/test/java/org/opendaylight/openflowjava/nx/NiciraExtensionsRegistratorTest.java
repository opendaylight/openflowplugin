...
public class NiciraExtensionsRegistratorTest {
    ...
    public void registerNiciraExtensionsTest() {
        ...
        Mockito.verify(registrator).registerMatchEntryDeserializer(Matchers
                ...
                Matchers.any(CtMarkCodec.class));
        Mockito.verify(registrator).registerMatchEntrySerializer(Matchers
                        .eq(new MatchEntrySerializerKey<>(EncodeConstants.OF13_VERSION_ID, Nxm1Class.class, NxmNxCtTpSrc.class)),
                Matchers.any(CtTpSrcCodec.class));
        Mockito.verify(registrator).registerMatchEntryDeserializer(Matchers
                        .eq(new MatchEntryDeserializerKey(EncodeConstants.OF13_VERSION_ID, OxmMatchConstants.NXM_1_CLASS, 124)),
                Matchers.any(CtTpSrcCodec.class));
        Mockito.verify(registrator).registerMatchEntrySerializer(Matchers
                        .eq(new MatchEntrySerializerKey<>(EncodeConstants.OF13_VERSION_ID, Nxm1Class.class, NxmNxCtTpDst.class)),
                Matchers.any(CtTpDstCodec.class));
        Mockito.verify(registrator).registerMatchEntryDeserializer(Matchers
                        .eq(new MatchEntryDeserializerKey(EncodeConstants.OF13_VERSION_ID, OxmMatchConstants.NXM_1_CLASS, 125)),
                Matchers.any(CtTpDstCodec.class));
    }
