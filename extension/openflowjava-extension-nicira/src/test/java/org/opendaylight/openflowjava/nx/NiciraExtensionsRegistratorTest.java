...
public class NiciraExtensionsRegistratorTest {
    ...
    public void registerNiciraExtensionsTest() {
        ...
        //Nshc2 and Contrack codecs are registered with same subtype
//        Mockito.verify(registrator).registerActionDeserializer(Matchers.eq(new NiciraActionDeserializerKey(EncodeConstants.OF13_VERSION_ID, 35)), Matchers.any(SetNshc2Codec.class));
//        Mockito.verify(registrator).registerActionSerializer(Matchers.eq(new NiciraActionSerializerKey(EncodeConstants.OF13_VERSION_ID, ActionSetNshc2.class)), Matchers.any(SetNshc2Codec.class));
        ...
        //Contrack and Nshc2 codecs are registered with same subtype
//        Mockito.verify(registrator).registerActionDeserializer(Matchers.eq(new NiciraActionDeserializerKey(EncodeConstants.OF13_VERSION_ID, 35)), Matchers.any(ConntrackCodec.class));
//        Mockito.verify(registrator).registerActionSerializer(Matchers.eq(new NiciraActionSerializerKey(EncodeConstants.OF13_VERSION_ID, ActionConntrack.class)), Matchers.any(ConntrackCodec.class));
    ...
    public void unregisterExtensionsTest() {
        ...
        // Nshc2 and Contrack codecs are unregistered with same subtype
//        Mockito.verify(registrator).unregisterActionDeserializer(new NiciraActionDeserializerKey(EncodeConstants.OF13_VERSION_ID, 35));
//        Mockito.verify(registrator).unregisterActionSerializer(new NiciraActionSerializerKey(EncodeConstants.OF13_VERSION_ID, ActionSetNshc2.class));
        ...
        // Contrack and Nshc2 codecs are unregistered with same subtype
//        Mockito.verify(registrator).unregisterActionDeserializer(new NiciraActionDeserializerKey(EncodeConstants.OF13_VERSION_ID, 35));
