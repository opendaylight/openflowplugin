...
public class ConntrackCodecTest {
    ...
    public void deserializeTest() {
        ...
        Assert.assertEquals("192.168.0.0", natAction.getIpAddressMin().getIpv4AddressNoZone().getValue());
        Assert.assertEquals("192.168.10.0", natAction.getIpAddressMax().getIpv4AddressNoZone().getValue());
    ...
    private Action createAction() {
        ...
        nxActionNatBuilder.setIpAddressMin(new IpAddressNoZone("192.168.0.0".toCharArray()));
        nxActionNatBuilder.setIpAddressMax(new IpAddressNoZone("192.168.10.0".toCharArray()));
