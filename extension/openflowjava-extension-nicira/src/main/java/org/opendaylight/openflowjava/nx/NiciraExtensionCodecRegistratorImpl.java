...
public class NiciraExtensionCodecRegistratorImpl implements NiciraExtensionCodecRegistrator, AutoCloseable {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(NiciraExtensionCodecRegistratorImpl.class);
    ...
    public void registerActionDeserializer(NiciraActionDeserializerKey key, OFDeserializer<Action> deserializer) {
        LOG.info("The registered action deserializer for the key and value: {} {}",key,deserializer);
    ...
    public static OFDeserializer<Action> getActionDeserializer(NiciraActionDeserializerKey key) {
        LOG.info("After registering the action deserializer for the key:{}",key);
