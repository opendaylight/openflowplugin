...
public class CtLabelCodec extends AbstractMatchCodec {
    ...
    public void serialize(MatchEntry input, ByteBuf outBuffer) {
        ...
        outBuffer.writeInt(ctLabelCase.getCtLabelValues().getCtLabel().intValue());
        outBuffer.writeInt(ctLabelCase.getCtLabelValues().getMask().intValue());
    }
    ...
    public MatchEntry deserialize(ByteBuf message) {
        ...
        ctLabelValuesBuilder.setCtLabel(message.readUnsignedInt());
        ctLabelValuesBuilder.setMask(message.readUnsignedInt());
