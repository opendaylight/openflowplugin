...
import org.opendaylight.yang.gen.v1.urn.opendaylight.openflowjava.nx.match.rev140421.OxmOfMplsLabel;
...
public class MplsLabelCodec extends AbstractMatchCodec {
  ...
  public static final MatchEntrySerializerKey<OxmClassBase, OxmOfMplsLabel> SERIALIZER_KEY = new MatchEntrySerializerKey<>(
      EncodeConstants.OF13_VERSION_ID, OxmClassBase.class,
      OxmOfMplsLabel.class);
