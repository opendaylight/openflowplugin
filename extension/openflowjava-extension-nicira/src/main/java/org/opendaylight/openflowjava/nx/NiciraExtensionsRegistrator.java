...
public class NiciraExtensionsRegistrator implements AutoCloseable {
    ...
    public void registerNiciraExtensions() {
        ...
        registrator.registerActionDeserializer(SetNsc1Codec.DESERIALIZER_KEY, NiciraActionCodecs.SET_NSC1_CODEC);
        registrator.registerActionSerializer(SetNsc1Codec.SERIALIZER_KEY, NiciraActionCodecs.SET_NSC1_CODEC);
        registrator.registerActionDeserializer(SetNsc2Codec.DESERIALIZER_KEY, NiciraActionCodecs.SET_NSC2_CODEC);
        registrator.registerActionSerializer(SetNsc2Codec.SERIALIZER_KEY, NiciraActionCodecs.SET_NSC2_CODEC);
        registrator.registerActionDeserializer(SetNsc3Codec.DESERIALIZER_KEY, NiciraActionCodecs.SET_NSC3_CODEC);
        registrator.registerActionSerializer(SetNsc3Codec.SERIALIZER_KEY, NiciraActionCodecs.SET_NSC3_CODEC);
        registrator.registerActionDeserializer(SetNsc4Codec.DESERIALIZER_KEY, NiciraActionCodecs.SET_NSC4_CODEC);
        registrator.registerActionSerializer(SetNsc4Codec.SERIALIZER_KEY, NiciraActionCodecs.SET_NSC4_CODEC);
        ...
        registrator.registerMatchEntrySerializer(Nsc1Codec.SERIALIZER_KEY, NiciraMatchCodecs.NSC1_CODEC);
        registrator.registerMatchEntryDeserializer(Nsc1Codec.DESERIALIZER_KEY, NiciraMatchCodecs.NSC1_CODEC);
        registrator.registerMatchEntrySerializer(Nsc2Codec.SERIALIZER_KEY, NiciraMatchCodecs.NSC2_CODEC);
        registrator.registerMatchEntryDeserializer(Nsc2Codec.DESERIALIZER_KEY, NiciraMatchCodecs.NSC2_CODEC);
        registrator.registerMatchEntrySerializer(Nsc3Codec.SERIALIZER_KEY, NiciraMatchCodecs.NSC3_CODEC);
        registrator.registerMatchEntryDeserializer(Nsc3Codec.DESERIALIZER_KEY, NiciraMatchCodecs.NSC3_CODEC);
        registrator.registerMatchEntrySerializer(Nsc4Codec.SERIALIZER_KEY, NiciraMatchCodecs.NSC4_CODEC);
        registrator.registerMatchEntryDeserializer(Nsc4Codec.DESERIALIZER_KEY, NiciraMatchCodecs.NSC4_CODEC);
    ...
    public void unregisterExtensions() {
        ...
        registrator.unregisterActionSerializer(SetNsc1Codec.SERIALIZER_KEY);
        registrator.unregisterActionDeserializer(SetNsc2Codec.DESERIALIZER_KEY);
        registrator.unregisterActionSerializer(SetNsc2Codec.SERIALIZER_KEY);
        registrator.unregisterActionDeserializer(SetNsc3Codec.DESERIALIZER_KEY);
        registrator.unregisterActionSerializer(SetNsc3Codec.SERIALIZER_KEY);
        registrator.unregisterActionDeserializer(SetNsc4Codec.DESERIALIZER_KEY);
        registrator.unregisterActionSerializer(SetNsc4Codec.SERIALIZER_KEY);
        ...
        registrator.unregisterMatchEntrySerializer(Nsc1Codec.SERIALIZER_KEY);
        registrator.unregisterMatchEntryDeserializer(Nsc1Codec.DESERIALIZER_KEY);
        registrator.unregisterMatchEntrySerializer(Nsc2Codec.SERIALIZER_KEY);
        registrator.unregisterMatchEntryDeserializer(Nsc2Codec.DESERIALIZER_KEY);
        registrator.unregisterMatchEntrySerializer(Nsc3Codec.SERIALIZER_KEY);
        registrator.unregisterMatchEntryDeserializer(Nsc3Codec.DESERIALIZER_KEY);
        registrator.unregisterMatchEntrySerializer(Nsc4Codec.SERIALIZER_KEY);
        registrator.unregisterMatchEntryDeserializer(Nsc4Codec.DESERIALIZER_KEY);
