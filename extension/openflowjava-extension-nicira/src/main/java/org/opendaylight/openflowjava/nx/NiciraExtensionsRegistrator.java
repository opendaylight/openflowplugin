/*
 * Copyright (c) 2014, 2015, 2017 Cisco Systems, Inc. and others.  All rights reserved.
 *
...
public class NiciraExtensionsRegistrator implements AutoCloseable {
    ...
    public NiciraExtensionsRegistrator(NiciraExtensionCodecRegistrator registrator) {
        ...
        registrator.registerMatchEntrySerializer(CtLabelCodec.SERIALIZER_KEY, NiciraMatchCodecs.CT_LBL_CODEC);
        registrator.registerMatchEntryDeserializer(CtLabelCodec.DESERIALIZER_KEY, NiciraMatchCodecs.CT_LBL_CODEC);
    ...
    public void close() throws Exception {
        ...
        registrator.unregisterMatchEntrySerializer(CtLabelCodec.SERIALIZER_KEY);
