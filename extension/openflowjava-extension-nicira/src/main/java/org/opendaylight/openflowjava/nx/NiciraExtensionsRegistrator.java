...
import org.opendaylight.openflowjava.nx.codec.match.MplsCodec;
...
public class NiciraExtensionsRegistrator implements AutoCloseable {
    ...
    public void registerNiciraExtensions() {
        ...
        registrator.registerMatchEntrySerializer(MplsCodec.SERIALIZER_KEY, NiciraMatchCodecs.NXM_OF_MPLS_LABEL_CODEC);
        registrator.registerMatchEntryDeserializer(MplsCodec.DESERIALIZER_KEY, NiciraMatchCodecs.NXM_OF_MPLS_LABEL_CODEC);
    ...
    public void unregisterExtensions() {
        ...
        registrator.unregisterMatchEntrySerializer(MplsCodec.SERIALIZER_KEY);
        registrator.unregisterMatchEntryDeserializer(MplsCodec.DESERIALIZER_KEY);
