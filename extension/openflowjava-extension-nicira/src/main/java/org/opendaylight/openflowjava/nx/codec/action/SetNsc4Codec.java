 ...
 */
public class SetNsc4Codec extends AbstractActionCodec {
    public static final int LENGTH = 16;
    public static final byte NXAST_SET_NSC_SUBTYPE = 37;
    public static final NiciraActionSerializerKey SERIALIZER_KEY =
            new NiciraActionSerializerKey(EncodeConstants.OF13_VERSION_ID, ActionSetNsc4.class);
    ...
    public void serialize(Action input, ByteBuf outBuffer) {
        ActionSetNsc4 action = ((ActionSetNsc4) input.getActionChoice());
        serializeHeader(LENGTH, NXAST_SET_NSC_SUBTYPE, outBuffer);
        outBuffer.writeZero(padding);
        outBuffer.writeInt(action.getNxActionSetNsc4().getNsc().intValue());
    }
    ...
    public Action deserialize(ByteBuf message) {
        ...
        NxActionSetNsc4Builder nxActionSetNspBuilder = new NxActionSetNsc4Builder();
        message.skipBytes(padding);
        nxActionSetNspBuilder.setNsc(message.readUnsignedInt());
        builder.setNxActionSetNsc4(nxActionSetNspBuilder.build());
