...
public class BundleAddMessageFactory extends AbstractBundleMessageFactory<BundleAddMessage> {
    ...
    public void serialize(BundleAddMessage input, ByteBuf outBuffer) {
        ...
        serializeInnerMessage(message, outBuffer, message.getImplementedInterface());
    ...
    // TODO register serializer for cases or use instanceof here
    private <T extends DataContainer> void serializeInnerMessage(final BundleInnerMessage innerMessage,
