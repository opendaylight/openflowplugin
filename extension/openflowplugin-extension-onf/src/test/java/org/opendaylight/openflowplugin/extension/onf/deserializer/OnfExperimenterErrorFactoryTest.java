...
public class OnfExperimenterErrorFactoryTest {
    ...
    public void testVersion() {
        ByteBuf buffer = ByteBufUtils.buildBuffer("ff ff 08 fc 00 00 00 01");
    ...
    public void testDeserializeBase() {
        ByteBuf buffer = ByteBufUtils.buildBuffer("ff ff 08 fc 4f 4e 46 00");
        ErrorMessage builtByFactory = factory.deserialize(buffer);
    ...
    public void testDeserializeCodes() {
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 08 fd 00 00 00 01");
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 08 fe 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 08 ff 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 00 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 01 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 02 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 03 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 04 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 05 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 06 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 07 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 08 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 09 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 0a 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
        ...
        buffer = ByteBufUtils.buildBuffer("ff ff 09 0b 00 00 00 01");
        builtByFactory = factory.deserialize(buffer);
