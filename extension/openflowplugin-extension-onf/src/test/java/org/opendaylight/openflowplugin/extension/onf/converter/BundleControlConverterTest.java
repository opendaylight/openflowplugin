...
public class BundleControlConverterTest {
    ...
    private void testConvertUp(final boolean withProperty) {
        ...
        final org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.onf.bundle.service.rev161201.send.experimenter.input.experimenter.message.of.choice.BundleControl converted
                = converter.convert(original, MessagePath.MESSAGE_NOTIFICATION);
        testConvert(converted, original, withProperty);
    }

    private static void testConvert(final org.opendaylight.yang.gen.v1.urn.opendaylight.openflowplugin.extension.onf.bundle.service.rev161201.send.experimenter.input.experimenter.message.of.choice.BundleControl ofpMessage,
