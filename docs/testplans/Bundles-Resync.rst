...
* Bring up ODL with `odl-openflowplugin-flow-services-rest` and `odl-restconf-all` installed.
* Add bridge to openflow node
...
* Delete bridge on openflow node
* Repeat above steps for other openflow nodes
