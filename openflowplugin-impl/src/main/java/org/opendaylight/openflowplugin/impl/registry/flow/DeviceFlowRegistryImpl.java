...
public class DeviceFlowRegistryImpl implements DeviceFlowRegistry {
    ...
    public DeviceFlowRegistryImpl(final short version, final DataBroker dataBroker, final KeyedInstanceIdentifier<Node, NodeKey> instanceIdentifier) {
        ...
        flowConsumer = flow -> {
            ...
            storeDescriptor(
                    FlowRegistryKeyFactory.create(version, flow),
                    FlowDescriptorFactory.create(flow.getTableId(), flow.getId()));
        };
    }
    ...
    public void addMark(final FlowRegistryKey flowRegistryKey) {
        ...
        flowRegistry.remove(correctFlowRegistryKey(flowRegistry.keySet(), flowRegistryKey));
    }
    ...
    private FlowRegistryKey correctFlowRegistryKey(@Nonnull final Collection<FlowRegistryKey> flowRegistryKeys,
                                                   @Nonnull final FlowRegistryKey key) {
