...
final class MeterMessageService<O extends DataObject> extends AbstractMessageService<Meter, MeterMessageBuilder, O> {
    protected MeterMessageService(final RequestContextStack requestContextStack, final DeviceContext deviceContext, final Class<O> clazz) {
        super(requestContextStack, deviceContext, clazz);
    }

    @Override
    protected OfHeader buildRequest(final Xid xid, final MeterMessageBuilder input) throws ServiceException {
        return input
    ...
    @Override
    public ListenableFuture<RpcResult<O>> processInput(Meter input) {
