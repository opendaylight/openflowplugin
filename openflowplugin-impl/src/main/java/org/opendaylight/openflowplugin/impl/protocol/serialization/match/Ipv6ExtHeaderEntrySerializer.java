...
public class Ipv6ExtHeaderEntrySerializer extends AbstractMatchEntrySerializer<Ipv6ExtHeader, Integer> {
    ...
    @Override
    protected Integer extractEntryMask(final Ipv6ExtHeader entry) {
        return entry.getIpv6ExthdrMask();
    }

    @Override
    protected void serializeEntry(final Ipv6ExtHeader entry, final Integer mask, final ByteBuf outBuffer) {
