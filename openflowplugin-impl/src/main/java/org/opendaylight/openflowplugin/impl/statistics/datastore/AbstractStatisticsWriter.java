...
public abstract class AbstractStatisticsWriter<T extends DataObject> {
    ...
    /**
     * Get node instance identifier
     * @return node instance identifier
     */
    protected InstanceIdentifier<Node> getNodeInstanceIdentifier() {
        return instanceIdentifier;
    }

    /**
     * Get flow capable node instance identifier
     * @return flow capable node instance identifier
     */
    protected InstanceIdentifier<FlowCapableNode> getFlowCapableNodeInstanceIdentifier() {
        return getNodeInstanceIdentifier().augmentation(FlowCapableNode.class);
    }
     ...
     * @param <O> data type
     */
    protected <O extends DataObject> void writeToTransaction(final InstanceIdentifier<O> path, final O data,
     ...
     * @return future
     */
    protected abstract ListenableFuture<Boolean> storeStatistics(List<T> statistics, boolean withParents);
}
