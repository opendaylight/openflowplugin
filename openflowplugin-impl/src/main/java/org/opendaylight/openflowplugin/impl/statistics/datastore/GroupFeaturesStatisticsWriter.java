...
public class GroupFeaturesStatisticsWriter extends AbstractStatisticsWriter<GroupFeatures> {

    public GroupFeaturesStatisticsWriter(final TxFacade txFacade, final InstanceIdentifier<Node> instanceIdentifier) {
