...
public class OpenFlowPluginProviderImpl implements OpenFlowPluginProvider, OpenFlowPluginExtensionRegistratorProvider {
    ...
    private RpcManager rpcManagerInitial;
    ...
    public void initialize() {
        ...
        rpcManagerInitial = new RpcManagerInitialImpl(rpcProviderRegistry, rpcRequestsQuota);
        rpcManager = new RpcManagerImpl();

        // CM -> DM -> RPC-Init -> Role -> SM -> RPC -> DM
        connectionManager.setDeviceConnectedHandler(deviceManager);
        deviceManager.setDeviceInitializationPhaseHandler(rpcManagerInitial);
        rpcManagerInitial.setDeviceInitializationPhaseHandler(roleManager);
