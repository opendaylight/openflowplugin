...
public class OpendaylightPortStatisticsRpcs {
    ...
    @VisibleForTesting
    ListenableFuture<RpcResult<GetAllNodeConnectorsStatisticsOutput>> getAllNodeConnectorsStatistics(
            final GetAllNodeConnectorsStatisticsInput input) {
        return allPortStats.handleAndNotify(input, notificationPublishService);
    }

    @VisibleForTesting
    ListenableFuture<RpcResult<GetNodeConnectorStatisticsOutput>> getNodeConnectorStatistics(
