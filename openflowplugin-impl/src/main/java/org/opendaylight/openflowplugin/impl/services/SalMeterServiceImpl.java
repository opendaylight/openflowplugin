...
public class SalMeterServiceImpl implements SalMeterService, ItemLifeCycleSource {
    ...
    public SalMeterServiceImpl(final RequestContextStack requestContextStack, final DeviceContext deviceContext, final ConverterExecutor converterExecutor) {
        ...
        addMeter = new MeterService<>(requestContextStack, deviceContext, AddMeterOutput.class, converterExecutor);
        updateMeter = new MeterService<>(requestContextStack, deviceContext, UpdateMeterOutput.class, converterExecutor);
        removeMeter = new MeterService<>(requestContextStack, deviceContext, RemoveMeterOutput.class, converterExecutor);
    }
