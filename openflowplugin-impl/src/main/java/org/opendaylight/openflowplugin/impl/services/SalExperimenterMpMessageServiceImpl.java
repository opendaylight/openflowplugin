...
public class SalExperimenterMpMessageServiceImpl extends AbstractMultipartService<SendExperimenterMpRequestInput> implements SalExperimenterMpMessageService {
    ...
    @Override
    protected OfHeader buildRequest(Xid xid, SendExperimenterMpRequestInput input) throws ConversionException {
        ...
        try {
            ...
            LOG.error("Conversion of experimenter message request failed. Exception: {}", e);
            throw e;
        }
