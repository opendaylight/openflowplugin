...
final class ConfigurationServiceImpl implements ConfigurationService {
    static final Logger LOG = LoggerFactory.getLogger(ConfigurationServiceImpl.class);
    ...
    ConfigurationServiceImpl(final OpenflowProviderConfig providerConfig) {
        ...
        update(ImmutableMap.<String, String>builder()
    ...
    public void update(final Map<String, String> properties) {
        properties.forEach((propertyName, newValue) -> {
            ...
            if (originalValue != null) {
                ...
                LOG.info("{} configuration property was changed from '{}' to '{}'", propertyName, originalValue,
                    newValue);
            } else {
                if (newValue == null) {
                    return;
