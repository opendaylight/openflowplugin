...
public class NodeStaticReplyTranslatorUtil {
    ...
    private static void addGroupCapabilities(@CheckForNull MultipartReplyGroupFeatures reply, List<Class<? extends GroupCapability>> gCapability) {
    ...
    private static void addSupportedGroups(@CheckForNull MultipartReplyGroupFeatures reply, List<Class<? extends GroupType>> supportedGroups) {
