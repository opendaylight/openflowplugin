...
public class SystemNotificationsListenerImpl implements SystemNotificationsListener {
    ...
    public void onSslConnectionError(SslConnectionError notification) {
        ...
        if (notification.getSwitchCertificate() != null) {
            switchCertificateBuilder.setIssuer(notification.getSwitchCertificate().getIssuer()).
                    setSubject(notification.getSwitchCertificate().getSubject()).setValidFrom(notification.getSwitchCertificate().getValidFrom()).
                    setValidTo(notification.getSwitchCertificate().getValidTo()).build();
        }
