...
public class TableStatisticsWriter extends AbstractStatisticsWriter<FlowTableAndStatisticsMap> {

    public TableStatisticsWriter(final TxFacade txFacade, final InstanceIdentifier<Node> instanceIdentifier) {
