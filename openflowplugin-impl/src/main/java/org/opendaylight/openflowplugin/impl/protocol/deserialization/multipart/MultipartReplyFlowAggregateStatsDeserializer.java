...
import org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.multipart.reply.multipart.reply.body.MultipartReplyAggregateBuilder;
...
public class MultipartReplyFlowAggregateStatsDeserializer implements OFDeserializer<MultipartReplyBody> {
    ...
    public MultipartReplyBody deserialize(ByteBuf message) {
        final MultipartReplyAggregateBuilder builder = new MultipartReplyAggregateBuilder()
