...
import org.opendaylight.yang.gen.v1.urn.opendaylight.flow.statistics.rev130819.multipart.reply.multipart.reply.body.MultipartReplyFlowBuilder;
...
public class MultipartReplyFlowStatsDeserializer implements OFDeserializer<MultipartReplyBody>, DeserializerRegistryInjector {
    ...
    public MultipartReplyBody deserialize(ByteBuf message) {
        final MultipartReplyFlowBuilder builder = new MultipartReplyFlowBuilder();
