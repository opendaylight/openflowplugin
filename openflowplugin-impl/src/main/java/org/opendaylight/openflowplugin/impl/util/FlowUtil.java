...
public final class FlowUtil {
     ...
     * @return the flow hash key
     */
    public static FlowHashIdMapKey buildFlowHashKey(final Match match, final int priority, final BigInteger cookie) {
        final String hash = String.valueOf(match) + priority + cookie;
        return new FlowHashIdMapKey(hash);
    }
