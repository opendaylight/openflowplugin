...
public final class FlatBatchUtil {
    ...
    static Function<List<RpcResult<ProcessFlatBatchOutput>>, RpcResult<ProcessFlatBatchOutput>> mergeRpcResults() {
        return new Function<List<RpcResult<ProcessFlatBatchOutput>>, RpcResult<ProcessFlatBatchOutput>>() {
            @Nullable
            @Override
            public RpcResult<ProcessFlatBatchOutput> apply(@Nullable List<RpcResult<ProcessFlatBatchOutput>> jobsResults) {
                boolean isSuccessful = true;
                List<RpcError> rpcErrors = new ArrayList<RpcError>();
                List<BatchFailure> batchFailures = new ArrayList<BatchFailure>();
