...
public class OpendaylightFlowStatisticsRpcs implements Delegator<OpendaylightFlowStatisticsRpcs> {
    ...
    private OpendaylightFlowStatisticsRpcs delegate;
    ...
    @Override
    public void setDelegate(OpendaylightFlowStatisticsRpcs delegate) {
