...
public class DeviceContextImpl implements DeviceContext, ExtensionConverterProviderKeeper {
    ...
    DeviceContextImpl(@Nonnull final ConnectionContext primaryConnectionContext,
        ...
        this.transactionChainManager = makeTransactionChainManager(dataBroker, deviceState);
    ...
    @VisibleForTesting
    TransactionChainManager makeTransactionChainManager(DataBroker dataBroker, DeviceState deviceState) {
        return new TransactionChainManager(dataBroker, deviceState);
    }
