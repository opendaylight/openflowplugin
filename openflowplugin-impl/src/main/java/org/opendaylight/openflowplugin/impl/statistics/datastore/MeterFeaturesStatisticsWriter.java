...
public class MeterFeaturesStatisticsWriter extends AbstractStatisticsWriter<MeterFeatures> {

    public MeterFeaturesStatisticsWriter(final TxFacade txFacade, final InstanceIdentifier<Node> instanceIdentifier) {
