...
public class SingleLayerMultipartRequestCallback extends AbstractMultipartRequestCallback<MultipartReply> {

    SingleLayerMultipartRequestCallback(RequestContext<List<MultipartReply>> context, Class<?> requestType, DeviceContext deviceContext, EventIdentifier eventIdentifier) {
