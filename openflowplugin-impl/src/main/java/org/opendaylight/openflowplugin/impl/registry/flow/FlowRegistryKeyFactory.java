...
import org.opendaylight.openflowplugin.impl.util.MatchNormalizer;
...
public class FlowRegistryKeyFactory {
    ...
    public static FlowRegistryKey create(final short version, @Nonnull final Flow flow) {
        ...
        final Match match = MatchNormalizer.normalizeMatch(MoreObjects.firstNonNull(flow.getMatch(), OFConstants.EMPTY_MATCH), version);
