...
public abstract class AbstractPortNumberEntrySerializer extends AbstractUint16EntrySerializer {
    protected AbstractPortNumberEntrySerializer(int oxmFieldCode, int oxmClassCode) {
        super(oxmFieldCode, oxmClassCode);
    }

    @Override
    protected final Integer extractEntry(Match match) {
