 ...
 */
abstract class AbstractDirectStatisticsService<I extends StoreStatsGrouping, O, T extends OfHeader>
     ...
     */
    AbstractDirectStatisticsService(MultipartType multipartType, RequestContextStack requestContextStack,
     ...
     */
    protected abstract void storeStatistics(O output);
}
