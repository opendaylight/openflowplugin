...
public class ActionSerializerKey<T extends Action> extends MessageTypeKey<Action>
     ...
     */
    public ActionSerializerKey(short msgVersion, Class<T> actionType, Long experimenterId) {
