...
public class RoleManagerImpl implements RoleManager, EntityOwnershipListener {
    ...
    public void onDeviceContextLevelUp(@CheckForNull final DeviceContext deviceContext) throws Exception {
        ...
        final Entity ofEntity = makeEntity(deviceContext.getDeviceState().getNodeId());
        final RoleContext roleContext = new RoleContextImpl(deviceContext, entityOwnershipService, ofEntity, txEntity);

        Verify.verify(contexts.putIfAbsent(ofEntity, roleContext) == null,
