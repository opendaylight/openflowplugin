...
public class RoleManagerImpl implements RoleManager, EntityOwnershipListener {
    ...
    public void onDeviceContextLevelUp(@CheckForNull final DeviceContext deviceContext) throws Exception {
        ...
        final ListenableFuture<Void> initRoleChangeFuture = roleContext.initialization();
        Futures.addCallback(initRoleChangeFuture, new FutureCallback<Void>() {
            ...
            public void onSuccess(final Void result) {
                ...
                try {
                    ...
                    LOG.warn("Initial RoleContext for Node {} fail", deviceContext.getDeviceState().getNodeId(), e);
                    deviceContext.close();
                }
            }
