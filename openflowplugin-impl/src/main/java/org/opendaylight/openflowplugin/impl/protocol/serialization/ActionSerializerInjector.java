...
class ActionSerializerInjector {
    ...
    static void injectSerializers(final SerializerExtensionProvider provider) {
        ...
        final Function<Class<? extends Action>, Consumer<AbstractActionSerializer>> injector =
     ...
     * @return injector
     */
    private static Function<Class<? extends Action>, Consumer<AbstractActionSerializer>> createInjector(final SerializerExtensionProvider provider,
                                                                                                        final byte version) {
