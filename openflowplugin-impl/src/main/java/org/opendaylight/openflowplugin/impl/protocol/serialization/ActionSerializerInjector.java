...
class ActionSerializerInjector {
    ...
    static void injectSerializers(final SerializerExtensionProvider provider) {
        ...
        registrator.apply(SetMplsTtlActionCase.class).accept(new SetMplsTtlActionSerializer());
        registrator.apply(SetNwTtlActionCase.class).accept(new SetNwTtlActionSerializer());
        registrator.apply(SetQueueActionCase.class).accept(new SetQueueActionSerializer());
    }
}