...
public class ContextChainImpl implements ContextChain {
    ...
    private final Set<DeviceRemovedHandler> deviceRemovedHandlers = new ConcurrentSet<>();
    private final Set<OFPContext> contexts = new ConcurrentSet<>();
    private final Set<ConnectionContext> auxiliaryConnections = new ConcurrentSet<>();
