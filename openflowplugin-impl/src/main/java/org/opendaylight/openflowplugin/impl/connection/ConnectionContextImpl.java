...
public class ConnectionContextImpl implements ConnectionContext {
    ...
    public void closeConnection(boolean propagate) {
        SessionStatistics.countEvent(this.getConnectionAdapter().getRemoteAddress().toString(), SessionStatistics.ConnectionStatus.DISCONNECTED_BY_OFP);
    ...
    public void onConnectionClosed() {
        SessionStatistics.countEvent(this.getConnectionAdapter().getRemoteAddress().toString(), SessionStatistics.ConnectionStatus.DISCONNECTED_BY_DEVICE);
        connectionState = ConnectionContext.CONNECTION_STATE.RIP;
