...
public class AllFlowsInTableService extends AbstractCompatibleStatService<GetAllFlowStatisticsFromFlowTableInput,
    ...
    private final FlowStatisticsToNotificationTransformer flowStatsTranformer;
    ...
    public AllFlowsInTableService(final RequestContextStack requestContextStack, final DeviceContext deviceContext, AtomicLong compatibilityXidSeed) {
        ...
        flowStatsTranformer = new FlowStatisticsToNotificationTransformer();
    }
    ...
    @Override
    public FlowsStatisticsUpdate transformToNotification(List<MultipartReply> mpResult) {
        return flowStatsTranformer.transformToNotification(mpResult, getDeviceContext());
    }
}
