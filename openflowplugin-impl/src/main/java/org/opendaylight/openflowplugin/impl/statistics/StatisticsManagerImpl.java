...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.openflowplugin.sm.control.rev150812.SetStatisticsIntervalInput;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.openflowplugin.sm.control.rev150812.GetStatisticsIntervalOutput;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.openflowplugin.sm.control.rev150812.GetStatisticsIntervalOutputBuilder;
...
public class StatisticsManagerImpl implements StatisticsManager, StatisticsManagerControlService {
    ...
    public Future<RpcResult<Void>> changeStatisticsWorkMode(ChangeStatisticsWorkModeInput input) {
     ...
     @Override
    public Future<RpcResult<GetStatisticsIntervalOutput>> getStatisticsInterval() {
      RpcResultBuilder<GetStatisticsIntervalOutput> rpcResultBuilder = RpcResultBuilder.success();
      GetStatisticsIntervalOutputBuilder getStatisticsIntervalOutputBuilder = new GetStatisticsIntervalOutputBuilder();
      getStatisticsIntervalOutputBuilder.setGetInterval(basicTimerDelay);
      rpcResultBuilder.withResult(getStatisticsIntervalOutputBuilder.build());
      return Futures.immediateFuture(rpcResultBuilder.build());
    }

    @Override
    public Future<RpcResult<Void>> setStatisticsInterval(SetStatisticsIntervalInput input) {
