...
public final class StatisticsManagerImpl implements StatisticsManager {
    ...
    public StatisticsManagerImpl(@NonNull final OpenflowProviderConfig config,
        ...
        controlServiceRegistration = requireNonNull(rpcProviderRegistry)
                .registerRpcImplementations(this.getRpcClassToInstanceMap());
    }

    private ListenableFuture<RpcResult<GetStatisticsWorkModeOutput>> getStatisticsWorkMode(
    ...
    private ListenableFuture<RpcResult<ChangeStatisticsWorkModeOutput>> changeStatisticsWorkMode(
