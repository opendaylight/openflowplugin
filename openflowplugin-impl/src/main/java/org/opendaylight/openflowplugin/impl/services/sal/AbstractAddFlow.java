...
public abstract class AbstractAddFlow implements AddFlow {
    @Override
    ...
    protected abstract @NonNull Uint8 version();

    protected abstract @NonNull DeviceFlowRegistry flowRegistry();
