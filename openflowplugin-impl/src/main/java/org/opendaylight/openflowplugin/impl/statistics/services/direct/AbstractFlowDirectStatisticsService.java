...
public abstract class AbstractFlowDirectStatisticsService<T extends OfHeader>
    ...
    protected AbstractFlowDirectStatisticsService(RequestContextStack requestContextStack, DeviceContext deviceContext, ConvertorExecutor convertorExecutor) {
    ...
    @Override
    protected void storeStatistics(GetFlowStatisticsOutput output) {
