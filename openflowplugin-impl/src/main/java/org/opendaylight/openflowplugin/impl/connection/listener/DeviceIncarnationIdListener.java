...
public class DeviceIncarnationIdListener implements ClusteredDataTreeChangeListener<DeviceIncarnationId>,
        AutoCloseable {
    ...
    private ListenerRegistration<DeviceIncarnationIdListener> listenerRegistration;

    private final DataBroker dataBroker;

    public DeviceIncarnationIdListener(final DataBroker dataBroker, final boolean enableClusterwideHoldTime) {
    ...
    private void processIncarnationId(DataTreeModification<DeviceIncarnationId> modification) {
        ...
        updateIncarnationIdCache(deviceIncarnationId);
    }

    public void updateIncarnationIdCache(DeviceIncarnationId deviceIncarnationId) {
