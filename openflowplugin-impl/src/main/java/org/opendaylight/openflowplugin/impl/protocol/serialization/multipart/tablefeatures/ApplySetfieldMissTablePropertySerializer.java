...
public class ApplySetfieldMissTablePropertySerializer extends AbstractTablePropertySerializer<ApplySetfieldMiss> {
    private final SerializerLookup registry;

    public ApplySetfieldMissTablePropertySerializer(final SerializerLookup registry) {
