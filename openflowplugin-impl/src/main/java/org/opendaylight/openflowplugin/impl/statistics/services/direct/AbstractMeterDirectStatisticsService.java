...
public abstract class AbstractMeterDirectStatisticsService<T extends OfHeader> extends
    ...
    public AbstractMeterDirectStatisticsService(RequestContextStack requestContextStack, DeviceContext deviceContext, ConvertorExecutor convertorExecutor) {
    ...
    @Override
    protected void storeStatistics(GetMeterStatisticsOutput output) {
