...
public class SalGroupServiceImpl implements SalGroupService, ItemLifeCycleSource {
    ...
    public SalGroupServiceImpl(final RequestContextStack requestContextStack,
        ...
        addGroup = new MultiLayerGroupService<>(requestContextStack, deviceContext, AddGroupOutput.class,
                converterExecutor);
        updateGroup = new MultiLayerGroupService<>(requestContextStack, deviceContext, UpdateGroupOutput.class,
                converterExecutor);
        removeGroup = new MultiLayerGroupService<>(requestContextStack, deviceContext, RemoveGroupOutput.class,
                converterExecutor);
