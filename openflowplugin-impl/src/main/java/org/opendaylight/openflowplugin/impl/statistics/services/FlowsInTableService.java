...
public final class FlowsInTableService extends AbstractCompatibleStatService<GetFlowStatisticsFromFlowTableInput,
    ...
    private final FlowStatisticsToNotificationTransformer flowStatisticsTransformer;
    ...
    public FlowsInTableService(final RequestContextStack requestContextStack, final DeviceContext deviceContext, AtomicLong compatibilityXidSeed) {
        ...
        flowStatisticsTransformer = new FlowStatisticsToNotificationTransformer();
    }
    ...
    @Override
    public FlowsStatisticsUpdate transformToNotification(List<MultipartReply> result) {
        return flowStatisticsTransformer.transformToNotification(result, getDeviceContext());
    }
}
