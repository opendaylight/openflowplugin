...
public class MatchDeserializerInjector {
    ...
    public static void injectDeserializers(final DeserializerExtensionProvider provider) {
        ...
        final Function<Integer, Function<Integer, Consumer<? extends MatchEntryDeserializer>>> injector =
     ...
     */
    @VisibleForTesting
    static Function<Integer, Function<Integer, Consumer<? extends MatchEntryDeserializer>>> createInjector(
