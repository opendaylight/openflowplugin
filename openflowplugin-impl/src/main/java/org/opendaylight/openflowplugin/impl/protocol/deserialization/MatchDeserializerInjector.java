...
public class MatchDeserializerInjector {
    ...
    public static void injectDeserializers(final DeserializerExtensionProvider provider) {
        ...
        final Function<Integer, Consumer<MatchEntryDeserializer>> experInjector =
        ...
        // TODO: How to differentiate between Ipv4 and Tunnel when all 3 are serialized to same format?
        ...
        experInjector.apply(EncodeConstants.ONFOXM_ET_TCP_FLAGS).accept(new TcpFlagsEntryDeserializer());
    }
