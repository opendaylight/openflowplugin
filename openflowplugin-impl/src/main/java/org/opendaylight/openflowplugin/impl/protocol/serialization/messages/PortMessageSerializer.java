...
public class PortMessageSerializer extends AbstractMessageSerializer<PortMessage> {
    ...
    private static final PortConfig DEFAULT_PORT_CONFIG = new PortConfig(true, true, true, true);
    ...
    public void serialize(final PortMessage message, final ByteBuf outBuffer) {
        ...
        outBuffer.writeInt(createPortConfigBitMask(requireNonNullElse(message.getMask(), DEFAULT_PORT_CONFIG)));
