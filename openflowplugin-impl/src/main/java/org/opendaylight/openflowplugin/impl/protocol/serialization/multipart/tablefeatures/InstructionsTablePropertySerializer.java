...
public class InstructionsTablePropertySerializer extends AbstractTablePropertySerializer<Instructions> {
    private final SerializerLookup registry;

    public InstructionsTablePropertySerializer(final SerializerLookup registry) {
        this.registry = requireNonNull(registry);
    }

    @Override
    protected void serializeProperty(final Instructions property, final ByteBuf byteBuf) {
        property.getInstructions()
