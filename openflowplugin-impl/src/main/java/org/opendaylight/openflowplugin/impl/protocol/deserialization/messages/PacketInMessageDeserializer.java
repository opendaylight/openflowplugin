...
import org.opendaylight.yang.gen.v1.urn.opendaylight.packet.service.rev130709.packet.in.message.MatchBuilder;
...
public class PacketInMessageDeserializer implements OFDeserializer<PacketInMessage>, DeserializerRegistryInjector {
    ...
    public PacketInMessage deserialize(final ByteBuf message) {
        ...
        packetInMessageBuilder.setMatch(new MatchBuilder(matchDeserializer.deserialize(message)).build());
