...
public class OpendaylightFlowStatisticsDelegateRpcs {

    private static final Logger LOG = LoggerFactory.getLogger(OpendaylightFlowStatisticsDelegateRpcs.class);
    ...
    public OpendaylightFlowStatisticsDelegateRpcs(final RequestContextStack requestContextStack,
     ...
     */
    @Deprecated
    private ListenableFuture<RpcResult<GetAggregateFlowStatisticsFromFlowTableForGivenMatchOutput>>
    ...
    private ListenableFuture<RpcResult<GetAggregateFlowStatisticsFromFlowTableForAllFlowsOutput>>
    ...
    private ListenableFuture<RpcResult<GetAllFlowStatisticsFromFlowTableOutput>> getAllFlowStatisticsFromFlowTable(
            final GetAllFlowStatisticsFromFlowTableInput input) {
        return allFlowsInTable.handleAndNotify(input, notificationService);
    }

    private ListenableFuture<RpcResult<GetAllFlowsStatisticsFromAllFlowTablesOutput>>
    ...
    private ListenableFuture<RpcResult<GetFlowStatisticsFromFlowTableOutput>> getFlowStatisticsFromFlowTable(
