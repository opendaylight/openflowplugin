...
public class SalMeterServiceImpl implements SalMeterService, ItemLifeCycleSource {
    ...
    public SalMeterServiceImpl(final RequestContextStack requestContextStack,
        ...
        addMeter = new MultiLayerMeterService<>(requestContextStack, deviceContext, AddMeterOutput.class,
                converterExecutor);
        updateMeter = new MultiLayerMeterService<>(requestContextStack, deviceContext, UpdateMeterOutput.class,
                converterExecutor);
        removeMeter = new MultiLayerMeterService<>(requestContextStack, deviceContext, RemoveMeterOutput.class,
                converterExecutor);
