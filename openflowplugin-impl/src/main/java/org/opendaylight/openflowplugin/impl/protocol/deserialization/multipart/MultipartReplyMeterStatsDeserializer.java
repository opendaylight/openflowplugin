...
import org.opendaylight.yang.gen.v1.urn.opendaylight.meter.statistics.rev131111.multipart.reply.multipart.reply.body.MultipartReplyMeterBuilder;
...
public class MultipartReplyMeterStatsDeserializer implements OFDeserializer<MultipartReplyBody> {
    ...
    public MultipartReplyBody deserialize(ByteBuf message) {
        final MultipartReplyMeterBuilder builder = new MultipartReplyMeterBuilder();
