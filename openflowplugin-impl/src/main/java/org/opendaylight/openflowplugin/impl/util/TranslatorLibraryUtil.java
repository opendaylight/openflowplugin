...
public final class TranslatorLibraryUtil {
    ...
    public static void injectBasicTranslatorLibrary(final TranslatorLibrarian librarian, final ConverterExecutor converterExecutor) {
        final TranslatorLibrary basicTranslatorLibrary = new TranslatorLibraryBuilder().
                addTranslator(of13TranslatorKeyFactory.createTranslatorKey(PacketIn.class), new PacketReceivedTranslator(converterExecutor)).
                ...
                addTranslator(of10TranslatorKeyFactory.createTranslatorKey(PacketIn.class), new PacketReceivedTranslator(converterExecutor)).
