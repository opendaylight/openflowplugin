...
public final class TranslatorLibraryUtil {
    ...
    public static void setBasicTranslatorLibrary(final TranslatorLibrarian librarian, final ConvertorManager convertorManager) {
        final TranslatorLibrary basicTranslatorLibrary = new TranslatorLibraryBuilder().
                addTranslator(of13TranslatorKeyFactory.createTranslatorKey(PacketIn.class), new PacketReceivedTranslator(convertorManager)).
                ...
                addTranslator(of13TranslatorKeyFactory.createTranslatorKey(FlowRemoved.class), new FlowRemovedTranslator(convertorManager)).
                addTranslator(of10TranslatorKeyFactory.createTranslatorKey(PacketIn.class), new PacketReceivedTranslator(convertorManager)).
                ...
                addTranslator(of10TranslatorKeyFactory.createTranslatorKey(FlowRemoved.class), new FlowRemovedV10Translator(convertorManager)).
