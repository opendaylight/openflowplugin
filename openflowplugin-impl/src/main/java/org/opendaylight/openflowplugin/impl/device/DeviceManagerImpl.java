...
public class DeviceManagerImpl implements DeviceManager, AutoCloseable {
    ...
    public void deviceConnected(@CheckForNull final ConnectionContext connectionContext) {
        ...
        final ReadyForNewTransactionChainHandler readyForNewTransactionChainHandler = new ReadyForNewTransactionChainHandlerImpl(this, connectionContext);
        ...
        final TransactionChainManager transactionChainManager = transactionChainManagerRegistration.getTransactionChainManager();
