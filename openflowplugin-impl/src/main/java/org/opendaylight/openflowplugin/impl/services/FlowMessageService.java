...
final class FlowMessageService<O extends DataObject> extends AbstractMessageService<Flow, FlowMessageBuilder, O> {
    ...
    public boolean isSupported() {
        return getVersion() >= OFConstants.OFP_VERSION_1_3;
    }

    /**
     * Converts input to {@link org.opendaylight.yang.gen.v1.urn.opendaylight.flow.types.rev131026.FlowMessageBuilder}
     * and calls #{@link org.opendaylight.openflowplugin.impl.services.FlowMessageService#handleServiceCall(Object)} on it.
    ...
    public ListenableFuture<RpcResult<O>> processInput(Flow input) {
        ...
        return handleServiceCall(flowMessageBuilder);
    }
}
