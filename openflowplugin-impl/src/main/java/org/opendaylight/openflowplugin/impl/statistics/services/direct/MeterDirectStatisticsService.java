...
public class MeterDirectStatisticsService extends AbstractDirectStatisticsService<GetMeterStatisticsInput, GetMeterStatisticsOutput> {
     ...
     */
    public MeterDirectStatisticsService(RequestContextStack requestContextStack, DeviceContext deviceContext, ConverterExecutor converterExecutor) {
        super(MultipartType.OFPMPMETER, requestContextStack, deviceContext, converterExecutor);
    ...
    protected GetMeterStatisticsOutput buildReply(List<MultipartReply> input, boolean success) {
        ...
        if (success) {
            for (final MultipartReply mpReply : input) {
                ...
                final Optional<List<MeterStats>> meterStatsList = getConverterExecutor().convert(replyBody.getMeterStats(), data);
