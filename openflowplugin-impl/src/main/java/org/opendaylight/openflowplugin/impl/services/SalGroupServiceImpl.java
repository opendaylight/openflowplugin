...
public class SalGroupServiceImpl extends CommonService implements SalGroupService {
    ...
    public Future<RpcResult<AddGroupOutput>> addGroup(final AddGroupInput input) {
        ...
        return handleServiceCallNew(new Function<RequestContext<AddGroupOutput>, ListenableFuture<RpcResult<AddGroupOutput>>>() {
            @Override
    ...
    public Future<RpcResult<UpdateGroupOutput>> updateGroup(final UpdateGroupInput input) {
        return handleServiceCallNew(new Function<RequestContext<UpdateGroupOutput>, ListenableFuture<RpcResult<UpdateGroupOutput>>>() {
    ...
    public Future<RpcResult<RemoveGroupOutput>> removeGroup(final RemoveGroupInput input) {
        ...
        return handleServiceCallNew(new Function<RequestContext<RemoveGroupOutput>, ListenableFuture<RpcResult<RemoveGroupOutput>>>() {
