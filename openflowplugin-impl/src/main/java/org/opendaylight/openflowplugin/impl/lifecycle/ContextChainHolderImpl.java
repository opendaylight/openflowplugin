...
public class ContextChainHolderImpl implements ContextChainHolder, MasterChecker {
    ...
    private final List<DeviceInfo> masteredDevices = new ArrayList<>();
    ...
    public void onNotAbleToStartMastership(
        ...
        removeFromMasteredList(deviceInfo);
    ...
    public void onMasterRoleAcquired(@Nonnull final DeviceInfo deviceInfo,
        ...
        Optional.ofNullable(contextChainMap.get(deviceInfo)).ifPresent(contextChain -> {
            if (contextChain.isMastered(mastershipState)) {
                masteredDevices.add(deviceInfo);
    ...
    public List<DeviceInfo> checkForMaster() {
        return masteredDevices;
    }

    @Override
    public boolean isAnyDeviceMastered() {
        return !masteredDevices.isEmpty();
    }
    ...
    private void removeFromMasteredList(@Nonnull DeviceInfo deviceInfo) {
        if (masteredDevices.contains(deviceInfo)) {
            masteredDevices.remove(deviceInfo);
