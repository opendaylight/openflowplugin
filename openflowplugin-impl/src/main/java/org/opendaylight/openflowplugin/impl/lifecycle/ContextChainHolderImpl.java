...
public class ContextChainHolderImpl implements ContextChainHolder {
    ...
    public static final String SINGLETON_SERVICE_PROVIDER_WAS_NOT_SET_YET = "Singleton service provider was not set yet.";
    ...
    public ContextChain createContextChain(final ConnectionContext connectionContext) {
        ...
        final StatisticsContext statisticsContext
                = statisticsManager.createContext(connectionContext.getDeviceInfo(), lifecycleService);
        ...
        lifecycleService.registerService(
                this.singletonServicesProvider,
                deviceContext,
                deviceContext.getServiceIdentifier(),
                deviceInfo);
