...
public class ContextChainHolderImpl implements ContextChainHolder {
    ...
    private final ConcurrentHashMap<DeviceInfo, ContextChain> withoutRoleChainsQueue = new ConcurrentHashMap<>();
    ...
    private final Object roleObjectQueue = new Object();
    private final Object roleObject = new Object();
