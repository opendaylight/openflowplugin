...
public class DeviceInitializationUtils {
     ...
     */
    public static ListenableFuture<Void> initializeNodeInformation(final DeviceContext deviceContext, final boolean switchFeaturesMandatory, final ConvertorManager convertorManager) {
        ...
        if (OFConstants.OFP_VERSION_1_0 == version) {
            ...
            deviceFeaturesFuture = createDeviceFeaturesForOF13(deviceContext, switchFeaturesMandatory, convertorManager);
        } else {
    ...
    private static ListenableFuture<List<RpcResult<List<MultipartReply>>>> createDeviceFeaturesForOF13(
            final DeviceContext deviceContext, final boolean switchFeaturesMandatory, final ConvertorManager convertorManager) {
                ...
                new AsyncFunction<RpcResult<List<MultipartReply>>, List<RpcResult<List<MultipartReply>>>>() {
                    ...
                    public ListenableFuture<List<RpcResult<List<MultipartReply>>>> apply(
                        ...
                        translateAndWriteReply(MultipartType.OFPMPDESC, deviceContext,
                                deviceContext.getDeviceInfo().getNodeInstanceIdentifier(), rpcResult.getResult(), convertorManager);
                        ...
                        createSuccessProcessingCallback(MultipartType.OFPMPMETERFEATURES, deviceContext,
                                deviceContext.getDeviceInfo().getNodeInstanceIdentifier(), replyMeterFeature, convertorManager);
                        ...
                        createSuccessProcessingCallback(MultipartType.OFPMPGROUPFEATURES, deviceContext,
                                deviceContext.getDeviceInfo().getNodeInstanceIdentifier(), replyGroupFeatures, convertorManager);
                        ...
                        createSuccessProcessingCallback(MultipartType.OFPMPTABLEFEATURES, deviceContext,
                                deviceContext.getDeviceInfo().getNodeInstanceIdentifier(), replyTableFeatures, convertorManager);
                        ...
                        createSuccessProcessingCallback(MultipartType.OFPMPPORTDESC, deviceContext,
                                deviceContext.getDeviceInfo().getNodeInstanceIdentifier(), replyPortDescription, convertorManager);
                ...
                switch (type) {
                    ...
                    case OFPMPTABLEFEATURES:
                        ...
                        final List<TableFeatures> tableFeatures = NodeStaticReplyTranslatorUtil
                                .nodeTableFeatureTranslator(tableFeaturesMP, dContext.getDeviceInfo().getVersion(), convertorManager);
        ...
        Futures.addCallback(requestContextFuture, new FutureCallback<RpcResult<List<MultipartReply>>>() {
            ...
            public void onSuccess(final RpcResult<List<MultipartReply>> rpcResult) {
                ...
                if (result != null) {
                    ...
                    translateAndWriteReply(type, deviceContext, nodeII, result, convertorManager);
                } else {
