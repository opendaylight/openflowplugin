...
import org.opendaylight.openflowplugin.impl.statistics.datastore.StatisticsWriterProviderFactory;
...
public class MdSalRegistrationUtils {
    ...
    public static void registerServices(@CheckForNull final RpcContext rpcContext,
        ...
        final StatisticsWriterProvider statisticsWriterProvider= StatisticsWriterProviderFactory.createDefaultProvider(deviceContext);
