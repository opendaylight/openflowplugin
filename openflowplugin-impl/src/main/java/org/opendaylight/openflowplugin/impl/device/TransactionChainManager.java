...
class TransactionChainManager implements TransactionChainListener, AutoCloseable {
     ...
     * @param ownershipChange - this object represent a restriction for activation functionality from OwnershipChangeListener //TODO:We cant use this parameter
     */
    public void activateTransactionManager() {
//        Preconditions.checkNotNull(ownershipChange);
//        LOG.trace("Entering method with ownershipChange: {}", ownershipChange);
