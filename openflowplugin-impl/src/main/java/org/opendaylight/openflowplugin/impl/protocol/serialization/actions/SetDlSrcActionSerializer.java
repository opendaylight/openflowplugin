...
public class SetDlSrcActionSerializer extends AbstractSetFieldActionSerializer {
    public SetDlSrcActionSerializer(final SerializerLookup registry) {
        super(registry);
    }
                ...
                .setSetField(new SetFieldBuilder()
                    .setEthernetMatch(new EthernetMatchBuilder()
                        .setEthernetSource(new EthernetSourceBuilder()
                            .setAddress(((SetDlSrcActionCase) input).getSetDlSrcAction().getAddress())
                            .build())
                        .build())
                    .build())
                .build();
