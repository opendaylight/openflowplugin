...
public class SalBundleRpcs {
    ...
    private ListenableFuture<RpcResult<ControlBundleOutput>> controlBundle(final ControlBundleInput input) {
    ...
    private ListenableFuture<RpcResult<AddBundleMessagesOutput>> addBundleMessages(final AddBundleMessagesInput input) {
