...
public final class MatchNormalizer {
    ...
    private static MatchBuilder normalizeInPortMatch(@Nonnull final MatchBuilder match, final short version) {
        return Optional
                ...
                .flatMap(inPort -> Optional.ofNullable(AddressNormalizationUtil
                        .normalizeProtocolAgnosticPort(inPort, version)))
                .map(inPhyPortUri -> match.setInPort(new NodeConnectorId(inPhyPortUri)))
                .orElse(match);
    }
    ...
    private static MatchBuilder normalizeInPhyPortMatch(@Nonnull final MatchBuilder match, final short version) {
        return Optional
                ...
                .flatMap(inPhyPort -> Optional.ofNullable(AddressNormalizationUtil
                        .normalizeProtocolAgnosticPort(inPhyPort, version)))
    ...
    private static MatchBuilder normalizeArpMatch(@Nonnull final MatchBuilder match) {
        return Optional
                ...
                .map(arp -> match
                        .setLayer3Match(new ArpMatchBuilder(arp)
    ...
    private static MatchBuilder normalizeIpv4Match(@Nonnull final MatchBuilder match) {
        return Optional
                ...
                .map(ipv4 -> match
                        .setLayer3Match(new Ipv4MatchBuilder(ipv4)
    ...
    private static MatchBuilder normalizeIpv6Match(@Nonnull final MatchBuilder match) {
        return Optional
                ...
                .map(ipv6 -> match
                        .setLayer3Match(new Ipv6MatchBuilder(ipv6)
    ...
    private static MatchBuilder normalizeEthernetMatch(@Nonnull final MatchBuilder match) {
        return Optional
                ...
                .map(eth -> match
                        .setEthernetMatch(new EthernetMatchBuilder(eth)
