...
public class FlowTableStatisticsWriter extends AbstractStatisticsWriter<FlowTableAndStatisticsMap> {
    ...
    public FlowTableStatisticsWriter(final TxFacade txFacade, final InstanceIdentifier<Node> instanceIdentifier) {
        super(txFacade, instanceIdentifier);
    }

    @Override
    protected ListenableFuture<Boolean> storeStatistics(final List<FlowTableAndStatisticsMap> statistics, final boolean withParents) {
        statistics.stream()
