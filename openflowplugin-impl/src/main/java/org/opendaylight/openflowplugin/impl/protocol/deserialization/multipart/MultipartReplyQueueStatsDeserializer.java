...
import org.opendaylight.yang.gen.v1.urn.opendaylight.queue.statistics.rev131216.multipart.reply.multipart.reply.body.MultipartReplyQueueBuilder;
...
public class MultipartReplyQueueStatsDeserializer implements OFDeserializer<MultipartReplyBody> {
    ...
    public MultipartReplyBody deserialize(ByteBuf message) {
        final MultipartReplyQueueBuilder builder = new MultipartReplyQueueBuilder();
