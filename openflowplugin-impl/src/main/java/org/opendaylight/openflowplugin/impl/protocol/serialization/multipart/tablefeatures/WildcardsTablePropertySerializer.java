...
public class WildcardsTablePropertySerializer extends AbstractTablePropertySerializer<Wildcards> {
    private final SerializerLookup registry;

    public WildcardsTablePropertySerializer(final SerializerLookup registry) {
        this.registry = requireNonNull(registry);
    }

    @Override
    protected void serializeProperty(final Wildcards property, final ByteBuf byteBuf) {
        property.getWildcardSetfield()
