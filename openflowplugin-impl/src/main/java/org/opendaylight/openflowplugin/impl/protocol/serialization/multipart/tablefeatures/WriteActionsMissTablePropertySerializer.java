...
public class WriteActionsMissTablePropertySerializer extends AbstractTablePropertySerializer<WriteActionsMiss> {
    private final SerializerLookup registry;

    public WriteActionsMissTablePropertySerializer(final SerializerLookup registry) {
        this.registry = requireNonNull(registry);
    }

    @Override
    protected void serializeProperty(final WriteActionsMiss property, final ByteBuf byteBuf) {
        property.getWriteActionsMiss()
