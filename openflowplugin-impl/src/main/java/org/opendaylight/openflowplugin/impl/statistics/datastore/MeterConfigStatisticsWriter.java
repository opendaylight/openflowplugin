...
public class MeterConfigStatisticsWriter extends AbstractStatisticsWriter<MeterConfigStatsReply> {

    private final DeviceRegistry registry;

    public MeterConfigStatisticsWriter(final TxFacade txFacade,
