...
final class RpcContextImpl implements RpcContext {
    ...
    public void instantiateServiceInstance() {
        ...
        // Note: out of order due to dependencies
        // sal-bundle.yang (ONF extension?)
        final var controlBundle = new ControlBundleImpl(sendExperimenter);
        final var addBundleMessages = new AddBundleMessagesImpl(sendExperimenter);

        // sal-experimenter-mp-message.yang
        final var sendExperimenterMpRequest = new SendExperimenterMpRequestImpl(this, deviceContext,
        ...
        // sal-port.yang
        final var updatePort = new UpdatePortImpl(this, deviceContext, convertorExecutor);
        ...
        final var builder = ImmutableClassToInstanceMap.<Rpc<?, ?>>builder()
            ...
            .put(ControlBundle.class, controlBundle)
            .put(AddBundleMessages.class, addBundleMessages)
            .put(SendExperimenterMpRequest.class, sendExperimenterMpRequest)
            ...
            .put(UpdatePort.class, updatePort)
            // sal-table.yang
