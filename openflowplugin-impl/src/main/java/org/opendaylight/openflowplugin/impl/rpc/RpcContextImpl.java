...
public class RpcContextImpl implements RpcContext {
    ...
    /**
     * @see org.opendaylight.openflowplugin.api.openflow.rpc.RpcContext#addNewRequest(java.util.concurrent.Future)
     */
    @Override
    public void addNewRequest(final Future<RpcResult<? extends DataObject>> result) {
        requestContexts.add(new RequestContextImpl(result));
    }
