...
import org.opendaylight.yang.gen.v1.urn.opendaylight.flow.inventory.rev130819.device.incarnation.ids.DeviceIncarnationIdKey;
...
public class HandshakeManagerImpl implements HandshakeManager {
    ...
    private final boolean enableClusterwideHoldTime;
    ...
    public HandshakeManagerImpl(ConnectionAdapter connectionAdapter, Short highestVersion, List<Short> versionOrder,
                                ...
                                boolean enableClusterwideHoldTime,
        ...
        this.enableClusterwideHoldTime = enableClusterwideHoldTime;
    ...
    public boolean isAllowedToConnect(BigInteger nodeId) {
        ...
        if (enableClusterwideHoldTime) {
            try {
                tx.put(LogicalDatastoreType.OPERATIONAL, instanceIdentifier, incarnationIdBuilder.build(), true);
                tx.submit().get();
            ...
            deviceIncarnationIdListener.updateIncarnationIdCache(incarnationIdBuilder.build());
        }
