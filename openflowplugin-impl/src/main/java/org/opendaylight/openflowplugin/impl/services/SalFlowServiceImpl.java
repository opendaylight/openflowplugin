        ...
        Futures.addCallback(future, new FutureCallback<RpcResult<RemoveFlowOutput>>() {
            ...
            public void onSuccess(final RpcResult<RemoveFlowOutput> result) {
                if (result.isSuccessful()) {
                    LOG.debug("flow removed with id={},finished without error,", input.getFlowRef().getValue());
                    ...
                    LOG.error("Flow remove failed for id={},with errors : {}", input.getFlowRef().getValue(),
