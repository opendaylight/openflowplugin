...
abstract class AbstractService<I, O> {
    ...
    public MultiMsgCollector createCollector(final RequestContext<List<MultipartReply>> requestContext){
        return new MultiMsgCollectorImpl(deviceContext, requestContext);
    }
