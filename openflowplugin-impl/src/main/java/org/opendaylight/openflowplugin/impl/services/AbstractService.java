...
public abstract class AbstractService<I, O> {
    ...
    public ListenableFuture<RpcResult<O>> handleServiceCall(@Nonnull final I input,
        ...
        LOG.error("The request context has xid={} for message={} and dpnId={}", requestContext.getXid(),
                input, getDatapathId());
        ...
        try {
            ...
            if (Objects.nonNull(isComplete)) {
                ...
                LOG.error("commitEntry for service call for txnId={} and message : {} and dpnId={}",
                        xid, request, getDatapathId());
