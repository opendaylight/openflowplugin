...
public class ConnectionManagerImpl implements ConnectionManager {
    ...
    public ConnectionManagerImpl(final OpenflowProviderConfig config, final ExecutorService executorService,
        ...
        this.deviceConnectionHoldTime = config.getDeviceConnectionHoldTime();
    ...
    class DeviceConnectionStatusProviderImpl implements DeviceConnectionStatusProvider,
            ClusteredDataTreeChangeListener<Node>, AutoCloseable {
        private final Map<BigInteger, LocalDateTime> deivceConnectionMap = new ConcurrentHashMap<>();
