...
public class ConnectionManagerImpl implements ConnectionManager {
    ...
    public ConnectionManagerImpl(final OpenflowProviderConfig config, final ExecutorService executorService,
        ...
        this.enableClusterwideHoldTime = config.isEnableClusterwideHoldTime();
        this.deviceConnectionHoldTimeInSeconds = config.getDeviceConnectionHoldTimeInSeconds();
        this.deviceIncarnationIdListener
                = new DeviceIncarnationIdListener(dataBroker, enableClusterwideHoldTime);
    }
    ...
    private HandshakeManager createHandshakeManager(final ConnectionAdapter connectionAdapter,
        ...
        HandshakeManagerImpl handshakeManager = new HandshakeManagerImpl(connectionAdapter,
                ...
                deviceConnectionRateLimiter, dataBroker, deviceConnectionHoldTimeInSeconds, enableClusterwideHoldTime,
