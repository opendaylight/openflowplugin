...
public class Ipv4ArbitraryBitMaskSourceEntrySerializer extends AbstractMatchEntrySerializer {
    ...
    protected boolean getHasMask(Match match) {
        return Objects.nonNull(Ipv4MatchArbitraryBitMask.class.cast(match.getLayer3Match()).getIpv4SourceArbitraryBitmask());
    }
