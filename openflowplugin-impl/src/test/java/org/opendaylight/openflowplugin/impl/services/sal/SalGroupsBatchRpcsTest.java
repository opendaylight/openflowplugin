...
public class SalGroupsBatchRpcsTest {
    ...
    @Before
    public void setUp() {
        salGroupsBatchRpcs = new SalGroupsBatchRpcs(salGroupRpcs, transactionRpc);
        ...
        rpcMap = salGroupsBatchRpcs.getRpcClassToInstanceMap();
    }
    ...
    public void testUpdateGroupsBatch_success() throws Exception {
        Mockito.when(salGroupRpcs.getRpcClassToInstanceMap().getInstance(UpdateGroup.class).invoke(Mockito.any()))
        ...
        final Future<RpcResult<UpdateGroupsBatchOutput>> resultFuture = rpcMap.getInstance(UpdateGroupsBatch.class)
            .invoke(input);
        ...
        inOrder.verify(salGroupRpcs, Mockito.times(2)).getRpcClassToInstanceMap()
            .getInstance(UpdateGroup.class).invoke(updateGroupInputCpt.capture());
    ...
    public void testAddGroupsBatch_success() throws Exception {
        Mockito.when(salGroupRpcs.getRpcClassToInstanceMap().getInstance(AddGroup.class).invoke(Mockito.any()))
        ...
        final Future<RpcResult<AddGroupsBatchOutput>> resultFuture = salGroupsBatchRpcs.getRpcClassToInstanceMap()
            .getInstance(AddGroupsBatch.class).invoke(input);
        ...
        final InOrder inOrder = Mockito.inOrder(salGroupRpcs, transactionRpc);
        inOrder.verify(salGroupRpcs, Mockito.times(2)).getRpcClassToInstanceMap()
            .getInstance(AddGroup.class).invoke(addGroupInputCpt.capture());
    ...
    public void testRemoveGroupsBatch_success() throws Exception {
        Mockito.when(salGroupRpcs.getRpcClassToInstanceMap().getInstance(RemoveGroup.class).invoke(Mockito.any()))
        ...
        final Future<RpcResult<RemoveGroupsBatchOutput>> resultFuture = salGroupsBatchRpcs.getRpcClassToInstanceMap()
            .getInstance(RemoveGroupsBatch.class).invoke(input);
        ...
        inOrder.verify(salGroupRpcs, Mockito.times(2)).getRpcClassToInstanceMap()
            .getInstance(RemoveGroup.class).invoke(removeGroupInputCpt.capture());
