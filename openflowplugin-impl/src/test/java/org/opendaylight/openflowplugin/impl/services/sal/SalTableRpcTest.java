...
public class SalTableRpcTest extends ServiceMocking {
    ...
    private SalTableRpc salTableRpc;
    ...
    public void setup() {
        ...
        salTableRpc = new SalTableRpc(mockedRequestContextStack, mockedDeviceContext,
    ...
    public void testUpdateTableFail1() {
        ...
        final Future<RpcResult<UpdateTableOutput>> rpcResultFuture = salTableRpc.getRpcClassToInstanceMap()
            .getInstance(UpdateTable.class).invoke(prepareUpdateTable());
