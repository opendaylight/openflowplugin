...
/**
 * Test for {@link OpendaylightFlowStatisticsDelegateRpcs}.
 * Skipping notification verification. This will be tested in tests of underlying single task oriented services.
 */
public class OpendaylightFlowStatisticsDelegateRpcsTest extends AbstractSingleStatsServiceTest {

    public static final int NOTIFICATION_WAIT_TIMEOUT_MS = 500;
    @Captor
    private ArgumentCaptor<MultipartRequestInput> requestInput;

    private OpendaylightFlowStatisticsDelegateRpcs flowStatisticsServiceDelegateRpcs;
    ...
    public void setUp() {
        ...
        flowStatisticsServiceDelegateRpcs = new OpendaylightFlowStatisticsDelegateRpcs(rqContextStack,
            deviceContext, notificationPublishService, new AtomicLong(21), convertorManager);
        rpcMap = flowStatisticsServiceDelegateRpcs.getRpcClassToInstanceMap();
    ...
    public void testGetAggregateFlowStatisticsFromFlowTableForGivenMatch() {
        rpcMap.getInstance(GetAggregateFlowStatisticsFromFlowTableForGivenMatch.class).invoke(null);
    }
    ...
    public void testGetAggregateFlowStatisticsFromFlowTableForAllFlows() throws Exception {
        ...
        final Future<RpcResult<GetAggregateFlowStatisticsFromFlowTableForAllFlowsOutput>> resultFuture
                = rpcMap.getInstance(GetAggregateFlowStatisticsFromFlowTableForAllFlows.class).invoke(input.build());
    ...
    public void testGetAllFlowStatisticsFromFlowTable() throws Exception {
        ...
        final Future<RpcResult<GetAllFlowStatisticsFromFlowTableOutput>> resultFuture
                = rpcMap.getInstance(GetAllFlowStatisticsFromFlowTable.class).invoke(input.build());
    ...
    public void testGetAllFlowsStatisticsFromAllFlowTables() throws Exception {
        ...
        final Future<RpcResult<GetAllFlowsStatisticsFromAllFlowTablesOutput>> resultFuture
                = rpcMap.getInstance(GetAllFlowsStatisticsFromAllFlowTables.class).invoke(input.build());
    ...
    public void testGetFlowStatisticsFromFlowTable() throws Exception {
        ...
        final Future<RpcResult<GetFlowStatisticsFromFlowTableOutput>> resultFuture
                = rpcMap.getInstance(GetFlowStatisticsFromFlowTable.class).invoke(input.build());
