...
public class FlatBatchMeterAdaptersTest {
    ...
    public void testAdaptFlatBatchAddMeter() {
        ...
        final Iterator<BatchAddMeters> it = addMetersBatchInput.getBatchAddMeters().values().iterator();
    ...
    public void testAdaptFlatBatchRemoveMeter() {
        ...
        Iterator<BatchRemoveMeters> iterator = removeMetersBatchInput.getBatchRemoveMeters().values().iterator();
