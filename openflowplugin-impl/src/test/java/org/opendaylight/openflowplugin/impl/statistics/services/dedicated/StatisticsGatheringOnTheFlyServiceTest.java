...
public class StatisticsGatheringOnTheFlyServiceTest extends ServiceMocking {
    ...
    protected void setup() {
        final ConverterManager converterManager = new ConverterManagerFactory()
            .newInstance(new ExtensionConverterManagerImpl());
        statisticsGatheringService = new StatisticsGatheringOnTheFlyService<>(
                mockedRequestContextStack, mockedDeviceContext, converterManager,
