...
public class RoleManagerImplTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.doNothing().when(deviceTerminationPhaseHandler).onDeviceContextLevelDown(Mockito.any(), Mockito.anyBoolean());
    ...
    public void testOnDeviceContextLevelDown() throws Exception {
        roleManagerSpy.onDeviceContextLevelDown(deviceInfo, true);
        inOrder.verify(roleManagerSpy).onDeviceContextLevelDown(deviceInfo, true);
    }
}