...
public class LifecycleServiceImplTest {
    ...
    public void closeServiceInstance() throws Exception {
        ...
        Mockito.verify(statContext).stopServices(false);
        Mockito.verify(deviceContext).stopServices(false);
        Mockito.verify(rpcContext).stopServices(false);
        Mockito.verify(roleContext).stopServices(false);
    }
