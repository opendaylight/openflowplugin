...
public class OpenFlowProviderConfigImplTest {
    ...
    public void setUp() throws Exception {
        ...
        when(configurationService.getProperty(eq(ConfigurationProperty.DEVICE_CONNECTION_RATE_LIMIT_PER_MIN.toString()), any()))
                .thenReturn(DEVICE_CONNECTION_RATE_LIMIT_PER_MIN);
