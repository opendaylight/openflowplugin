...
public abstract class AbstractSerializerTest {
    ...
    public void setUp() throws Exception {
        ...
        bufferOrder = inOrder(buffer);
        init();
    }

    @After
    public void tearDown() throws Exception {
        bufferOrder.verifyNoMoreInteractions();
    }
    ...
    protected ByteBuf bufferVerify() {
        return bufferOrder.verify(buffer);
    }

    protected ByteBuf bufferVerify(VerificationMode mode) {
        return bufferOrder.verify(buffer, mode);
    }
