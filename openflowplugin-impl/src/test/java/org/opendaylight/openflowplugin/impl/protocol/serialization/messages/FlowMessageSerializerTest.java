...
public class FlowMessageSerializerTest extends AbstractSerializerTest {
    ...
    public void testSerialize() throws Exception {
        ...
        int matchLength2 = 17;
        assertEquals(out.readShort(), 1); // OXM match type
        assertEquals(out.readUnsignedShort(), matchLength2); // OXM match length
        ...
        int paddingRemainder2 = matchLength2 % EncodeConstants.PADDING;
        if (paddingRemainder2 != 0) {
            out.skipBytes(EncodeConstants.PADDING - paddingRemainder2);
        }
