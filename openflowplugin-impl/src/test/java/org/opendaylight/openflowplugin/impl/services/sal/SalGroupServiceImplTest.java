...
public class SalGroupServiceImplTest extends ServiceMocking {
    ...
    KeyedInstanceIdentifier<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node,
            NodeKey> NODE_II = InstanceIdentifier.create(Nodes.class).child(Node.class,
