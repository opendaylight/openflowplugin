...
public class MultipartReplyMeterStatsDeserializerTest extends AbstractMultipartDeserializerTest {
    ...
    private static final long PACKET_IN_COUNT = 3;
    private static final long BYTE_IN_COUNT = 4;
    private static final int SECOND = 5;
    private static final int NANOSECOND = 6;
    private static final long PACKET_BAND_COUNT = 7;
    private static final long BYTE_BAND_COUNT = 8;
