...
public class MultipartReplyTranslatorUtilTest {
    ...
    private ConverterExecutor converterExecutor = converterManagerFactory.createDefaultManager();
    ...
    public void setUp() throws Exception {
        ...
        TranslatorLibraryUtil.injectBasicTranslatorLibrary(translatorLibrarian, converterExecutor);
    }
