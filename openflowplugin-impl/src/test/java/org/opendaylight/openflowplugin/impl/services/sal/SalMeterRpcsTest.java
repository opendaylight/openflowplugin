...
public class SalMeterRpcsTest extends ServiceMocking {
    ...
    SalMeterRpcs salMeterRpcs;

    @Override
    protected void setup() {
        final ConvertorManager convertorManager = ConvertorManagerFactory.createDefaultManager();
        salMeterRpcs = new SalMeterRpcs(mockedRequestContextStack, mockedDeviceContext, convertorManager);
    }
    ...
    private void addMeter() {
        ...
        salMeterRpcs.getRpcClassToInstanceMap().getInstance(AddMeter.class).invoke(addMeterInput);
    ...
    private void updateMeter() {
        ...
        this.<AddMeterOutput>mockSuccessfulFuture();
        salMeterRpcs.getRpcClassToInstanceMap().getInstance(UpdateMeter.class).invoke(updateMeterInput);
        verify(mockedRequestContextStack).createRequestContext();
    }
    ...
    private void removeMeter() {
        ...
        salMeterRpcs.getRpcClassToInstanceMap().getInstance(RemoveMeter.class).invoke(removeMeterInput);
        verify(mockedRequestContextStack).createRequestContext();
    }
}