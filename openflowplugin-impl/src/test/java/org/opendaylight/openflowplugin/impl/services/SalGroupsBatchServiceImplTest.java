...
public class SalGroupsBatchServiceImplTest {
    ...
    @Test
    public void testUpdateGroupsBatch() throws Exception {
    ...
    @Test
    public void testAddGroupsBatch() throws Exception {
    ...
    @Test
    public void testRemoveGroupsBatch() throws Exception {
    ...
    public void testExtractNodeId() throws Exception {
        Assert.assertEquals(NODE_ID, SalGroupsBatchServiceImpl.extractNodeId(NODE_REF));
    }
