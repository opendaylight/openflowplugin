...
public class ConfigurationServiceFactoryImplTest {
    ...
    public void update() throws Exception {
        ...
        final int tpMinThreadsUpdate = THREAD_POOL_MIN_THREADS_UPDATE;

        configurationService.update(ImmutableMap
                .<String, String>builder()
                .put(ConfigurationProperty.THREAD_POOL_MIN_THREADS.toString(), String.valueOf(THREAD_POOL_MIN_THREADS_UPDATE))
                .build());
