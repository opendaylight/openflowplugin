...
public class MultipartReplyGroupDescDeserializerTest extends AbstractMultipartDeserializerTest {
    ...
    public void deserialize() {
        ...
        final GroupDescStats firstGroupDescStats = reply.getGroupDescStats().values().iterator().next();
        ...
        final Bucket firstBucket = firstGroupDescStats.getBuckets().getBucket().values().iterator().next();
