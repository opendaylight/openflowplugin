...
public class SalEchoRpcTest extends ServiceMocking {
    ...
    SalEchoRpc salEchoRpc;

    @Override
    protected void setup() {
        salEchoRpc = new SalEchoRpc(mockedRequestContextStack, mockedDeviceContext);
    }
    ...
    public void testSendEcho() throws Exception {
        ...
        final Future<RpcResult<SendEchoOutput>> echoOutput = salEchoRpc.getRpcClassToInstanceMap()
            .getInstance(SendEcho.class).invoke(sendEchoInput);
