...
public class FlatBatchGroupAdaptersTest {
    ...
    public void testAdaptFlatBatchAddGroup() throws Exception {
        final BatchPlanStep<FlatBatchAddGroupCase> planStep = new BatchPlanStep<>(FlatBatchAddGroupCase.class, BatchStepType.FLOW_ADD);
        planStep.setBarrierAfter(true);
        planStep.add(createAddGroupBatchCase(1L));
        planStep.add(createAddGroupBatchCase(2L));
    ...
    private FlatBatchAddGroupCase createAddGroupBatchCase(final long groupIdValue) {
        return new FlatBatchAddGroupCaseBuilder()
    ...
    private FlatBatchRemoveGroupCase createRemoveGroupBatchCase(final long groupIdValue) {
        return new FlatBatchRemoveGroupCaseBuilder()
    ...
    private FlatBatchUpdateGroupCase createUpdateGroupBatchCase(final long groupIdValue) {
        return new FlatBatchUpdateGroupCaseBuilder()
    ...
    public void testAdaptFlatBatchRemoveGroup() throws Exception {
        final BatchPlanStep<FlatBatchRemoveGroupCase> planStep = new BatchPlanStep<>(FlatBatchRemoveGroupCase.class, BatchStepType.FLOW_REMOVE);
        planStep.setBarrierAfter(true);
        planStep.add(createRemoveGroupBatchCase(1L));
        planStep.add(createRemoveGroupBatchCase(2L));
    ...
    public void testAdaptFlatBatchUpdateGroup() throws Exception {
        final BatchPlanStep<FlatBatchUpdateGroupCase> planStep = new BatchPlanStep<>(FlatBatchUpdateGroupCase.class, BatchStepType.FLOW_UPDATE);
        planStep.setBarrierAfter(true);
        planStep.add(createUpdateGroupBatchCase(1L));
        planStep.add(createUpdateGroupBatchCase(2L));
