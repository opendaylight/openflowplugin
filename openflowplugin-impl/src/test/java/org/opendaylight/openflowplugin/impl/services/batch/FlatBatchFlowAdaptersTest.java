...
public class FlatBatchFlowAdaptersTest {
    ...
    public void testAdaptFlatBatchAddFlow() {
        ...
        Iterator<BatchAddFlows> iterator = addFlowsBatchInput.getBatchAddFlows().values().iterator();
    ...
    public void testAdaptFlatBatchRemoveFlow() {
        ...
        Iterator<BatchRemoveFlows> iterator = removeFlowsBatchInput.getBatchRemoveFlows().values().iterator();
    ...
    public void testAdaptFlatBatchUpdateFlow() {
        ...
        Iterator<BatchUpdateFlows> iterator = updateFlowsBatchInput.getBatchUpdateFlows().values().iterator();
