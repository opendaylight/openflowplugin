...
public class FlatBatchFlowAdaptersTest {
    ...
    public void testAdaptFlatBatchAddFlow() throws Exception {
        final BatchPlanStep<FlatBatchAddFlowCase> planStep = new BatchPlanStep<>(FlatBatchAddFlowCase.class, BatchStepType.FLOW_ADD);
        planStep.setBarrierAfter(true);
        planStep.add(createAddFlowBatchCase("1"));
        planStep.add(createAddFlowBatchCase("2"));
    ...
    private FlatBatchAddFlowCase createAddFlowBatchCase(final String flowIdValue) {
        return new FlatBatchAddFlowCaseBuilder()
    ...
    private FlatBatchRemoveFlowCase createRemoveFlowBatchCase(final String flowIdValue) {
        return new FlatBatchRemoveFlowCaseBuilder()
    ...
    private FlatBatchUpdateFlowCase createUpdateFlowBatchCase(final String flowIdValue) {
        return new FlatBatchUpdateFlowCaseBuilder()
    ...
    public void testAdaptFlatBatchRemoveFlow() throws Exception {
        final BatchPlanStep<FlatBatchRemoveFlowCase> planStep = new BatchPlanStep<>(FlatBatchRemoveFlowCase.class, BatchStepType.FLOW_REMOVE);
        planStep.setBarrierAfter(true);
        planStep.add(createRemoveFlowBatchCase("1"));
        planStep.add(createRemoveFlowBatchCase("2"));
    ...
    public void testAdaptFlatBatchUpdateFlow() throws Exception {
        final BatchPlanStep<FlatBatchUpdateFlowCase> planStep = new BatchPlanStep<>(FlatBatchUpdateFlowCase.class, BatchStepType.FLOW_UPDATE);
        planStep.setBarrierAfter(true);
        planStep.add(createUpdateFlowBatchCase("1"));
        planStep.add(createUpdateFlowBatchCase("2"));
