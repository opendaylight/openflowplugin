...
import org.opendaylight.yang.gen.v1.urn.opendaylight.flat.batch.service.rev160321.process.flat.batch.input.batch.batch.choice.flat.batch.add.flow._case.FlatBatchAddFlowContainerBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.flat.batch.service.rev160321.process.flat.batch.input.batch.batch.choice.flat.batch.add.group._case.FlatBatchAddGroupContainerBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.flat.batch.service.rev160321.process.flat.batch.input.batch.batch.choice.flat.batch.remove.flow._case.FlatBatchRemoveFlowContainerBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.flat.batch.service.rev160321.process.flat.batch.input.batch.batch.choice.flat.batch.remove.group._case.FlatBatchRemoveGroupContainerBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.flat.batch.service.rev160321.process.flat.batch.input.batch.batch.choice.flat.batch.update.flow._case.FlatBatchUpdateFlowContainerBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.flat.batch.service.rev160321.process.flat.batch.input.batch.batch.choice.flat.batch.update.group._case.FlatBatchUpdateGroupContainerBuilder;
...
public class SalFlatBatchServiceImplTest {
    ...
    public void testProcessFlatBatch_firstFailedInterrupted() throws Exception {
        ...
        ProcessFlatBatchInput batchInput = new ProcessFlatBatchInputBuilder()
                ...
                .setBatch(Lists.newArrayList(
                        createFlowAddBatch(0, "f1"),
                        createFlowAddBatch(1, "f1"),
                        createFlowRemoveBatch(2, "f2"),
                        createFlowUpdateBatch(3, "f3"),

                        createGroupAddBatch(4, 1L),
                        createGroupRemoveBatch(5, 2L),
                        createGroupUpdateBatch(6, 3L),

                        createMeterAddBatch(7, 1L),
                        createMeterRemoveBatch(8, 2L),
                        createMeterUpdateBatch(9, 3L)
                ))
                .setExitOnFirstError(true)
                .build();
    ...
    private Batch createFlowAddBatch(final int batchOrder, final String flowIdValue) {
        return new BatchBuilder()
                ...
                .setBatchChoice(new FlatBatchAddFlowCaseBuilder()
                        .setFlatBatchAddFlowContainer(new FlatBatchAddFlowContainerBuilder()
    ...
    private Batch createFlowRemoveBatch(final int batchOrder, final String flowIdValue) {
        return new BatchBuilder()
                ...
                .setBatchChoice(new FlatBatchRemoveFlowCaseBuilder()
                        .setFlatBatchRemoveFlowContainer(new FlatBatchRemoveFlowContainerBuilder()
                                .setFlowId(new FlowId(flowIdValue))
                                .build())
                        .build())
                .build();
    ...
    private Batch createFlowUpdateBatch(final int batchOrder, final String flowIdValue) {
        return new BatchBuilder()
                ...
                .setBatchChoice(new FlatBatchUpdateFlowCaseBuilder()
                        .setFlatBatchUpdateFlowContainer(new FlatBatchUpdateFlowContainerBuilder()
                                .setFlowId(new FlowId(flowIdValue))
                                .build())
                        .build())
                .build();
    ...
    private Batch createGroupAddBatch(final int batchOrder, final long groupIdValue) {
        return new BatchBuilder()
                ...
                .setBatchChoice(new FlatBatchAddGroupCaseBuilder()
                        .setFlatBatchAddGroupContainer(new FlatBatchAddGroupContainerBuilder()
    ...
    private Batch createGroupRemoveBatch(final int batchOrder, final long groupIdValue) {
        return new BatchBuilder()
                ...
                .setBatchChoice(new FlatBatchRemoveGroupCaseBuilder()
                        .setFlatBatchRemoveGroupContainer(new FlatBatchRemoveGroupContainerBuilder()
                                .setGroupId(new GroupId(groupIdValue))
                                .build())
                        .build())
                .build();
    ...
    private Batch createGroupUpdateBatch(final int batchOrder, final long groupIdValue) {
        return new BatchBuilder()
                ...
                .setBatchChoice(new FlatBatchUpdateGroupCaseBuilder()
                        .setFlatBatchUpdateGroupContainer(new FlatBatchUpdateGroupContainerBuilder()
    ...
    public void testPrepareBatchPlan_success() throws Exception {
        final FlatBatchAddFlowCase flatBatchAddFlowCase = new FlatBatchAddFlowCaseBuilder()
                .setFlatBatchAddFlowContainer(new FlatBatchAddFlowContainerBuilder()
                        ...
                        .build())
                .build();
        final BatchPlanStep<? extends BatchChoice> batchPlanStep =
                new BatchPlanStep<>((Class<? extends BatchChoice>) flatBatchAddFlowCase.getImplementedInterface(), BatchStepType.FLOW_ADD);
        final List<BatchPlanStep<? extends BatchChoice>> batchPlan = Lists.newArrayList(batchPlanStep);
    ...
    public void testPrepareBatchPlan_failure() throws Exception {
        ...
        final BatchPlanStep<? extends BatchChoice> batchPlanStep =
                new BatchPlanStep<>((Class<? extends BatchChoice>) flatBatchAddFlowCase.getImplementedInterface(), BatchStepType.FLOW_ADD);
        batchPlanStep.add(flatBatchAddFlowCase);
        batchPlanStep.add(flatBatchAddFlowCase);

        final List<BatchPlanStep<? extends BatchChoice>> batchPlan = Lists.newArrayList(batchPlanStep, batchPlanStep);
