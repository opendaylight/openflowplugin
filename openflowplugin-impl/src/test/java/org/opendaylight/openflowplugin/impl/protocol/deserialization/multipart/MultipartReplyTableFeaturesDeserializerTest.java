...
public class MultipartReplyTableFeaturesDeserializerTest extends AbstractMultipartDeserializerTest {
    ...
    public void deserialize() {
        ...
        assertEquals(InstructionsMiss.class, reply.nonnullTableFeatures().values().iterator().next().getTableProperties()
                .nonnullTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(WriteActionsMiss.class, reply.nonnullTableFeatures().values().iterator().next().getTableProperties()
                .nonnullTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(ApplyActionsMiss.class, reply.nonnullTableFeatures().values().iterator().next().getTableProperties()
                .nonnullTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
