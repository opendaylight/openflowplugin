...
public class MultipartReplyTableFeaturesDeserializerTest extends AbstractMultipartDeserializerTest {
    ...
    public void deserialize() {
        ...
        TableFeatures firstTableFeature = reply.getTableFeatures().values().iterator().next();
        ...
        assertEquals(Instructions.class, firstTableFeature.getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());

        writeValues(buffer, OFPTFPT_INSTRUCTIONS_MISS);
        reply = (MultipartReplyTableFeatures) deserializeMultipart(buffer);

        assertEquals(InstructionsMiss.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(NextTable.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(NextTableMiss.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(WriteActions.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(WriteActionsMiss.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(ApplyActions.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(ApplyActionsMiss.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(Match.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(Wildcards.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(WriteSetfield.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(WriteSetfieldMiss.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(ApplySetfield.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
        ...
        assertEquals(ApplySetfieldMiss.class, reply.getTableFeatures().values().iterator().next().getTableProperties()
                .getTableFeatureProperties().values().iterator().next().getTableFeaturePropType()
                .implementedInterface());
