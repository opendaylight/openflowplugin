...
public class TranslatorLibratyUtilTest {
    ...
    class TranslatorLibrarianTestImpl implements TranslatorLibrarian {

        private TranslatorLibrary translatorLibrary;

        @Override
        public org.opendaylight.openflowplugin.api.openflow.device.TranslatorLibrary oook() {
            return null;
        }
        ...
        public TranslatorLibrary getTranslatorLibrary() {
            return this.translatorLibrary;
        }

    }

    final TranslatorLibrarianTestImpl translatorLibrarian = new TranslatorLibrarianTestImpl();

    @Test
    public void setBasicTranslatorLibraryTest() {
        TranslatorLibraryUtil.setBasicTranslatorLibrary(translatorLibrarian);
        TranslatorLibrary translatorLibrary = translatorLibrarian.getTranslatorLibrary();
