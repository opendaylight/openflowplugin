...
public class SalExperimenterMessageRpcTest extends ServiceMocking {
    ...
    private SalExperimenterMessageRpc salExperimenterMessageRpc;
    @Mock
    ...
    protected void setup() {
        salExperimenterMessageRpc = new SalExperimenterMessageRpc(mockedRequestContextStack,
                                                                              mockedDeviceContext,
    ...
    public void testSendExperimenter() {
        ...
        salExperimenterMessageRpc.getRpcClassToInstanceMap().getInstance(SendExperimenter.class)
            .invoke(sendExperimenterInput);
    ...
    public void testBuildRequest() throws Exception {
        ...
        final OfHeader request =
                salExperimenterMessageRpc.buildRequest(new Xid(DUMMY_XID_VALUE), sendExperimenterInput);
