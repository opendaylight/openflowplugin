...
import org.opendaylight.yang.gen.v1.urn.opendaylight.meters.service.rev160316.meter.update.OriginalBatchedMeterBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.meters.service.rev160316.meter.update.UpdatedBatchedMeterBuilder;
...
public class SalMetersBatchServiceImplTest {
    ...
    @Test
    public void testUpdateMetersBatch() throws Exception {
    ...
    @Test
    public void testAddMetersBatch() throws Exception {
    ...
    @Test
    public void testRemoveMetersBatch() throws Exception {
    ...
    public void testExtractNodeId() throws Exception {
        Assert.assertEquals(NODE_ID, SalMetersBatchServiceImpl.extractNodeId(NODE_REF));
    }
