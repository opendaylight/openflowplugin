...
public class RoleContextImplTest {
    ...
    @Mock
    private Consumer<DeviceInfo> schedulerCloseJob;
    ...
    public void setUp() throws Exception {
        ...
        roleContext = new RoleContextImpl(connectionContext, roleService, timer, schedulerCloseJob);
    ...
    public void makeDeviceSlave() throws Exception {
        ...
        Mockito.verify(roleService).setRole(new SetRoleInputBuilder()
                ...
                .build());
        Mockito.verify(schedulerCloseJob).accept(deviceInfo);
