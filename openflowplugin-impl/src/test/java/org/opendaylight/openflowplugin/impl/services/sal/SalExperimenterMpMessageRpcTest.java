...
public class SalExperimenterMpMessageRpcTest extends ServiceMocking {
    private SalExperimenterMpMessageRpc salExperimenterMpMessageRpc;

    @Override
    protected void setup() {
        this.<List<MultipartReply>>mockSuccessfulFuture();

        salExperimenterMpMessageRpc = new SalExperimenterMpMessageRpc(
    ...
    public void sendExperimenterMpRequest() {
        ...
        salExperimenterMpMessageRpc.getRpcClassToInstanceMap().getInstance(SendExperimenterMpRequest.class)
            .invoke(data);
