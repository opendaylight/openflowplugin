...
public class MultipartReplyMeterConfigDeserializerTest extends AbstractMultipartDeserializerTest {
    ...
    public void deserializeDrop() {
        ...
        assertEquals(METER_ID,
            reply.getMeterConfigStats().values().iterator().next().getMeterId().getValue().intValue());
        assertEquals(FLAGS, reply.getMeterConfigStats().values().iterator().next().getFlags());
        final Drop drop = (Drop) reply.getMeterConfigStats().values().iterator().next()
                .getMeterBandHeaders().getMeterBandHeader().values().iterator().next().getBandType();
    ...
    public void deserializeDscp() {
        ...
        final DscpRemark dscpRemark = (DscpRemark) reply.getMeterConfigStats().values().iterator().next()
                .getMeterBandHeaders().getMeterBandHeader().values().iterator().next().getBandType();
