...
public class OpenFlowPluginProviderImplTest {
    ...
    public void setUp() {
        ...
        when(configurationService.getProperty(Matchers.eq(ConfigurationProperty.DEVICE_CONNECTION_HOLD_TIME.toString()),
                Matchers.any())).thenReturn(DEVICE_CONNECTION_HOLD_TIME);
    }
