...
public class MatchConvertorTest {
    ...
    public void testPacketTypeConversion() {
        ...
        packetTypeBuilder.setNamespace(1);
        packetTypeBuilder.setType(0x894f);
        builder.setPacketType(packetTypeBuilder.build());
        Match match = builder.build();
        ...
        Assert.assertEquals("Wrong in port", 1,
                ((PacketTypeCase) entry.getMatchEntryValue()).getPacketType().getNamespace().intValue());
        Assert.assertEquals("Wrong in port", 0x894f,
                ((PacketTypeCase) entry.getMatchEntryValue()).getPacketType().getType().intValue());
    }
}
