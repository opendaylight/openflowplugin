...
public class MatchResponseConverter2Test {
    ...
    /**
     * Test {@link MatchResponseConverter#convert(org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.oxm.rev150225.MatchEntriesGrouping, VersionDatapathIdConverterData)}
     */
    @Test(expected = NullPointerException.class)
    public void testEmptyMatch() {
        final VersionDatapathIdConverterData datapathIdConvertorData = new VersionDatapathIdConverterData(OFConstants.OFP_VERSION_1_3);
