...
public class PortConvertorTest {
    ...
    public void testtoPortModInputwithAllParameters()
    {
        ...
        Optional<PortModInput> portOutOptional = ConvertorManager.getInstance().convert(Port.class, portBld.build(), data);
        Assert.assertTrue("Port convertor not found", portOutOptional.isPresent());
        PortModInput portOut = portOutOptional.get();
