...
public class PacketOutConvertorTest{
    ...
    public void toPacketOutInputAllParmNullTest(){
        ...
        Assert.assertEquals(message.getAction(), this
                .buildActionForNullTransmitPacketInputAction(nodeConnKey,
                        version));
        ...
        Assert.assertEquals(message.getData(), transmitPacketInput.getPayload());
    }
