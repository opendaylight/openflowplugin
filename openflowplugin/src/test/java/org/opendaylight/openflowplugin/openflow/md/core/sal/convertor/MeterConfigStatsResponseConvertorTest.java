...
public class MeterConfigStatsResponseConvertorTest {
    ...
    public void testToSALMeterConfigList() {
        Optional<List<MeterConfigStats>> meterConfigsOptional = ConvertorManager.getInstance().convert(MeterConfig.class, createMeterConfigList());
        Assert.assertTrue("Meter config stats convertor not found", meterConfigsOptional.isPresent());
        List<MeterConfigStats> meterConfigs = meterConfigsOptional.get();
