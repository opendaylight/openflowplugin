...
public class GroupConvertorTest {
    ...
    public void testGroupModConvertorwithallParameters() {
        ...
        final Optional<GroupModInputBuilder> outAddGroupInputOptional = ConvertorManager.getInstance().convert(addGroupBuilder.build(), data);
        Assert.assertTrue("Group convertor not found", outAddGroupInputOptional.isPresent());
        final GroupModInputBuilder outAddGroupInput = outAddGroupInputOptional.get();
    ...
    public void testGroupModConvertSortedBuckets() {
        ...
        final Optional<GroupModInputBuilder> outAddGroupInputOptional = ConvertorManager.getInstance().convert(input, data);
        Assert.assertTrue("Group convertor not found", outAddGroupInputOptional.isPresent());
        final GroupModInputBuilder outAddGroupInput = outAddGroupInputOptional.get();
