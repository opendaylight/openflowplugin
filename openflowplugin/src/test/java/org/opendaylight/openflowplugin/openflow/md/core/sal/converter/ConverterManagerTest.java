...
/**
 * Test for {@link ConverterManager}
 */
@RunWith(MockitoJUnitRunner.class)
public class ConverterManagerTest {
    /**
     * Test for {@link ConverterManager#registerConverter(short, Converter)}
     * @throws Exception
     */
    @Test
    public void testRegisterConvertor() throws Exception {
        final ConverterManager convertorManager = new ConverterManager(OFConstants.OFP_VERSION_1_3)
        ...
        final Optional<Converter> convertor = convertorManager.findConverter(OFConstants.OFP_VERSION_1_3, Action.class);
        assertTrue("Failed to find converter for action", convertor.isPresent());
    }

    /**
     * Test for {@link ConverterManager#convert(org.opendaylight.yangtools.yang.binding.DataContainer, ConverterData)}
     * @throws Exception
     */
    @Test
    ...
    /**
     * Test for {@link ConverterManager#convert(java.util.Collection, ConverterData)}
     * @throws Exception
     */
    @Test
