...
public class MatchResponseConvertor2Test {
    ...
    public void testEmptyMatchEntry() {
        ...
        Assert.assertEquals("Wrong match entries", null, builtMatch.getPacketType());
    ...
    public void testWithMatchEntryNoMasks() {
        ...
        Assert.assertEquals("Wrong packet namespace", 1, builtMatch.getPacketType().getNamespace().intValue());
        Assert.assertEquals("Wrong packet type", 0x894f, builtMatch.getPacketType().getType().intValue());
