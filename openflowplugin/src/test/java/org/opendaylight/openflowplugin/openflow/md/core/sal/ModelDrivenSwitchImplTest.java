...
public class ModelDrivenSwitchImplTest {
    ...
    private static NodeRef createNodeRef(String string) {
        ...
        InstanceIdentifier<org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node> path = InstanceIdentifier
                .builder().node(Nodes.class)
                .node(org.opendaylight.yang.gen.v1.urn.opendaylight.inventory.rev130819.nodes.Node.class, key)
                .toInstance();
