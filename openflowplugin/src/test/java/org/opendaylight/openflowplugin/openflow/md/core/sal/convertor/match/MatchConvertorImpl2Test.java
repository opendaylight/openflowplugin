...
public class MatchConvertorImpl2Test {
     ...
     */
    @Test
    public void testIpv4MatchArbitraryBitMask(){
        MatchBuilder builder = new MatchBuilder();
        ...
        ipv4MatchArbitraryBitMaskBuilder.setIpv4SourceArbitraryBitMask(new DottedQuad("255.255.0.0"));
        ipv4MatchArbitraryBitMaskBuilder.setIpv4DestinationAddressNoMask( new Ipv4Address("10.1.1.1"));
        ipv4MatchArbitraryBitMaskBuilder.setIpv4DestinationArbitraryBitMask(new DottedQuad("255.240.0.0"));
        ...
        Assert.assertEquals("wrong Ipv4Adress source", "10.2.2.2",((Ipv4SrcCase) entry.getMatchEntryValue()).getIpv4Src().getIpv4Address().getValue());
        entry = entries.get(1);
