 ...
 *
 */
public class GroupStatsResponseConverterTest {
    ...
    public void testEmptyGroupStats() {
        ...
        Optional<List<org.opendaylight.yang.gen.v1.urn.opendaylight.group.types.rev131018.group.statistics.reply
                .GroupStats>> salGroupStats = convertorManager.convert(groupStats, new VersionConverterData(OFConstants.OFP_VERSION_1_3));
    ...
    public void testSingleGroupStat() {
        ...
        Optional<List<org.opendaylight.yang.gen.v1.urn.opendaylight.group.types.rev131018.group.statistics.reply
                .GroupStats>> salGroupStatsOptional = convertorManager.convert(groupStats, new VersionConverterData(OFConstants.OFP_VERSION_1_3));
        Assert.assertTrue("Group stats response converter not found", salGroupStatsOptional.isPresent());
