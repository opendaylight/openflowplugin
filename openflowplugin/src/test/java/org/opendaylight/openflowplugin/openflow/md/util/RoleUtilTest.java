...
public class RoleUtilTest {
    ...
    /**
     * Test method for {@link org.opendaylight.openflowplugin.openflow.md.util.RoleUtil#createRuleRequestInput(org.opendaylight.openflowplugin.api.openflow.md.core.session.SessionContext, org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.openflow.common.config.impl.rev140326.OfpRole, java.math.BigInteger)}.
     */
    @Test
    public void testCreateRuleRequestInput() {
        RoleRequestInput roleRequestInput = RoleUtil.createRuleRequestInput(session, OfpRole.BECOMEMASTER, generationId).build();
