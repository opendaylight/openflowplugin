...
public class OfToSalIpv6NdSllCase extends ConvertorCase<Ipv6NdSllCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalIpv6NdSllCase() {
        super(Ipv6NdSllCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull Ipv6NdSllCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
