...
public class OfToSalMplsBosCase extends ConvertorCase<MplsBosCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalMplsBosCase() {
        super(MplsBosCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull MplsBosCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
