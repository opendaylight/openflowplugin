...
public class OfToSalIpDscpCase extends ConvertorCase<IpDscpCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalIpDscpCase() {
        super(IpDscpCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull IpDscpCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
