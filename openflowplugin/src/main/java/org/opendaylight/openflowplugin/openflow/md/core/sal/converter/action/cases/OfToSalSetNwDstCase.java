...
public class OfToSalSetNwDstCase extends ConvertorCase<SetNwDstCase, Action, ActionResponseConverterData> {
    public OfToSalSetNwDstCase() {
        super(SetNwDstCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<Action> process(@Nonnull final SetNwDstCase source, final ActionResponseConverterData data, ConverterExecutor converterExecutor) {
