...
public final class MatchExtensionHelper {
    ...
    public static void injectExtension(
        ...
        final GeneralAugMatchNodesNodeTableFlowBuilder builder = flowBuilderIn(matchBuilder);
        if (extBuilder != null) {
    ...
    private static GeneralAugMatchNodesNodeTableFlowBuilder flowBuilderIn(final MatchBuilder matchBuilder) {
        // FIXME: remove the Optional.ofNullable() here, which will result more performant and easier to understand code
        //        NOTE we are always allocating a new object!
        return Optional.ofNullable(matchBuilder.augmentation(GeneralAugMatchNodesNodeTableFlow.class))
