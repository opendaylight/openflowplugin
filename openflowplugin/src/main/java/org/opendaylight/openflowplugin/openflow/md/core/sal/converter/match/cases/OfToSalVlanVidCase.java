...
public class OfToSalVlanVidCase extends ConvertorCase<VlanVidCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalVlanVidCase() {
        super(VlanVidCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull VlanVidCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
