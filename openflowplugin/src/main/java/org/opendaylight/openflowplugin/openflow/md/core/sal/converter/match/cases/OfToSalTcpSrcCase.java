...
public class OfToSalTcpSrcCase extends ConvertorCase<TcpSrcCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalTcpSrcCase() {
        super(TcpSrcCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull TcpSrcCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
