...
public class ExtensionConverterManagerImpl implements ExtensionConverterManager {
     ...
     * @return registration closure
     */
    private <T extends DataContainer, K extends ExperimenterMessageOfChoice, D extends ConvertorData> RegistrationCloserMessageToOFJava<T, K, D>
            hireMessageJanitor(final TypeVersionKey<K> key, final ConverterMessageToOFJava<K, T, D> extConvertor) {
    ...
    @Override
    public <F extends ExperimenterMessageOfChoice, T extends DataContainer, D extends ConvertorData> ConverterMessageToOFJava<F, T, D>
