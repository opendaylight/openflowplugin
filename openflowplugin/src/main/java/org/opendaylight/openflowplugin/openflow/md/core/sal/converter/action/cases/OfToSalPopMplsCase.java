...
public class OfToSalPopMplsCase extends ConvertorCase<PopMplsCase, Action, ActionResponseConverterData> {
    public OfToSalPopMplsCase() {
        super(PopMplsCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<Action> process(@Nonnull final PopMplsCase source, final ActionResponseConverterData data, ConverterExecutor converterExecutor) {
