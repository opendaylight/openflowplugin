...
public class OfToSalSetNwTtlCase extends ConvertorCase<SetNwTtlCase, Action, ActionResponseConverterData> {
    public OfToSalSetNwTtlCase() {
        super(SetNwTtlCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<Action> process(@Nonnull final SetNwTtlCase source, final ActionResponseConverterData data, ConverterExecutor converterExecutor) {
