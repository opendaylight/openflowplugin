        ...
        for(org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.instruction.rev130731.instructions.grouping.Instruction switchInst : instructions){
            if(switchInst.getType().equals(org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.instruction.rev130731.ApplyActions.class)){
                ...
                EnhancedMessageTypeKey<org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.action.rev130731.actions.grouping.Action, ? extends InstructionBase> key = 
                        ...
                        switchInst.getType());
                ConvertorFromOFJava<DataContainer, ActionPath> convertor = OFSessionUtil.getExtensionConvertorProvider().getConverter(key);
                Entry<Class<? extends Augmentation<Extension>>, Augmentation<Extension>> extensionInstruction = convertor.convert(switchInst, null);
