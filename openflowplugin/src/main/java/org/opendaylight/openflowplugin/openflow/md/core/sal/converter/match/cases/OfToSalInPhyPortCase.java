...
public class OfToSalInPhyPortCase extends ConvertorCase<InPhyPortCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalInPhyPortCase() {
        super(InPhyPortCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull InPhyPortCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
