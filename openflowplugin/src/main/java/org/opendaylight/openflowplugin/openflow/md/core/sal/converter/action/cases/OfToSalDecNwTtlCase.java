...
public class OfToSalDecNwTtlCase extends ConvertorCase<DecNwTtlCase, Action, ActionResponseConverterData> {
    public OfToSalDecNwTtlCase() {
        super(DecNwTtlCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<Action> process(@Nonnull final DecNwTtlCase source, final ActionResponseConverterData data, ConverterExecutor converterExecutor) {
