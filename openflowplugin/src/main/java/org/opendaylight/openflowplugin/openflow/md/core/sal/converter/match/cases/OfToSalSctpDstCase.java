...
public class OfToSalSctpDstCase extends ConvertorCase<SctpDstCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalSctpDstCase() {
        super(SctpDstCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull SctpDstCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
