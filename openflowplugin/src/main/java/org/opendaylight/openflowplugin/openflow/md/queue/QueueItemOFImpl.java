...
public class QueueItemOFImpl implements QueueItem<OfHeader> {
    ...
    public String toString() {
        if(message != null && message instanceof NotificationQueueWrapper) {
            return "message " + message + " type " + ((NotificationQueueWrapper)message).getNotification().getClass() + " " + ((NotificationQueueWrapper)message).getNotification().toString();
