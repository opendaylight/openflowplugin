...
public class OfToSalSetFieldCase extends ConvertorCase<SetFieldCase, Action, ActionResponseConvertorData> {
    ...
    @Override
    public Optional<Action> process(ConvertorManager convertorManager, @Nonnull final SetFieldCase source, final ActionResponseConvertorData data) {
        ...
        final Optional<MatchBuilder> matchOptional = convertorManager.convert(setFieldAction, datapathIdConvertorData);
