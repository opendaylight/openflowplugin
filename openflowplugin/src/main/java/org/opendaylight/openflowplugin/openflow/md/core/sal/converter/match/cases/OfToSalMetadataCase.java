...
public class OfToSalMetadataCase extends ConvertorCase<MetadataCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalMetadataCase() {
        super(MetadataCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull MetadataCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
