...
/**
 * The Convertor case used in {@link org.opendaylight.openflowplugin.openflow.md.core.sal.converter.common.ConvertorProcessor}.
 *
...
public abstract class ConvertorCase<FROM, TO, DATA extends ConverterData> {
     ...
     * @return the optional
     */
    public abstract Optional<TO> process(@Nonnull final FROM source, final DATA data, final ConverterExecutor converterExecutor);

    /**
     * Should {@link org.opendaylight.openflowplugin.openflow.md.core.sal.converter.common.ConvertorProcessor}
    ...
    Optional<TO> processRaw(@Nonnull final Object source, final DATA data, final ConverterExecutor converterExecutor) {
        return process(getType().cast(source), data, converterExecutor);
    }
