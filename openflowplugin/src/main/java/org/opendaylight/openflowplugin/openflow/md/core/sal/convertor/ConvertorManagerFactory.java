...
public class ConvertorManagerFactory {
    ...
    public static ConvertorManager createDefaultManager() {
        ...
        return new ConvertorManager()
                ...
                .registerConvertor(OFConstants.OFP_VERSION_1_0, matchResponseConvertor)
                ...
                .registerConvertor(OFConstants.OFP_VERSION_1_3, matchV10ResponseConvertor)
