...
public class OfToSalPbbIsidCase extends ConvertorCase<PbbIsidCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalPbbIsidCase() {
        super(PbbIsidCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull PbbIsidCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
