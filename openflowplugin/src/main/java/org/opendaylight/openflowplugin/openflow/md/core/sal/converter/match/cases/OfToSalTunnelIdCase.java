...
public class OfToSalTunnelIdCase extends ConvertorCase<TunnelIdCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalTunnelIdCase() {
        super(TunnelIdCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull TunnelIdCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
