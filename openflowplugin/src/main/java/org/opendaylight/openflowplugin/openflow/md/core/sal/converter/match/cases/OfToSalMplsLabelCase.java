...
public class OfToSalMplsLabelCase extends ConvertorCase<MplsLabelCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalMplsLabelCase() {
        super(MplsLabelCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull MplsLabelCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
