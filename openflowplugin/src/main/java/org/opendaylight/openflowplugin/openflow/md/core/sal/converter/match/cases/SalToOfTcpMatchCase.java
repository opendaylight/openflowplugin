...
public class SalToOfTcpMatchCase extends ConvertorCase<TcpMatch, List<MatchEntry>, VersionConverterData> {
    public SalToOfTcpMatchCase() {
        super(TcpMatch.class, true);
    }

    @Override
    public Optional<List<MatchEntry>> process(@Nonnull TcpMatch source, VersionConverterData data, ConverterExecutor converterExecutor) {
