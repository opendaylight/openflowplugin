...
public class OfToSalIpv6FlabelCase extends ConvertorCase<Ipv6FlabelCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalIpv6FlabelCase() {
        super(Ipv6FlabelCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull Ipv6FlabelCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
