...
public final class IpConversionUtil {
    ...
    static private String byteArrayV6AddressToString (byte [] _binary_form) throws UnknownHostException{
    ...
    static private String byteArrayV6PrefixToString(byte [] _binary_form) throws UnknownHostException {
        ...
        sb.append("/");
        sb.append(_binary_form[INADDR6SZ + 1] & 0xff);
        return sb.toString();
    }
