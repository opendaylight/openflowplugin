...
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.OFApprovedExperimenterIds;
...
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.SalToOfArpMatchCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.SalToOfIpv4MatchArbitraryBitMaskCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.SalToOfIpv4MatchCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.SalToOfIpv6MatchArbitraryBitMaskCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.SalToOfIpv6MatchCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.SalToOfSctpMatchCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.SalToOfTcpMatchCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.SalToOfTunnelIpv4MatchCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.SalToOfUdpMatchCase;
...
public class MatchConvertorImpl implements MatchConvertor<List<MatchEntry>> {
    private static final ConvertorProcessor<Layer3Match, List<MatchEntry>, VersionConverterData> LAYER3_PROCESSOR = new ConvertorProcessor<Layer3Match, List<MatchEntry>, VersionConverterData>()
    ...
    private static final ConvertorProcessor<Layer4Match, List<MatchEntry>, VersionConverterData> LAYER4_PROCESSOR = new ConvertorProcessor<Layer4Match, List<MatchEntry>, VersionConverterData>()
    ...
    private static void layer3Match(final List<MatchEntry> matchEntryList, final Layer3Match layer3Match, ConverterExecutor converterExecutor) {
    ...
    private static void layer4Match(final List<MatchEntry> matchEntryList, final Layer4Match layer4Match, ConverterExecutor converterExecutor) {
    ...
    @Override
    public List<MatchEntry> convert(final Match match, ConverterExecutor converterExecutor) {
        ...
        layer4Match(result, match.getLayer4Match(), converterExecutor);
        icmpv4Match(result, match.getIcmpv4Match());
        icmpv6Match(result, match.getIcmpv6Match());
        layer3Match(result, match.getLayer3Match(), converterExecutor);
