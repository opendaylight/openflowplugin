...
public class SalToOfIpv4MatchCase extends ConvertorCase<Ipv4Match, List<MatchEntry>, VersionConverterData> {
    public SalToOfIpv4MatchCase() {
        super(Ipv4Match.class, true);
    }

    @Override
    public Optional<List<MatchEntry>> process(@Nonnull Ipv4Match source, VersionConverterData data, ConverterExecutor converterExecutor) {
