...
public class OfToSalIpProtoCase extends ConvertorCase<IpProtoCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalIpProtoCase() {
        super(IpProtoCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull IpProtoCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
