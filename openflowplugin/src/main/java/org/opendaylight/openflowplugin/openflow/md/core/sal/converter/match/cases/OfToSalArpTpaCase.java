...
public class OfToSalArpTpaCase extends ConvertorCase<ArpTpaCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalArpTpaCase() {
        super(ArpTpaCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull ArpTpaCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
