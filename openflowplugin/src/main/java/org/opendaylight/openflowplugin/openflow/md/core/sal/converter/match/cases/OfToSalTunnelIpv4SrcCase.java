...
public class OfToSalTunnelIpv4SrcCase extends ConvertorCase<Ipv4SrcCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalTunnelIpv4SrcCase() {
        super(Ipv4SrcCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull Ipv4SrcCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
