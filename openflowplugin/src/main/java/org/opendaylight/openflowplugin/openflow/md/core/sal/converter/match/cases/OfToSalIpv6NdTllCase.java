...
public class OfToSalIpv6NdTllCase extends ConvertorCase<Ipv6NdTllCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalIpv6NdTllCase() {
        super(Ipv6NdTllCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull Ipv6NdTllCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
