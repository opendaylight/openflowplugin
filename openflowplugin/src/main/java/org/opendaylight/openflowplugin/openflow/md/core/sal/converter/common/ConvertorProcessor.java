...
package org.opendaylight.openflowplugin.openflow.md.core.sal.converter.common;
...
/**
 * Processes source and return result based on converter cases added to this processor.
 *
 * @param <FROM> the source type
 * @param <TO>   the result type
 * @param <DATA> the type of converter data
 */
public class ConvertorProcessor<FROM extends DataContainer, TO, DATA extends ConverterData> {
    ...
    /**
     * Add converter processor case.
     *
     * @param processorCase the processor case
     * @return the converter processor
     */
    ...
    /**
     * Process source and return result based on converter cases, or empty if no match is found.
     *
     * @param source the source
     * @param converterExecutor converter executor
     * @return the optional
     */
    public Optional<TO> process(final FROM source, final ConverterExecutor converterExecutor) {
        return process(source, null, converterExecutor);
    }
     ...
     * @return the optional
     */
    public Optional<TO> process(final FROM source, final DATA data, final ConverterExecutor converterExecutor) {
        ...
        if (Objects.nonNull(processorCase)) {
            result = processorCase.processRaw(source, data, converterExecutor);
    ...
    /**
     * Sets default case, what will be used when we do not find any matching converter case for source.
     *
