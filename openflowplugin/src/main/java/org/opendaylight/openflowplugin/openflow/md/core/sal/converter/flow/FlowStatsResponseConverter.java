 ...
 * </pre>
 */
public class FlowStatsResponseConverter extends Converter<List<FlowStats>, List<FlowAndStatisticsMapList>, VersionDatapathIdConverterData> {
    ...
    private Instructions wrapOF10ActionsToInstruction(List<org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.action.rev150203.actions.grouping.Action> actionsList, final short version) {
        ActionResponseConverterData actionResponseConvertorData = new ActionResponseConverterData(version);
    ...
    @Override
    public List<FlowAndStatisticsMapList> convert(List<FlowStats> source, VersionDatapathIdConverterData data) {
        ...
        for (FlowStats flowStats : source) {
            ...
            if (flowStats.getInstruction() != null) {
                final VersionConverterData simpleConvertorData = new VersionConverterData(data.getVersion());
