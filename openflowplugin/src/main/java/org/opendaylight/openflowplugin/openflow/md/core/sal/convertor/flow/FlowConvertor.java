...
public class FlowConvertor extends Convertor<Flow, List<FlowModInputBuilder>, VersionDatapathIdConvertorData> {
    ...
    private List<Instruction> toInstructions(final Flow flow, final short version, final BigInteger datapathid) {
    ...
    private List<Action> getActions(final short version, final BigInteger datapathid, final Flow flow) {
        Instructions instructions = flow.getInstructions();
