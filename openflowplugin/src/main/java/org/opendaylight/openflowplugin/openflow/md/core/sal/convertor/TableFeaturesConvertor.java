...
/**
 * Utility class for converting a MD-SAL Table features into the OF table
 * features.
 */
public class TableFeaturesConvertor {
    ...
    private static void setSetFieldTableFeatureProperty(TableFeaturePropertiesBuilder builder,
            TableFeaturesPropType type,
