...
public class TableFeaturesConvertor {
    ...
    private static void setInstructionTableFeatureProperty(TableFeaturePropertiesBuilder builder,
        ...
        List<org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.instruction.rev130731.instructions.grouping.Instructions> instructionTypeList = new ArrayList<>();
