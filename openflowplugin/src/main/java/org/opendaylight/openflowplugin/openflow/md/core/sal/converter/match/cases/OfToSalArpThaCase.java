...
public class OfToSalArpThaCase extends ConvertorCase<ArpThaCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalArpThaCase() {
        super(ArpThaCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull ArpThaCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
