...
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalCopyTtlInCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalCopyTtlOutCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalDecMplsTtlCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalDecNwTtlCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalGroupCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalOutputActionCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalPopMplsCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalPopPbbCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalPopVlanCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalPushMplsCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalPushPbbCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalPushVlanCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalSetFieldCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalSetMplsTtlCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalSetNwDstCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalSetNwTtlCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalSetQueueCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.cases.OfToSalStripVlanCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.action.data.ActionResponseConverterData;
    ...
    public List<org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.Action> convert(List<Action> source, ActionResponseConverterData data) {
        ...
        if (source != null) {
            for (final Action action : source) {
                final Optional<org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.Action> convertedAction = PROCESSOR.process(action.getActionChoice(), data, getConverterExecutor());
