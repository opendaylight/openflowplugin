...
public class SalToOfIpv4MatchArbitraryBitMaskCase extends ConvertorCase<Ipv4MatchArbitraryBitMask, List<MatchEntry>, VersionConverterData> {
    public SalToOfIpv4MatchArbitraryBitMaskCase() {
        super(Ipv4MatchArbitraryBitMask.class, true);
    }

    @Override
    public Optional<List<MatchEntry>> process(@Nonnull Ipv4MatchArbitraryBitMask source, VersionConverterData data, ConverterExecutor converterExecutor) {
