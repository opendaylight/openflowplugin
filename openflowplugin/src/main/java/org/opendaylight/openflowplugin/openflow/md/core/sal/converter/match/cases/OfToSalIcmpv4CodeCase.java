...
public class OfToSalIcmpv4CodeCase extends ConvertorCase<Icmpv4CodeCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalIcmpv4CodeCase() {
        super(Icmpv4CodeCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull Icmpv4CodeCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
