...
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.MatchConvertorUtil;
...
public class SalToOfTunnelIpv4MatchCase extends ConvertorCase<TunnelIpv4Match, List<MatchEntry>, VersionConverterData> {
    public SalToOfTunnelIpv4MatchCase() {
        super(TunnelIpv4Match.class, true);
    }

    @Override
    public Optional<List<MatchEntry>> process(@Nonnull TunnelIpv4Match source, VersionConverterData data, ConverterExecutor converterExecutor) {
