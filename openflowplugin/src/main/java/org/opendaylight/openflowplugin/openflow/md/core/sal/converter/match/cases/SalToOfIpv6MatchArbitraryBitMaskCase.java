...
public class SalToOfIpv6MatchArbitraryBitMaskCase extends ConvertorCase<Ipv6MatchArbitraryBitMask, List<MatchEntry>, VersionConverterData> {
    public SalToOfIpv6MatchArbitraryBitMaskCase() {
        super(Ipv6MatchArbitraryBitMask.class, true);
    }

    @Override
    public Optional<List<MatchEntry>> process(@Nonnull Ipv6MatchArbitraryBitMask source, VersionConverterData data, ConverterExecutor converterExecutor) {
