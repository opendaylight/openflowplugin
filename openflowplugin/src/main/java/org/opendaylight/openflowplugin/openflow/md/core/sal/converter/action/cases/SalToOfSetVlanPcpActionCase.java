...
public class SalToOfSetVlanPcpActionCase extends ConvertorCase<SetVlanPcpActionCase, Action, ActionConverterData> {
    ...
    @Nonnull
    @Override
    public Optional<Action> process(@Nonnull final SetVlanPcpActionCase source, final ActionConverterData data, ConverterExecutor converterExecutor) {
