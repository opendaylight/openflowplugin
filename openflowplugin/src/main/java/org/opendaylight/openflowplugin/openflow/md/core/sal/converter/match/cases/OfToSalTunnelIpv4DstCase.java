...
public class OfToSalTunnelIpv4DstCase extends ConvertorCase<Ipv4DstCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalTunnelIpv4DstCase() {
        super(Ipv4DstCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull Ipv4DstCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
