...
public class OfToSalTcpDstCase extends ConvertorCase<TcpDstCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalTcpDstCase() {
        super(TcpDstCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull TcpDstCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
