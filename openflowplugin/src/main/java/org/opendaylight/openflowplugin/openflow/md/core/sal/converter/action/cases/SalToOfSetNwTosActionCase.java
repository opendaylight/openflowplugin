...
public class SalToOfSetNwTosActionCase extends ConvertorCase<SetNwTosActionCase, Action, ActionConverterData> {
    ...
    @Nonnull
    @Override
    public Optional<Action> process(@Nonnull final SetNwTosActionCase source, final ActionConverterData data, ConverterExecutor converterExecutor) {
