...
public class OfToSalSetQueueCase extends ConvertorCase<SetQueueCase, Action, ActionResponseConverterData> {
    public OfToSalSetQueueCase() {
        super(SetQueueCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<Action> process(@Nonnull final SetQueueCase source, final ActionResponseConverterData data, ConverterExecutor converterExecutor) {
