...
public class OfToSalSctpSrcCase extends ConvertorCase<SctpSrcCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalSctpSrcCase() {
        super(SctpSrcCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull SctpSrcCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
