...
public class OfToSalArpOpCase extends ConvertorCase<ArpOpCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalArpOpCase() {
        super(ArpOpCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull ArpOpCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
