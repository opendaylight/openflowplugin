...
public final class RoleUtil {
    ...
    private RoleUtil() {
        throw new AssertionError("RoleUtil is not expected to be instantiated.");
    }
     ...
     */
    public static RoleRequestInputBuilder createRuleRequestInput(
    ...
    public static Future<RpcResult<RoleRequestOutput>> sendRoleChangeRequest(SessionContext sessionContext, OfpRole ofpRole, BigInteger generationId) {
        RoleRequestInputBuilder ruleRequestInputBld = RoleUtil.createRuleRequestInput(sessionContext, ofpRole, generationId);
    ...
    public static CheckedFuture<Boolean, RolePushException> makeCheckedRuleRequestFxResult(
        ...
        return Futures.makeChecked(
                rolePushResult,  
                new Function<Exception, RolePushException>() {
            @Override
