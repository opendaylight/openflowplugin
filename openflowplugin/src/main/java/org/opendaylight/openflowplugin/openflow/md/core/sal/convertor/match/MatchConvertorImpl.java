            ...
            if (layer3Match instanceof Ipv4Match) {
                ...
                if (ipv4Match.getIpv4Destination() != null) {
					...
					if (!checkIfPrefixValueIsMax(ipv4Prefix)) {
						...
						Ipv4SubnetUtils ipv4SubnetUtils = new Ipv4SubnetUtils(ipv4AddressStr);

						if (!ipv4SubnetUtils.getInfo().getAddress().toString()
								.equalsIgnoreCase(ipv4SubnetUtils.getInfo().getNetworkAddress())) {
