...
public class MatchConvertorImpl implements MatchConvertor<List<MatchEntry>> {
    ...
    private static void layer3Match(final List<MatchEntry> matchEntryList, final Layer3Match layer3Match, ConvertorManager convertorManager) {
        java.util.Optional<List<MatchEntry>> result = LAYER3_PROCESSOR.process(convertorManager, layer3Match);
    ...
    private static void layer4Match(final List<MatchEntry> matchEntryList, final Layer4Match layer4Match, ConvertorManager convertorManager) {
        java.util.Optional<List<MatchEntry>> result = LAYER4_PROCESSOR.process(convertorManager, layer4Match);
    ...
    @Override
    public List<MatchEntry> convert(final Match match, ConvertorManager convertorManager) {
        ...
        layer4Match(result, match.getLayer4Match(), convertorManager);
        icmpv4Match(result, match.getIcmpv4Match());
        icmpv6Match(result, match.getIcmpv6Match());
        layer3Match(result, match.getLayer3Match(), convertorManager);
