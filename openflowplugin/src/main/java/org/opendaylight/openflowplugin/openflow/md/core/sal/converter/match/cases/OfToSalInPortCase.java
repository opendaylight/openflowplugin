...
public class OfToSalInPortCase extends ConvertorCase<InPortCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalInPortCase() {
        super(InPortCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull InPortCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
