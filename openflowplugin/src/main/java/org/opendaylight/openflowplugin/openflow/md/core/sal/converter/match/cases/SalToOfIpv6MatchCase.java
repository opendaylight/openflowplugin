...
public class SalToOfIpv6MatchCase extends ConvertorCase<Ipv6Match, List<MatchEntry>, VersionConverterData> {
    public SalToOfIpv6MatchCase() {
        super(Ipv6Match.class, true);
    }

    @Override
    public Optional<List<MatchEntry>> process(@Nonnull Ipv6Match source, VersionConverterData data, ConverterExecutor converterExecutor) {
