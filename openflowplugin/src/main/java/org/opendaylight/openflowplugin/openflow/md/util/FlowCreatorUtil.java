...
public final class FlowCreatorUtil {
    ...
    public static final FlowModFlags  DEFAULT_FLOW_MOD_FLAGS =
        new FlowModFlags(FlowConverter.DEFAULT_OFPFF_CHECK_OVERLAP,
