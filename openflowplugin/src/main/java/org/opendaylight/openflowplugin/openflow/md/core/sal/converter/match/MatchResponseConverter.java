...
package org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match;
...
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalArpOpCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalArpShaCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalArpSpaCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalArpThaCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalArpTpaCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalEthDstCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalEthSrcCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalEthTypeCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIcmpv4CodeCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIcmpv4TypeCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIcmpv6CodeCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIcmpv6TypeCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalInPhyPortCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalInPortCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpDscpCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpEcnCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpProtoCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpv4DstCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpv4SrcCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpv6DstCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpv6ExthdrCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpv6FlabelCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpv6NdSllCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpv6NdTargetCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpv6NdTllCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalIpv6SrcCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalMetadataCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalMplsBosCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalMplsLabelCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalMplsTcCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalPbbIsidCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalSctpDstCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalSctpSrcCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalTcpDstCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalExperimenterIdCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalTcpSrcCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalTunnelIdCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalTunnelIpv4DstCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalTunnelIpv4SrcCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalUdpDstCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalUdpSrcCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalVlanPcpCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.cases.OfToSalVlanVidCase;
import org.opendaylight.openflowplugin.openflow.md.core.sal.converter.match.data.MatchResponseConverterData;
...
public class MatchResponseConverter extends Converter<MatchEntriesGrouping, MatchBuilder, VersionDatapathIdConverterData> {
    ...
    @Override
    public MatchBuilder convert(MatchEntriesGrouping source, VersionDatapathIdConverterData datapathIdConvertorData) {
        final MatchBuilder matchBuilder = new MatchBuilder();

        final MatchResponseConverterData data = new MatchResponseConverterData(datapathIdConvertorData.getVersion());
