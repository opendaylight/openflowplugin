...
public class OfToSalIpv6DstCase extends ConvertorCase<Ipv6DstCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalIpv6DstCase() {
        super(Ipv6DstCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull Ipv6DstCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
