...
public final class ActionConvertor {
    ...
    public static List<ActionsList> getActionList(List<Actions> actions)

    {
      ...
      {
            Action action = actions.get(actionItem);
...
Action action, ActionBuilder actionBuilder,
        ...
        // TODO :SAL Layer changes required
        // return SalToOFPushAction(((PushVlanAction) action).getEthernetType(),
        // actionBuilder, actionsListBuilder);
        // TODO:Remove this
        return null;
...
Action action, ActionBuilder actionBuilder,
        ...
        actionBuilder
                .setType((Class<? extends org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.types.rev130731.Action>) NwTtlAction.class);
...
Action action, ActionBuilder actionBuilder,
        ...
        actionBuilder
                .addAugmentation(
                        (Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.action.rev130731.action.header.Action>>) SetQueue.class,
                        queueIdActionBuilder.build());
...
Action action, ActionBuilder actionBuilder,
        ...
        actionBuilder
                .addAugmentation(
                        ...
                        (Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.action.rev130731.action.header.Action>) experimenterActionBuilder);
        actionsListBuilder.setAction(actionBuilder.build());
        return actionsListBuilder.build();
...
Action action, ActionBuilder actionBuilder,
        ...
        groupIdBuilder.setGroupId(Long.parseLong(groupAction.getGroup()));
...
Action action, ActionBuilder actionBuilder,
        ...
        /* OF */
        actionBuilder
                .setType((Class<? extends org.opendaylight.yang.gen.v1.urn.opendaylight.openflow.common.types.rev130731.Action>) MplsTtlAction.class);
