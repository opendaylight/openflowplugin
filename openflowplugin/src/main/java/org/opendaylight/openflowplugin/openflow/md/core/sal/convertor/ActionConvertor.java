...
public final class ActionConvertor {
    ...
    private static final String UNKNOWN_ACTION_TYPE = "Unknown Action Type for the Version";
    ...
    public static List<Action> getActions(
        ...
        List<org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.list.Action> sortedActions = 
    ...
    private static Action salToOFSetVlanId(
        ...
        if (version == OFConstants.OFP_VERSION_1_0) {
            ...
            LOG.error(UNKNOWN_ACTION_TYPE, version);
            return null;
        }
    }
