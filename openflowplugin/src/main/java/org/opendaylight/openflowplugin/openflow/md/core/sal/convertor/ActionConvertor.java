...

    {
        ...
        for (int actionItem = 0; actionItem < actions.size(); actionItem++) {
            ...
            if (action instanceof OutputActionCase)
                 ...
                 */
                ConverterExtensionKey<? extends org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.Action> key = new ConverterExtensionKey<>(action.getClass());
