...
public class OfToSalIcmpv4TypeCase extends ConvertorCase<Icmpv4TypeCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalIcmpv4TypeCase() {
        super(Icmpv4TypeCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull Icmpv4TypeCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
