...
public class OfToSalEthTypeCase extends ConvertorCase<EthTypeCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalEthTypeCase() {
        super(EthTypeCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull EthTypeCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
