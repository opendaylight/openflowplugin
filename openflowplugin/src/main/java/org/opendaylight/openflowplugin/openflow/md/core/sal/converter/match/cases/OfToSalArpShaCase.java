...
public class OfToSalArpShaCase extends ConvertorCase<ArpShaCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalArpShaCase() {
        super(ArpShaCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull ArpShaCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
