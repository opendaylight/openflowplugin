...
public class OfToSalSetMplsTtlCase extends ConvertorCase<SetMplsTtlCase, Action, ActionResponseConverterData> {
    public OfToSalSetMplsTtlCase() {
        super(SetMplsTtlCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<Action> process(@Nonnull final SetMplsTtlCase source, final ActionResponseConverterData data, ConverterExecutor converterExecutor) {
