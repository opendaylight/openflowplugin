...
public class SalToOfArpMatchCase extends ConvertorCase<ArpMatch, List<MatchEntry>, VersionConverterData> {
    public SalToOfArpMatchCase() {
        super(ArpMatch.class, true);
    }

    @Override
    public Optional<List<MatchEntry>> process(@Nonnull ArpMatch source, VersionConverterData data, ConverterExecutor converterExecutor) {
