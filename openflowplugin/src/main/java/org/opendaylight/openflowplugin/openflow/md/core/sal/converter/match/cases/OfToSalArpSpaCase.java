...
public class OfToSalArpSpaCase extends ConvertorCase<ArpSpaCase, MatchBuilder, MatchResponseConverterData> {
    public OfToSalArpSpaCase() {
        super(ArpSpaCase.class, true, OFConstants.OFP_VERSION_1_0, OFConstants.OFP_VERSION_1_3);
    }

    @Override
    public Optional<MatchBuilder> process(@Nonnull ArpSpaCase source, MatchResponseConverterData data, ConverterExecutor converterExecutor) {
