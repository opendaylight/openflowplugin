...
public class FlowFlagsConvertorV10Impl implements FlowFlagConvertor<FlowModFlagsV10> {
    ...
    public FlowModFlagsV10 convert(
            FlowModFlags source, ConverterExecutor converterExecutor) {

        FlowModFlagsV10 ofFlowModFlags;
        if (source != null) {
            ofFlowModFlags = new FlowModFlagsV10(
                    source.isCHECKOVERLAP(), FlowConverter.DEFAULT_OFPFF_EMERGENCY, source.isSENDFLOWREM());
        } else {
            ofFlowModFlags = new FlowModFlagsV10(
                    FlowConverter.DEFAULT_OFPFF_CHECK_OVERLAP,
                    FlowConverter.DEFAULT_OFPFF_EMERGENCY,
